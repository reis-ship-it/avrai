...
class SupabaseIntegrationExample extends StatefulWidget {
  ...
  @override
  State<SupabaseIntegrationExample> createState() =>
      _SupabaseIntegrationExampleState();
}

class _SupabaseIntegrationExampleState
    extends State<SupabaseIntegrationExample> {
                  ...
                  children: [
                    ...
                    if (_users.isEmpty)
                      const Padding(
                          ...
                          child: Text('No users found. Create one to test!'))
                    else
                      ListView.builder(
                        shrinkWrap: true,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            trailing: Text(user['created_at'] != null
