...
void main() {
  ...
  testWidgets('Signal DM + sender-key share smoke (device)', (tester) async {
    await tester.runAsync(() async {
      ...
      final aliceSecureSignalStorage =
          SecureSignalStorage(secureStorage: aliceStorage);
      ...
      final bobSecureSignalStorage =
          SecureSignalStorage(secureStorage: bobStorage);
      ...
      final decoded =
          jsonDecode(utf8.decode(shareDecrypted)) as Map<String, dynamic>;
