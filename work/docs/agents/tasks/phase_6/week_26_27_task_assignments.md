# Phase 6 Task Assignments - Local Expert System Redesign (Week 26-27)

**Date:** November 24, 2025  
**Purpose:** Detailed task assignments for Phase 6, Week 26-27 (Event Discovery & Matching - Phase 2)  
...
**Focus:** EventMatchingService, CrossLocalityConnectionService, Local Expert Priority Logic, UserPreferenceLearningService, EventRecommendationService

### **Agent 2: Frontend & UX**
**Focus:** Events Page Tabs (organized by scope), Event Search Filtering, UI Integration

### **Agent 3: Models & Testing**
**Focus:** Event Matching Models, Test Updates, Integration Tests, Documentation

---

## 📅 **Week 26: Reputation/Matching System & Cross-Locality Connections**

### **Agent 1: Backend & Integration**
**Status:** 🟢 Ready to Start  
**Focus:** Event Matching Service, Cross-Locality Connection Service, Local Expert Priority

**Tasks:**

#### **Day 1-3: EventMatchingService (Reputation/Matching Score Service)**
- [ ] **Create `lib/core/services/event_matching_service.dart`**
...
- [ ] **Local Expert Priority Logic**
  ...
  - [ ] Update `getEventsByHost()` if needed:
    - [ ] Ensure local expert events are prioritized

#### **Day 4-5: CrossLocalityConnectionService**
- [ ] **Create `lib/core/services/cross_locality_connection_service.dart`**
...
### **Agent 2: Frontend & UX**
**Status:** 🟢 Ready to Start  
**Focus:** Events Page UI Updates (Week 26 prep, Week 27 main work)

**Tasks:**

#### **Day 1-2: Review & Prepare for Week 27**
- [ ] **Review existing EventsBrowsePage**
...
- [ ] **Create Tab Widget (if starting early)**
...
**⚠️ CRITICAL: Testing Workflow (TDD Approach)**
- **DO NOT WAIT** for Agent 1's implementation
- **Write tests based on specifications/requirements** (task assignments, implementation plan, requirements docs)
- Tests serve as both:
  1. **Specification** for Agent 1 (what the code should do)
  2. **Tests** that will be verified once Agent 1 completes
- **After Agent 1 completes:** Verify tests pass and update if implementation differs from spec
- This enables **true parallel work** while ensuring tests match final implementation
...
- [ ] **Create `lib/core/models/event_matching_score.dart`**
...
- [ ] **Create `lib/core/models/cross_locality_connection.dart`**
...
- [ ] **Create `lib/core/models/user_movement_pattern.dart`**
...
- [ ] **Create `test/unit/services/event_matching_service_test.dart`**
...
- [ ] **Create `test/unit/services/cross_locality_connection_service_test.dart`**
...
## 📅 **Week 27: Events Page Organization & User Preference Learning**

### **Agent 1: Backend & Integration**
**Status:** 🟢 Ready to Start  
**Focus:** User Preference Learning Service, Event Recommendation Service

**Tasks:**

#### **Day 1-3: UserPreferenceLearningService**
- [ ] **Create `lib/core/services/user_preference_learning_service.dart`**
...
- [ ] **Create `lib/core/services/event_recommendation_service.dart`**
...
- [ ] **Create `lib/core/models/user_preferences.dart`**
...
- [ ] **Create `lib/core/models/event_recommendation.dart`**
...
- [ ] **Create `test/unit/services/user_preference_learning_service_test.dart`**
  - [ ] Test preference learning from attendance
  - [ ] Test preference weight calculation
  - [ ] Test exploration suggestions
  - [ ] Test preference updates

- [ ] **Create `test/unit/services/event_recommendation_service_test.dart`**
...
- **New Services:** 4 services (EventMatchingService, CrossLocalityConnectionService, UserPreferenceLearningService, EventRecommendationService)
- **New Models:** 5 models (EventMatchingScore, CrossLocalityConnection, UserMovementPattern, UserPreferences, EventRecommendation)
- **Modified Services:** 1 service (ExpertiseEventService)
- **Modified UI:** 1 page (EventsBrowsePage)
