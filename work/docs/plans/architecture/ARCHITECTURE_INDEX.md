...
- **KernelGraph internal workflow IR + governed self-improvement architecture:** [`KERNELGRAPH_INTERNAL_WORKFLOW_IR_AND_GOVERNED_SELF_IMPROVEMENT_ARCHITECTURE_2026-04-03.md`](./KERNELGRAPH_INTERNAL_WORKFLOW_IR_AND_GOVERNED_SELF_IMPROVEMENT_ARCHITECTURE_2026-04-03.md)
...
- **External forecast compute-sidecar authority (TimesFM/admin-first):** [`TIMESFM_FORECAST_SIDECAR_INTEGRATION_AUTHORITY_2026-04-03.md`](./TIMESFM_FORECAST_SIDECAR_INTEGRATION_AUTHORITY_2026-04-03.md)
- **Current planned forecast-sidecar anchors:** `M31-P10-11` admin-only TimesFM shadow integration + governed diagnostics traceability; `M31-P10-12` governed forecast distillation + supervision tuple export; `M31-P10-13` hierarchy-loop propagation + live-reality notation for any TimesFM-informed effect that leaves admin-only learning surfaces
- **Reality-model autonomous control-plane + supervisor-daemon authority:** [`REALITY_MODEL_AUTONOMOUS_CONTROL_PLANE_AND_SUPERVISOR_DAEMON_2026-03-30.md`](./REALITY_MODEL_AUTONOMOUS_CONTROL_PLANE_AND_SUPERVISOR_DAEMON_2026-03-30.md)
  - Current active stage-2 milestone anchor: `M31-P10-6` multi-environment executor parity + admin simulation/training quality
