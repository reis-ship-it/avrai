# BHAM Consolidated Replay Normalized Observations
...
- `ALDOT Long-Term Construction Projects` [`aggregate_metric_replay_source_adapter`] records `3` observations `3`
- `ALDOT Traffic Data` [`aggregate_metric_replay_source_adapter`] records `2` observations `2`
- `BEA / U.S. Census Bureau Economic Series` [`aggregate_metric_replay_source_adapter`] records `1` observations `1`
- `City of Birmingham OpenGov` [`calendar_event_replay_source_adapter`] records `2` observations `2`
- `Jefferson / Shelby / Regional GIS and Assessors` [`spatial_feature_replay_source_adapter`] records `6` observations `6`
- `U.S. Census ACS` [`aggregate_metric_replay_source_adapter`] records `378` observations `378`
- `BJCC / Legacy Arena / Protective Stadium Calendars` [`calendar_event_replay_source_adapter`] records `5` observations `5`
- `UAB Academic, Clinical, and Event Calendars` [`calendar_event_replay_source_adapter`] records `3` observations `3`
- `OpenStreetMap POI Data` [`spatial_feature_replay_source_adapter`] records `789` observations `789`
- `Birmingham Public Library Network` [`calendar_event_replay_source_adapter`] records `8` observations `8`
- `Birmingham365.org` [`spatial_feature_replay_source_adapter`] records `1` observations `1`
- `City of Birmingham Play Pages` [`calendar_event_replay_source_adapter`] records `17` observations `17`
- `Eventbrite / Meetup` [`calendar_event_replay_source_adapter`] records `6` observations `6`
- `IN Birmingham (CVB Calendar)` [`calendar_event_replay_source_adapter`] records `13` observations `13`
- `Major Venue Calendars and Historical Venue Calendars` [`calendar_event_replay_source_adapter`] records `9` observations `9`
- `Neighborhood Association Calendars` [`calendar_event_replay_source_adapter`] records `3` observations `3`
- `Bhamwiki` [`historical_entity_replay_source_adapter`] records `11` observations `11`
...
- `obs:aldot-construction-pratt-highway-black-creek-2023` -> `movement_flow` `bham_west_sandusky`
- `obs:aldot-construction-19th-street-ensley-2023` -> `movement_flow` `bham_ensley`
- `obs:aldot-construction-13th-street-south-uab-2023` -> `movement_flow` `bham_southside_uab`
- `obs:aldot-traffic-bham-core-bottlenecks-2023` -> `movement_flow` `bham_core`
- `obs:aldot-traffic-bham-valleydale-acton-pressure-2023` -> `movement_flow` `bham_south_east_corridor`
- `obs:bea-2023-01073-CAINC1-line-3` -> `economic_signal` `Birmingham Metro`
- `obs:bham-opengov-civic-locality-and-finance-2023` -> `event` `birmingham_city`
- `obs:bham-opengov-public-safety-snapshot-dec-2023` -> `event` `birmingham_city`
- `obs:rpcgb-hist-greater-birmingham-region-2023` -> `locality` `greater_birmingham_region`
- `obs:rpcgb-hist-jefferson-county-2023` -> `locality` `jefferson_county`
- `obs:rpcgb-hist-shelby-county-2023` -> `locality` `shelby_county`
- `obs:rpcgb-hist-birmingham-open-data-2023` -> `locality` `greater_birmingham_region`
- `obs:rpcgb-hist-regional-transportation-plan-2023` -> `movement_flow` `greater_birmingham_region`
- `obs:rpcgb-hist-building-communities-program-2023` -> `community` `greater_birmingham_region`
...
- `obs:bjcc-elevation-nights-2023` -> `event` `bham_uptown`
- `obs:bjcc-mean-girls-2023` -> `event` `bham_uptown`
- `obs:bjcc-fantasia-joe-2023` -> `event` `bham_uptown`
- `obs:bjcc-pentatonix-2023` -> `event` `bham_uptown`
- `obs:bjcc-trans-siberian-orchestra-2023` -> `event` `bham_uptown`
- `obs:uab-academic-spring-2023-term` -> `event` `bham_southside_uab`
- `obs:uab-academic-fall-2023-term` -> `event` `bham_southside_uab`
- `obs:uab-new-years-holiday-2023` -> `event` `bham_southside_uab`
...
- `obs:bpl-avondale-branch-seed-2026` -> `event` `bham_avondale`
- `obs:bpl-central-branch-seed-2026` -> `event` `bham_downtown`
- `obs:bpl-southside-branch-seed-2026` -> `event` `bham_southside`
- `obs:bpl-springville-road-branch-seed-2026` -> `event` `bham_roebuck`
- `obs:bpl-avondale-branch-seed-2026` -> `event` `bham_avondale`
- `obs:bpl-central-branch-seed-2026` -> `event` `bham_downtown`
- `obs:bpl-southside-branch-seed-2026` -> `event` `bham_southside`
- `obs:bpl-springville-road-branch-seed-2026` -> `event` `bham_roebuck`
- `obs:bham365-citywide-culture-network-seed-2026` -> `community` `bham_downtown`
- `obs:city-play-alabama-theatre-seed-2026` -> `event` `bham_downtown`
- `obs:city-play-bham-museum-of-art-seed-2026` -> `event` `bham_downtown`
- `obs:city-play-civil-rights-institute-seed-2026` -> `event` `bham_civil_rights_district`
- `obs:city-play-botanical-gardens-seed-2026` -> `event` `bham_lane_park`
- `obs:city-play-alabama-jazz-hall-of-fame-seed-2026` -> `event` `bham_downtown`
- `obs:city-food-culture-fest-2023` -> `event` `bham_citywide`
- `obs:city-awaken-2023` -> `event` `bham_downtown`
- `obs:city-i-heart-art-2023` -> `event` `bham_downtown`
- `obs:city-magic-city-classic-2023` -> `event` `bham_westside_legion_field`
- `obs:city-black-gospel-celebration-2023` -> `event` `bham_downtown`
- `obs:city-play-alabama-sports-hall-of-fame-2023` -> `venue` `bham_uptown`
- `obs:city-play-arlington-historic-house-2023` -> `venue` `bham_citywide`
- `obs:city-play-barber-museum-2023` -> `venue` `bham_metro_regional`
- `obs:city-play-negro-southern-league-museum-2023` -> `venue` `bham_downtown`
- `obs:city-play-birmingham-zoo-2023` -> `venue` `bham_lane_park`
- `obs:city-play-mcwane-science-center-2023` -> `venue` `bham_downtown`
- `obs:city-play-southern-museum-of-flight-2023` -> `venue` `bham_metro_regional`
- `obs:evtmeet-hist-1` -> `community` `bham_metro_regional`
- `obs:evtmeet-hist-2` -> `community` `bham_metro_regional`
- `obs:evtmeet-hist-3` -> `community` `bham_metro_regional`
- `obs:evtmeet-hist-4` -> `community` `bham_metro_regional`
- `obs:evtmeet-hist-5` -> `community` `bham_metro_regional`
- `obs:evtmeet-hist-6` -> `community` `bham_metro_regional`
- `obs:inbham-hist-bham-metro-guides-2023` -> `locality` `bham_metro_regional`
- `obs:inbham-hist-avondale-crestwood-2023` -> `community` `bham_avondale`
- `obs:inbham-hist-downtown-2023` -> `community` `bham_downtown`
- `obs:inbham-hist-homewood-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-hoover-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-irondale-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-bessemer-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-fultondale-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-gardendale-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-leeds-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-mountain-brook-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-trussville-2023` -> `community` `bham_metro_regional`
- `obs:inbham-hist-vestavia-2023` -> `community` `bham_metro_regional`
- `obs:major-venue-saturn-seed-2026` -> `event` `bham_avondale`
- `obs:major-venue-iron-city-seed-2026` -> `event` `bham_southside`
- `obs:major-venue-the-nick-seed-2026` -> `event` `bham_southside`
- `obs:major-venue-alabama-theatre-seed-2026` -> `event` `bham_downtown`
- `obs:major-venue-lyric-theatre-seed-2026` -> `event` `bham_downtown`
- `obs:major-venue-alys-stephens-center-seed-2026` -> `event` `bham_southside_uab`
- `obs:major-venue-workplay-seed-2026` -> `event` `bham_southside`
- `obs:major-venue-bjcc-campus-seed-2026` -> `event` `bham_uptown`
- `obs:major-venue-oak-mountain-amphitheatre-seed-2026` -> `event` `bham_metro_regional`
- `obs:nhcal-east-avondale-neighborhood-association-2023` -> `community` `bham_east_avondale`
- `obs:nhcal-glen-iris-neighborhood-association-2023` -> `community` `bham_glen_iris`
- `obs:nhcal-wylam-neighborhood-association-2023` -> `community` `bham_wylam`
- `obs:bhamwiki-forest-park-south-avondale-2023` -> `locality` `bham_forest_park_south_avondale`
- `obs:bhamwiki-eastwood-neighborhood-2023` -> `community` `bham_eastwood`
- `obs:bhamwiki-friends-of-avondale-park-2023` -> `community` `bham_avondale`
- `obs:bhamwiki-grassroots-coalition-2023` -> `community` `bham_citywide`
- `obs:bhamwiki-jones-valley-teaching-farm-2023` -> `community` `bham_citywide`
- `obs:bhamwiki-southside-branch-library-2023` -> `venue` `bham_southside`
- `obs:bhamwiki-saturn-2023` -> `club` `bham_avondale`
- `obs:bhamwiki-iron-city-2023` -> `club` `bham_southside`
- `obs:bhamwiki-east-avondale-neighborhood-association-2023` -> `community` `bham_east_avondale`
- `obs:bhamwiki-glen-iris-neighborhood-association-2023` -> `community` `bham_glen_iris`
- `obs:bhamwiki-wylam-neighborhood-association-2023` -> `community` `bham_wylam`
