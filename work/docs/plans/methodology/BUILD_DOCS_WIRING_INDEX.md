...
2. `docs/plans/methodology/REALITY_MODEL_SIMULATION_TO_TRAINING_OPERATOR_RUNBOOK_2026-04-01.md`
3. `docs/plans/architecture/TIMESFM_FORECAST_SIDECAR_INTEGRATION_AUTHORITY_2026-04-03.md`
4. `docs/EXPERIMENT_REGISTRY.md`
5. `docs/ML_MODEL_TRAINING_CHECKLIST.md`
6. `docs/ML_SIMULATION_EXPERIMENT_LOG.md`
7. `configs/ml/feature_label_contracts.json`
8. `configs/ml/avrai_native_type_contracts.json`
9. `configs/experiments/EXPERIMENT_REGISTRY.csv`
