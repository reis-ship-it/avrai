...
- `docs/plans/methodology/REALITY_MODEL_SIMULATION_TO_TRAINING_OPERATOR_RUNBOOK_2026-04-01.md`
...
Reality-model-specific note:

1. Use `docs/plans/methodology/REALITY_MODEL_SIMULATION_TO_TRAINING_OPERATOR_RUNBOOK_2026-04-01.md` for the replay-simulation-to-training workflow.
2. This governance doc remains the generic ML policy layer, not the reality-model replay operator runbook.
