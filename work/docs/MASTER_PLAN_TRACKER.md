...
**Last Updated:** March 4, 2026 (v31: added 3 new architectural sections — Transport Backend Interface (3.7A), Subsystem Isolation (7.10), Connection Capability Model (8.2A). Added RuntimeContext pattern note to Phase 7 header. Added Foundational Decisions #26-#28. Updated Cross-Phase Connections with new contracts, data flows, chain reaction scenarios, and parallel execution safety rules. Previous v30: advanced AI services + privacy model additions)
...
| **AVRAI OS — Phase 12 (Cognitive Kernel, Platform Adapters & External API)** | 2026-03-03 | 🟢 **Active** | **CRITICAL** | 24-40 weeks post-beta; 8 sections (12.1 Kernel → 12.7 SDK + 12.8 Face Matching gated). North star: headless Rust kernel on any device, external API for AI companies, Plugin Framework for local IoT/health apps, physical-to-digital opt-in matching. | [`MASTER_PLAN.md#phase-12`](./MASTER_PLAN.md) · Rationale: [`plans/rationale/PHASE_12_OS_RATIONALE.md`](./plans/rationale/PHASE_12_OS_RATIONALE.md) |
