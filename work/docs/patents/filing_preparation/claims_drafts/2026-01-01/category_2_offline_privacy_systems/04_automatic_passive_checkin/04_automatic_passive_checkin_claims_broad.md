# Automatic Passive Check-In System with Dual-Trigger Verification — Claims Draft (BROAD)
...
(a) Detecting user entry into geofence with a threshold interval radius using background location monitoring;
...
(e) Recording visit only if dwell time ≥ a threshold interval.
