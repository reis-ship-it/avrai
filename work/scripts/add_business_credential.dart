...
void main(List<String> args) {
  if (args.length < 3) {
    print(
        'Usage: dart run scripts/add_business_credential.dart <business_id> <username> <password>');
    print('');
    print('Example:');
    print(
        '  dart run scripts/add_business_credential.dart business_abc123 mybusiness mySecurePassword123');
  ...
  print('');
  print(
      'INSERT INTO business_credentials (business_id, username, password_hash, is_active)');
