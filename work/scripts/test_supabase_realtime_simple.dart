...
void main() async {
  developer.log('🚀 Starting Supabase Realtime Test',
      name: 'TestSupabaseRealtime');
  ...
  try {
    ...
    developer.log('✅ All tests completed successfully',
        name: 'TestSupabaseRealtime');
  } catch (e) {
...
Future<void> _testConfiguration() async {
  developer.log('🔧 Testing Supabase configuration...',
      name: 'TestSupabaseRealtime');
  ...
  developer.log('  Environment: ${config['environment']}',
      name: 'TestSupabaseRealtime');
...
Future<void> _testChannelCreation() async {
  ...
  for (final channel in channels) {
    ...
    developer.log('  ✅ Channel created: $channel',
        name: 'TestSupabaseRealtime');
  }
...
Future<void> _testMessageBroadcasting() async {
  developer.log('📢 Testing message broadcasting...',
      name: 'TestSupabaseRealtime');
  ...
  developer.log('  Broadcasting discovery message',
      name: 'TestSupabaseRealtime');
  developer.log('  Payload: ${json.encode(discoveryMessage)}',
      name: 'TestSupabaseRealtime');
  ...
  developer.log('  Broadcasting learning message',
      name: 'TestSupabaseRealtime');
  developer.log('  Payload: ${json.encode(learningMessage)}',
      name: 'TestSupabaseRealtime');
  ...
  developer.log('  Broadcasting anonymous message',
      name: 'TestSupabaseRealtime');
  developer.log('  Payload: ${json.encode(anonymousMessage)}',
      name: 'TestSupabaseRealtime');

  // Simulate message sending
  await Future.delayed(const Duration(milliseconds: 500));

  developer.log('✅ Message broadcasting test passed',
      name: 'TestSupabaseRealtime');
}

/// Test presence tracking
Future<void> _testPresenceTracking() async {
  developer.log('👥 Testing presence tracking...',
      name: 'TestSupabaseRealtime');
  ...
  developer.log('  Presence: ${json.encode(presenceData)}',
      name: 'TestSupabaseRealtime');
  ...
  developer.log('  Retrieved presence: ${mockPresenceList.length} nodes',
      name: 'TestSupabaseRealtime');

  for (final node in mockPresenceList) {
    developer.log('    Node: ${node['user_id']} - ${node['node_type']}',
        name: 'TestSupabaseRealtime');
  }

  developer.log('✅ Presence tracking test passed',
      name: 'TestSupabaseRealtime');
}
