...
class EnhancedAIChatInterface extends StatefulWidget {
  ...
  @override
  State<EnhancedAIChatInterface> createState() =>
      _EnhancedAIChatInterfaceState();
}
...
class _EnhancedAIChatInterfaceState extends State<EnhancedAIChatInterface> {
  ...
  Future<void> _checkForActionSuccess(String command, String response) async {
    ...
    final isAction = successKeywords
        .any((keyword) => response.toLowerCase().contains(keyword));
          ...
          onUndo: () async {
            ...
            try {
              ...
              if (undoResult.success) {
                context.showSuccess('Action undone successfully!');
              } else {
                context.showWarning(undoResult.message);
              }
            } catch (e) {
              if (!mounted) return;
              context.showError('Undo failed: $e');
            }
          },
          onViewResult: () {
