...
/// Border visualization panel for **MapKit (macOS)**.
///
...
class BorderVisualizationWidgetMapKit extends StatefulWidget {
  /// MapKit controller (optional; for future map interactions).
  final fmm.FlutterMacosMapsController? mapController;
  ...
  const BorderVisualizationWidgetMapKit({
    super.key,
    this.mapController,
    this.locality,
    this.localityCode,
  ...
  @override
  State<BorderVisualizationWidgetMapKit> createState() =>
      _BorderVisualizationWidgetMapKitState();
}

class _BorderVisualizationWidgetMapKitState
    extends State<BorderVisualizationWidgetMapKit> {
  ...
  String? _error;
  final List<_MapKitBoundaryItem> _items = [];
  ...
  @override
  void didUpdateWidget(covariant BorderVisualizationWidgetMapKit oldWidget) {
