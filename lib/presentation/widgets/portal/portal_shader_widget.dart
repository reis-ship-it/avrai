...
class _PortalShaderWidgetState extends State<PortalShaderWidget>
  ...
  Future<void> _loadShader() async {
    try {
      final program = await ui.FragmentProgram.fromAsset('shaders/portal_world.frag');
      if (mounted) {
        setState(() {
          _program = program;
        });
      ...
      developer.log('Failed to load portal shader: $e', name: 'PortalShaderWidget');
    }
  }
...
class _PortalShaderPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final q = repaintController.uprightCorrection * repaintController.cameraRotation;
