...
class _TurbineLoaderState extends State<TurbineLoader>
  ...
  Widget build(BuildContext context) {
    final ringColor = widget.isDark ? const Color(0xFFE0E0E0) : const Color(0xFF404040);
    final coreColor = widget.isDark ? AppColors.electricGreen : AppColors.electricGreen; // Always electric green core
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: coreColor.withValues(
                    alpha: 0.5 + 0.5 * math.sin(_controller.value * 2 * math.pi),
                  ),
                  boxShadow: [
                    BoxShadow(
                      color: coreColor.withValues(alpha: 0.6),
                      blurRadius: 10 + 5 * math.sin(_controller.value * 2 * math.pi),
                      spreadRadius: 2,
                    ),
                  ],
                ),
