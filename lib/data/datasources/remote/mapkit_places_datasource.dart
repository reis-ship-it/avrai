...
import 'package:avrai/core/services/places/mapkit_places_cache_service.dart';
...
class MapKitPlacesDataSource implements PlacesDataSource {
  ...
  Future<List<Spot>> searchPlaces({
    ...
    try {
      ...
      developer.log('Error searching places: $e', name: _logName, stackTrace: st);
      return [];
    }
  }
  ...
  Spot _itemToSpot(Map<String, dynamic> item) {
    ...
    final ident = (item['identifier'] as String?) ?? '${lat}_${lon}_${name.hashCode}';
