...
class AppDatabase extends _$AppDatabase {
  ...
  Future<void> upsertTransferProgress(TransferProgressCompanion progress) async {
  ...
  Future<void> updateTransferChunk(
    ...
    await (update(transferProgress)..where((t) => t.transferId.equals(transferId)))
  ...
  Future<List<SyncStateData>> getPendingSyncItems() async {
    return (select(syncState)..where((s) => s.syncStatus.equals('pending'))).get();
  }
