...
import 'package:avrai/runtime/avrai_runtime_os/services/transport/mesh/learning_insight_peer_send_lane.dart';
...
class LearningInsightPeerDispatchLane {
  ...
  static Future<void> send({
    ...
    final bool learningEnabled = prefs.getBool(prefsKeyAi2AiLearningEnabled) ?? true;
