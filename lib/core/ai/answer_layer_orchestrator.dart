...
import 'package:avrai/core/ai/rag_context_builder.dart';
import 'package:avrai/core/ai/rag_feedback_signals.dart';
import 'package:avrai/core/ai/rag_formatter.dart';
import 'package:avrai/core/ai/retrieval_service.dart';
  ...
  Future<void> _recordFeedback({
    ...
    try {
      ...
      if (_conversationPrefsStore != null) {
        ...
        await _conversationPrefsStore
            .updateFromTurn(prefsKey, usedBypass: usedBypass);
      }
    } catch (e) {
