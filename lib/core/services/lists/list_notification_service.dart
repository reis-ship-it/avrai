...
class ListNotificationService {
    ...
    try {
      ...
      if (settings.authorizationStatus == fcm.AuthorizationStatus.authorized ||
        ...
        if (_fcmToken != null) {
          ...
          developer.log('FCM token obtained: ${_fcmToken?.substring(0, 20)}...', name: _logName);
        }
  ...
  Future<void> _loadPreferences() async {
    try {
      ...
      developer.log('Error loading notification preferences: $e', name: _logName);
    }
  }
  ...
  Future<void> savePreferences({
    ...
    try {
      ...
      developer.log('Error saving notification preferences: $e', name: _logName);
    }
  }
