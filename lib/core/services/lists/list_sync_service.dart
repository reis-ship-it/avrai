...
class ListSyncService {
  ...
  Future<List<SuggestedListState>> syncFromServer({
    ...
    try {
      developer.log('Syncing lists from server for user: $userId', name: _logName);
  ...
  Future<void> syncListState({
    ...
    try {
      ...
      developer.log('Error syncing to server, queuing operation: $e', name: _logName);
  ...
  Future<void> _processPendingOperations() async {
    ...
    for (final op in operations) {
      try {
        ...
        developer.log('Failed to process pending operation: $e', name: _logName);
