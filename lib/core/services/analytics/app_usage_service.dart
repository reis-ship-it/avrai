...
class AppUsageService {
  ...
  bool get isAvailable => _isInitialized && _hasPermission && Platform.isAndroid;
  ...
  Map<String, dynamic> _deriveLearningSignals(Map<String, dynamic> usageData) {
    final categoryUsage = usageData['category_usage'] as Map<String, int>? ?? {};
    ...
    final entertainmentPercent = _getPercent(categoryUsage['entertainment'], totalMinutes);
    final productivityPercent = _getPercent(categoryUsage['productivity'], totalMinutes);
