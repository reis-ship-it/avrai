...
class CalendarTrackingService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _hasPermission = permissionResult.isSuccess && permissionResult.data == true;
  ...
  Future<Map<String, dynamic>> getCalendarPatterns() async {
    ...
    return {
      ...
      'events_with_location_percent':
          totalEvents > 0 ? (eventsWithLocation / totalEvents * 100).round() : 0,
      'recurring_percent':
