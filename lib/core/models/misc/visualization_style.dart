...
class KnotVisualizationStyle extends VisualizationStyle {
  ...
  KnotVisualizationStyle({
    this.type = 'metallic',
    this.primaryColor = 0x00FF66, // AppColors.electricGreen
...
/// Helper to convert Flutter Color to hex int for Three.js
extension ColorToHex on Color {
  /// Convert Color to hex int (without alpha)
  int toHex() {
...
class VisualizationStyleFactory {
  ...
  static KnotVisualizationStyle knotFromBrand({
    ...
    return KnotVisualizationStyle(
      ...
      secondaryColor: AppColors.primaryLight.toHex(),
      glowColor: AppColors.electricGreen.toHex(),
      lod: lod,
      autoRotate: autoRotate,
    );
  }
  ...
  static FabricVisualizationStyle fabricFromBrand({
    ...
    return FabricVisualizationStyle(
      highlightColor: AppColors.white.toHex(),
      lod: lod,
    );
  }
  ...
  static NetworkVisualizationStyle networkFromBrand() {
    return NetworkVisualizationStyle(
      nodeColor: AppColors.electricGreen.toHex(),
      edgeColor: AppColors.electricGreen.toHex(),
      centerColor: AppColors.white.toHex(),
    );
  }
}
