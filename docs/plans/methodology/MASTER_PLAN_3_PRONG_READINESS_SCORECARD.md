...
|------|-----------------|-------|---------------|----------------|
| G1 Lifecycle coverage (100% governed claims) | Red | Platform Eng | - | M4-P3-1 lifecycle baseline and code evidence |
| G2 Conviction/policy enforcement on high-impact actions | Red | Runtime/OS Eng | - | M5-P3-1 production gate authority; shadow bypass target <= 2.0% |
| G3 Independent replication before operational/canonical | Red | ML Research | - | M5-P3-3 replication queue and SLA |
| G4 Canary + rollback live-fire drill success | Red | Reliability | - | M5-P3-2 canary rollback automation |
| G5 Self-healing SLO (detect -> contain -> recover) | Red | Reliability | - | M6-P3-1 cross-domain incident routing |
| G6 Transparency coverage (confidence/provenance surfaces) | Red | Product | - | M5/M6 transparency UX coverage |
| G7 Immutable audit reconstruction completeness | Red | Governance/Security | - | M6-P3-3 final readiness audit package |
...
|------|-----------------|----------------------|
| AVRAI Product | Red | High-impact surfaces show confidence/provenance/last-validated; user correction loop live |
| AVRAI OS | Red | Conviction gate enforced; canary+rollback active; policy/audit logs immutable |
| Reality System | Red | Promotion ladder enforced; contradiction auto-demotion active; novelty quarantine in place |
