...
abstract class ListsRepository {
  ...
  Future<void> approveCollaborationRequest(
      String userId, String listId, String approvedBy);

  /// Deny collaboration request
  Future<void> denyCollaborationRequest(
      String userId, String listId, String deniedBy);
  ...
  Future<void> updateUserRoleInList(
      String userId, String listId, ListRole role);
