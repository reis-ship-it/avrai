...
class ReplayScenarioPacket {
  ...
  static const int defaultReplayYear = requiredBhamReplayYear;
  static const String defaultSimulationCityCode = 'simulation';
  ...
  bool get isReplayValid =>
      baseReplayYear > 0 && cityCode.isNotEmpty && isReplayOnly;
  ...
  ReplayScenarioPacket normalized() {
    return ReplayScenarioPacket(
      ...
      cityCode: cityCode,
      baseReplayYear: baseReplayYear <= 0 ? defaultReplayYear : baseReplayYear,
  ...
  Map<String, dynamic> toJson() {
    ...
    return <String, dynamic>{
      ...
      'baseReplayYear': normalizedPacket.baseReplayYear,
  ...
  factory ReplayScenarioPacket.fromJson(Map<String, dynamic> json) {
    return ReplayScenarioPacket(
      ...
      cityCode: json['cityCode'] as String? ?? defaultSimulationCityCode,
      baseReplayYear:
          (json['baseReplayYear'] as num?)?.toInt() ?? defaultReplayYear,
