...
// Removed runtime/avrai_runtime_os/services/expertise/expertise_service.dart
...
class UnifiedUser extends Equatable {
  ...
  List<ExpertisePin> getExpertisePins() {
    // NOTE: Generating ExpertisePins from ExpertiseLevels should be handled in apps or services layer.
    // Core model is data-only.
    // For now, this is returning an empty list. Implement presentation mapping where needed.
    return [];
  }
