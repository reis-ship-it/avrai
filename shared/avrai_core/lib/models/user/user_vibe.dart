...
class UserVibe {
  ...
  factory UserVibe.fromPersonalityProfile(
      String userId, Map<String, double> personalityDimensions,
    ...
    return UserVibe(
      ...
      createdAt: now,
      expiresAt:
          now.add(const Duration(days: VibeConstants.vibeSignatureExpiryDays)),
  ...
  double calculateVibeCompatibility(UserVibe other) {
    ...
    final overallCompatibility = (dimensionCompatibility * 0.6 +
  ...
  Map<String, dynamic> getAnonymizedSummary() {
    return {
      'signature_hash':
          hashedSignature.substring(0, 8), // Truncated for display
  ...
  factory UserVibe.fromJson(Map<String, dynamic> json) {
    return UserVibe(
      ...
      anonymizedDimensions:
          Map<String, double>.from(json['anonymized_dimensions']),
