...
class UsagePattern extends Equatable {
  ...
  final Map<String, double>
      receptivityByTime; // morning, afternoon, evening, night

  // What doors have they opened?
  final List<String>
      openedDoorTypes; // 'spots', 'communities', 'events', 'people'
  ...
  factory UsagePattern.fromJson(Map<String, dynamic> json) {
    return UsagePattern(
      userId: json['userId'],
      recommendationFocus:
          (json['recommendationFocus'] as num?)?.toDouble() ?? 0.5,
      ...
      receptivityByContext:
          Map<String, double>.from(json['receptivityByContext'] ?? {}),
      receptivityByTime:
          Map<String, double>.from(json['receptivityByTime'] ?? {}),
      ...
      totalCommunitiesJoined:
          (json['totalCommunitiesJoined'] as num?)?.toInt() ?? 0,
  ...
  UsagePattern copyWith({
    ...
    return UsagePattern(
      ...
      totalCommunitiesJoined:
          totalCommunitiesJoined ?? this.totalCommunitiesJoined,
