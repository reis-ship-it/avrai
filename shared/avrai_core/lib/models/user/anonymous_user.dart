    ...
    return AnonymousUser(
      ...
      personalityDimensions: json['personalityDimensions'] != null
          ? PersonalityProfile.fromJson(
              json['personalityDimensions'] as Map<String, dynamic>)
          : null,
  ...
  AnonymousUser copyWith({
    ...
    return AnonymousUser(
      ...
      personalityDimensions:
          personalityDimensions ?? this.personalityDimensions,
...
class ObfuscatedLocation extends Equatable {
  ...
  @override
  List<Object?> get props =>
      [city, state, country, latitude, longitude, expiresAt];
}
