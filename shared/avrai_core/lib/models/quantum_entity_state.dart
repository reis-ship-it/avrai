...
class QuantumEntityState {
  ...
  QuantumEntityState normalized() {
    ...
    return QuantumEntityState(
      ...
      quantumVibeAnalysis:
          quantumVibeAnalysis.map((k, v) => MapEntry(k, v * scale)),
  ...
  factory QuantumEntityState.fromJson(Map<String, dynamic> json) {
    return QuantumEntityState(
      ...
      personalityState:
          Map<String, double>.from(json['personalityState'] as Map),
      quantumVibeAnalysis:
          Map<String, double>.from(json['quantumVibeAnalysis'] as Map),
      entityCharacteristics:
          Map<String, dynamic>.from(json['entityCharacteristics'] as Map),
      location: json['location'] != null
          ? EntityLocationQuantumState.fromJson(
              json['location'] as Map<String, dynamic>)
          : null,
      timing: json['timing'] != null
          ? EntityTimingQuantumState.fromJson(
              json['timing'] as Map<String, dynamic>)
          : null,
      tAtomic:
          AtomicTimestamp.fromJson(json['tAtomic'] as Map<String, dynamic>),
      normalizationFactor:
          (json['normalizationFactor'] as num?)?.toDouble() ?? 1.0,
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is QuantumEntityState &&
        other.entityId == entityId &&
        other.tAtomic.timestampId == tAtomic.timestampId;
  }
...
class EntityTimingQuantumState {
  ...
  int get dayOfWeekIndex {
    ...
    return dayOfWeekPreference > 0.5
        ? 6
        : 0; // Weekend -> Sunday, Weekday -> Monday
  }
