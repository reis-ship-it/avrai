...
class GeographicExpansion extends Equatable {
  ...
  bool hasReachedGlobalThreshold() {
    ...
    final totalCoverage =
        nationCoverage.values.fold(0.0, (sum, coverage) => sum + coverage);
  ...
  factory GeographicExpansion.fromJson(Map<String, dynamic> json) {
    ...
    try {
      final payload = <String, dynamic>{
        ...
        'hypothesisId': 'H5',
        'location':
            'lib/core/models/geographic/geographic_expansion.dart:GeographicExpansion.fromJson',
        'message': 'fromJson map runtime types',
        'data': {
          'localityCoverage_type':
              json['localityCoverage']?.runtimeType.toString(),
    ...
    final eventHostingLocationsMap =
        asStringKeyedMap(json['eventHostingLocations']);
  ...
  GeographicExpansion copyWith({
    ...
    return GeographicExpansion(
      ...
      eventHostingLocations:
          eventHostingLocations ?? this.eventHostingLocations,
