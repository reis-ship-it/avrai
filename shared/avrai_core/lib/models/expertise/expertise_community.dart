...
class ExpertiseCommunity extends Equatable {
  ...
  ExpertiseCommunity copyWith({
    ...
    return ExpertiseCommunity(
      ...
      location:
          location is _CopyWithSentinel ? this.location : location as String?,
      name: name ?? this.name,
      description: description is _CopyWithSentinel
          ? this.description
          : description as String?,
      memberIds: memberIds ?? this.memberIds,
      memberCount: memberCount ?? this.memberCount,
      minLevel: minLevel is _CopyWithSentinel
          ? this.minLevel
          : minLevel as ExpertiseLevel?,
