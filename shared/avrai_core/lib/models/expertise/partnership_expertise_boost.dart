...
class PartnershipExpertiseBoost extends Equatable {
  ...
  factory PartnershipExpertiseBoost.fromJson(Map<String, dynamic> json) {
    return PartnershipExpertiseBoost(
      ...
      vibeCompatibilityBoost:
          (json['vibeCompatibilityBoost'] as num?)?.toDouble() ?? 0.0,
      revenueSuccessBoost:
          (json['revenueSuccessBoost'] as num?)?.toDouble() ?? 0.0,
      ...
      relatedCategoryBoost:
          (json['relatedCategoryBoost'] as num?)?.toDouble() ?? 0.0,
      unrelatedCategoryBoost:
          (json['unrelatedCategoryBoost'] as num?)?.toDouble() ?? 0.0,
  ...
  PartnershipExpertiseBoost copyWith({
    ...
    return PartnershipExpertiseBoost(
      ...
      vibeCompatibilityBoost:
          vibeCompatibilityBoost ?? this.vibeCompatibilityBoost,
      ...
      unrelatedCategoryBoost:
          unrelatedCategoryBoost ?? this.unrelatedCategoryBoost,
