...
class BusinessExpertPreferences extends Equatable {
  ...
  final String?
      preferredLocation; // Specific location (e.g., "Brooklyn", "NYC")
  ...
  final List<String>?
      preferredBackgrounds; // e.g., ["Restaurant", "Hospitality", "Retail"]
  final List<String>?
      preferredCertifications; // e.g., ["Food Safety", "Sommelier"]
  final List<String>? preferredSkills; // Specific skills beyond expertise

  // Personality & Work Style Preferences
  final List<String>?
      preferredPersonalityTraits; // e.g., ["Outgoing", "Detail-oriented", "Creative"]
  final List<String>?
      preferredWorkStyles; // e.g., ["Collaborative", "Independent", "Leadership"]
  final List<String>?
      preferredCommunicationStyles; // e.g., ["Direct", "Diplomatic", "Enthusiastic"]

  // Availability Preferences
  final List<String>?
      preferredAvailability; // e.g., ["Weekdays", "Evenings", "Weekends"]
  final bool requireFlexibleSchedule;

  // Engagement Preferences
  final List<String>?
      preferredEngagementTypes; // e.g., ["Consulting", "Partnership", "Mentorship"]
  ...
  final Map<String, dynamic>
      aiMatchingCriteria; // Custom criteria for AI matching
  ...
  factory BusinessExpertPreferences.fromJson(Map<String, dynamic> json) {
    return BusinessExpertPreferences(
      requiredExpertiseCategories:
          List<String>.from(json['requiredExpertiseCategories'] ?? []),
      preferredExpertiseCategories:
          List<String>.from(json['preferredExpertiseCategories'] ?? []),
      ...
      requireFlexibleSchedule:
          json['requireFlexibleSchedule'] as bool? ?? false,
      ...
      preferLongTermRelationships:
          json['preferLongTermRelationships'] as bool? ?? false,
      ...
      aiMatchingCriteria:
          Map<String, dynamic>.from(json['aiMatchingCriteria'] ?? {}),
  ...
  BusinessExpertPreferences copyWith({
    ...
    assert(() {
      ...
      try {
        ...
        final payload = <String, dynamic>{
          ...
          'data': {
            'preferredLocation_isSentinel':
                preferredLocation is _CopyWithSentinel,
            'preferredLocation_value': preferredLocation is _CopyWithSentinel
                ? null
                : preferredLocation,
          },
    ...
    return BusinessExpertPreferences(
      requiredExpertiseCategories:
          requiredExpertiseCategories ?? this.requiredExpertiseCategories,
      preferredExpertiseCategories:
          preferredExpertiseCategories ?? this.preferredExpertiseCategories,
      minExpertLevel: minExpertLevel is _CopyWithSentinel
          ? this.minExpertLevel
          : minExpertLevel as int?,
      preferredExpertLevel: preferredExpertLevel is _CopyWithSentinel
          ? this.preferredExpertLevel
          : preferredExpertLevel as int?,
      preferredLocation: preferredLocation is _CopyWithSentinel
          ? this.preferredLocation
          : preferredLocation as String?,
      preferredLocations: preferredLocations is _CopyWithSentinel
          ? this.preferredLocations
          : preferredLocations as List<String>?,
      maxDistanceKm: maxDistanceKm is _CopyWithSentinel
          ? this.maxDistanceKm
          : maxDistanceKm as int?,
      allowRemote: allowRemote ?? this.allowRemote,
      preferredAgeRange: preferredAgeRange is _CopyWithSentinel
          ? this.preferredAgeRange
          : preferredAgeRange as AgeRange?,
      preferredLanguages: preferredLanguages is _CopyWithSentinel
          ? this.preferredLanguages
          : preferredLanguages as List<String>?,
      minYearsExperience: minYearsExperience is _CopyWithSentinel
          ? this.minYearsExperience
          : minYearsExperience as int?,
      preferredBackgrounds: preferredBackgrounds is _CopyWithSentinel
          ? this.preferredBackgrounds
          : preferredBackgrounds as List<String>?,
      preferredCertifications: preferredCertifications is _CopyWithSentinel
          ? this.preferredCertifications
          : preferredCertifications as List<String>?,
      preferredSkills: preferredSkills is _CopyWithSentinel
          ? this.preferredSkills
          : preferredSkills as List<String>?,
      preferredPersonalityTraits:
          preferredPersonalityTraits is _CopyWithSentinel
              ? this.preferredPersonalityTraits
              : preferredPersonalityTraits as List<String>?,
      preferredWorkStyles: preferredWorkStyles is _CopyWithSentinel
          ? this.preferredWorkStyles
          : preferredWorkStyles as List<String>?,
      preferredCommunicationStyles:
          preferredCommunicationStyles is _CopyWithSentinel
              ? this.preferredCommunicationStyles
              : preferredCommunicationStyles as List<String>?,
      preferredAvailability: preferredAvailability is _CopyWithSentinel
          ? this.preferredAvailability
          : preferredAvailability as List<String>?,
      requireFlexibleSchedule:
          requireFlexibleSchedule ?? this.requireFlexibleSchedule,
      preferredEngagementTypes: preferredEngagementTypes is _CopyWithSentinel
          ? this.preferredEngagementTypes
          : preferredEngagementTypes as List<String>?,
      preferredCommitmentLevel: preferredCommitmentLevel is _CopyWithSentinel
          ? this.preferredCommitmentLevel
          : preferredCommitmentLevel as int?,
      preferLongTermRelationships:
          preferLongTermRelationships ?? this.preferLongTermRelationships,
      preferredCommunities: preferredCommunities is _CopyWithSentinel
          ? this.preferredCommunities
          : preferredCommunities as List<String>?,
      preferCommunityLeaders:
          preferCommunityLeaders ?? this.preferCommunityLeaders,
      minCommunityConnections: minCommunityConnections is _CopyWithSentinel
          ? this.minCommunityConnections
          : minCommunityConnections as int?,
      aiMatchingCriteria: aiMatchingCriteria ?? this.aiMatchingCriteria,
      minMatchScore: minMatchScore is _CopyWithSentinel
          ? this.minMatchScore
          : minMatchScore as double?,
      aiKeywords: aiKeywords is _CopyWithSentinel
          ? this.aiKeywords
          : aiKeywords as List<String>?,
      aiMatchingPrompt: aiMatchingPrompt is _CopyWithSentinel
          ? this.aiMatchingPrompt
          : aiMatchingPrompt as String?,
      excludedExpertise: excludedExpertise is _CopyWithSentinel
          ? this.excludedExpertise
          : excludedExpertise as List<String>?,
      excludedLocations: excludedLocations is _CopyWithSentinel
          ? this.excludedLocations
          : excludedLocations as List<String>?,
    );
  }
