...
class BusinessVerification extends Equatable {
  ...
  factory BusinessVerification.fromJson(Map<String, dynamic> json) {
    return BusinessVerification(
      ...
      method: VerificationMethodExtension.fromString(
          json['method'] as String? ?? 'automatic'),
  ...
  BusinessVerification copyWith({
    ...
    try {
      final payload = <String, dynamic>{
        ...
        'hypothesisId': 'H7',
        'location':
            'lib/core/models/business/business_verification.dart:BusinessVerification.copyWith',
        'message': 'copyWith nullable field handling',
        'data': {
          'legalBusinessName_param_is_unset':
              identical(legalBusinessName, _unset),
