      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            const Text(
              'This kernel surface was opened from the command-center attention queue with carried operator context.',
            ),
            ...
            Wrap(
              ...
              children: [
                if (widget.initialView != null &&
                    widget.initialView!.isNotEmpty)
                  Chip(label: Text('View: ${widget.initialView}')),
                if (widget.initialFocus != null &&
...
class _GovernanceRecentCardState extends State<_GovernanceRecentCard> {
  ...
  static const KernelGovernanceWhyProjectionService _whyProjection =
      KernelGovernanceWhyProjectionService();
  ...
  void _showDecisionDetails(KernelGovernanceTelemetryEvent event) {
    final explanation = _whyProjection.explainEvent(
      event,
      perspective: WhyRequestedPerspective.admin,
    );
