...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  })  : _oauthDeepLinkHandler =
            GetIt.instance.isRegistered<OAuthDeepLinkHandler>()
                ? GetIt.instance<OAuthDeepLinkHandler>()
                : null,
        super(AuthInitial()) {
  ...
  Future<void> _onPasswordResetRequested(
    ...
    emit(AuthLoading());
    try {
      final authBackend = GetIt.instance<AuthBackend>();
  ...
  Future<void> _onSignOutRequested(
    ...
    try {
      ...
      try {
        ...
        if (GetIt.instance
            .isRegistered<AdminConversationStyleHydrationService>()) {
          await GetIt.instance<AdminConversationStyleHydrationService>()
  ...
  Future<void> _postLoginInit({
    ...
    try {
      ...
      if (allowCloudLoad && password != null && password.isNotEmpty) {
        final syncService = GetIt.instance<PersonalitySyncService>();
    ...
    try {
      ...
      _logger.debug(
        'AuthBloc: Admin conversation-style hydration skipped: $e',
        tag: 'AuthBloc',
      );
    }
