...
Wave-31 command-center operator layer:
- The command center now includes an oversight cockpit, AI2AI mesh health summary, temporal replay snapshot, kernel + sandbox research summary, and a shared `Needs Attention` queue.
- `Needs Attention` items carry direct deep links with handoff context into Launch Safety, AI2AI, Reality Oversight, URK, and Research Center.
- Top-level command-center actions are bounded to operator-safe workflows such as controlled validation and field-proof export.
