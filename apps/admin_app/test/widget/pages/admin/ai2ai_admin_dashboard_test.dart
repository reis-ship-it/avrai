    ...
    testWidgets('renders command-center handoff context when provided',
      ...
      final widget = WidgetTestHelpers.createTestableWidget(
        child: const AI2AIAdminDashboard(
          useThreeJsVisualizations: false,
          initialFocus: 'mesh_rejects',
          initialAttention: 'mesh_rejected_announces',
        ),
      );
      ...
      expect(find.text('Focus: mesh_rejects'), findsOneWidget);
      expect(find.text('Attention: mesh_rejected_announces'), findsOneWidget);
    });
  });
}
