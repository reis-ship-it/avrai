...
import 'package:avrai_core/enums/list_enums.dart';
import 'package:avrai_core/models/spot.dart';
import 'package:avrai_core/models/spot_list.dart';
...
class WidgetTestHelpers {
  ...
  static SpotList createTestList({
    ...
    return SpotList(
      ...
      type: isPublic ? ListType.public : ListType.private,
      createdAt: now,
      updatedAt: now,
      curatorId: curatorId,
      isPublic: isPublic,
