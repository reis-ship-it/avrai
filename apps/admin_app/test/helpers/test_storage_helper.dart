...
class TestStorageHelper {
  ...
  static const List<String> _boxNames = [
    ...
    'bham_admin_support_chat',
    'bham_direct_match',
    'bham_event_chat',
    'bham_event_chat_memberships',
    'bham_route_learning',
    'bham_notification_policy',
    'bham_admin_moderation',
    'bham_admin_break_glass',
    'bham_launch_evidence',
    'bham_launch_controls',
