...
class TestHelpers {
  ...
  static void expectDeepEquals(
      dynamic actual, dynamic expected, String context) {
  ...
  static void mockConnectivityError(
      Connectivity connectivityMock, Exception error) {
  ...
  static void verifyMethodCall(
      Mock mock, String methodName, List<dynamic> args) {
