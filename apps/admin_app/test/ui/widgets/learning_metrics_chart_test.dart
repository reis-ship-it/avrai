...
void main() {
  group('LearningMetricsChart Widget Tests', () {
    ...
    testWidgets('should display learning metrics chart with all UI elements',
      ...
      expect(chartPaint,
          findsAtLeastNWidgets(1)); // At least one CustomPaint for the chart
    });

    testWidgets('should display CustomPaint with chart painter',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
    ...
    testWidgets('should switch to bar chart when bar button is tapped',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should switch to area chart when area button is tapped',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should switch time range when time range button is tapped',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should switch to hour time range when 1H button is tapped',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should switch to month time range when 1M button is tapped',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should toggle metric selection when legend item is tapped',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should have interactive chart area for tapping',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should have chart area that can be tapped for metric details',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
      final widget = WidgetTestHelpers.createTestableWidget(
    ...
    testWidgets('should display all legend items with correct labels',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
    ...
    testWidgets('should display chart type selector buttons with icons',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
    ...
    testWidgets('should render chart with different metric values',
        (WidgetTester tester) async {
    ...
    testWidgets('should maintain line chart as default selection',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
    ...
    testWidgets('should maintain day time range as default selection',
        (WidgetTester tester) async {
      // Arrange
      final metrics = createTestMetrics();
