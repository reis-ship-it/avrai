...
class ModelFactories {
  ...
  static UnifiedUser createAgeVerifiedUser({
    ...
    return createTestUser(
      ...
      isAgeVerified: true,
      ageVerificationDate:
          ageVerificationDate ?? TestHelpers.createTestDateTime(),
    );
  }
  ...
  static PersonalityProfile createAdventurousExplorerProfile(
  ...
  static PersonalityProfile createCommunityCuratorProfile(
      {String? userId, String? agentId}) {
    return createTestPersonalityProfile(
      userId: userId,
      agentId: agentId,
  ...
  static Map<String, double> _createTestConfidence(
      Map<String, double> dimensions) {
