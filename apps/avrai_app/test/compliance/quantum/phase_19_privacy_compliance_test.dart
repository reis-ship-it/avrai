...
void main() {
  group('Phase 19 Privacy Compliance Tests', () {
    ...
    group('AgentId-Only Validation', () {
      test('should use agentId exclusively, never userId in matching results',
          () async {
        // Arrange
    ...
    group('GDPR Compliance', () {
      ...
      test('should validate privacy compliance', () async {
        ...
        final validation =
            await privacyService.validatePrivacy(data: compliantData);
      ...
      test('should detect privacy violations', () async {
        ...
        // Act: Validate privacy
        final validation =
            await privacyService.validatePrivacy(data: nonCompliantData);
    ...
    group('CCPA Compliance', () {
      test('should validate privacy for data deletion scenarios', () async {
        ...
        final validation =
            await privacyService.validatePrivacy(data: dataToDelete);
    ...
    group('Privacy Audit', () {
      test('should pass privacy audit - no userId in third-party data',
          () async {
