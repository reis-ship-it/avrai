...
// import 'package:avrai_runtime_os/path/component.dart';
  ...
  group('Component', () {
    ...
    group('performAction', () {
      ...
      test('should handle dependency errors gracefully', () async {
        // Arrange
        when(() => mockDependency.method())
            .thenThrow(Exception('Dependency error'));
    ...
    group('calculateValue', () {
      test(
          'should calculate value and throw ArgumentError for negative numbers',
          () {
