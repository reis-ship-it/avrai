...
// import 'package:avrai_runtime_os/services/service_name.dart';
  ...
  group('ServiceName', () {
    ...
    group('method1', () {
      test('should perform expected behavior when condition is met', () async {
        // Arrange
        when(() => mockDependency1.method(any()))
        ...
        expect(result.property,
            equals('value')); // TODO: Replace with actual property check
    ...
    group('method2', () {
      test('should perform expected behavior and another behavior', () async {
        ...
        // Arrange
        when(() => mockDependency2.method(any()))
    ...
    group('Error Handling', () {
      test('should handle specific error and return appropriate response',
          () async {
        // Arrange
        when(() => mockDependency1.method(any()))
