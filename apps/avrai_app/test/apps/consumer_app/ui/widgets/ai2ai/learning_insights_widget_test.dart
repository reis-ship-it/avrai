...
void main() {
  group('LearningInsightsWidget Widget Tests', () {
    testWidgets('should display empty state when no insights',
      ...
      expect(
          find.text('Insights will appear as your AI learns from interactions'),
          findsOneWidget);
    ...
    testWidgets('should display count chip when insights exist',
        (WidgetTester tester) async {
    ...
    testWidgets('should limit displayed insights to 5 items',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should display exactly 5 insights when list has exactly 5 items',
        (WidgetTester tester) async {
    ...
    testWidgets('should display insight details correctly',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should display high reliability icon (>=0.8) for high reliability insights',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should display medium reliability icon (>=0.5, <0.8) for medium reliability insights',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should display low reliability icon (<0.5) for low reliability insights',
        (WidgetTester tester) async {
    ...
    testWidgets('should format timestamp as days ago when difference is days',
        (WidgetTester tester) async {
    ...
    testWidgets('should format timestamp as hours ago when difference is hours',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should format timestamp as minutes ago when difference is minutes',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should format timestamp as "Just now" when difference is less than a minute',
        (WidgetTester tester) async {
    ...
    testWidgets('should format value and reliability as percentages correctly',
        (WidgetTester tester) async {
    ...
    testWidgets('should display multiple insights with correct details',
        (WidgetTester tester) async {
      ...
      expect(find.text('User shows strong preference for adventure activities'),
          findsOneWidget);
      expect(find.text('Social Patterns'), findsOneWidget);
      expect(find.text('Moderate social interaction patterns detected'),
          findsOneWidget);
    ...
    testWidgets('should display card with correct styling',
        (WidgetTester tester) async {
      // Arrange
      final insights = [
        SharedInsight(
