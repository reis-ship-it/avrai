...
void main() {
  group('EvolutionTimelineWidget Widget Tests', () {
    testWidgets('should display empty state when no milestones',
      ...
      expect(find.text('Milestones will appear as your personality evolves'),
          findsOneWidget);
    ...
    testWidgets('should display statistics correctly',
        (WidgetTester tester) async {
    ...
    testWidgets('should display milestones when they exist',
        (WidgetTester tester) async {
      ...
      final profile = PersonalityProfile(
        ...
        authenticity: 0.8,
        createdAt:
            TestHelpers.createTestDateTime().subtract(const Duration(days: 30)),
        lastUpdated: TestHelpers.createTestDateTime(),
    ...
    testWidgets(
        'should limit displayed milestones to 10 when more than 10 exist',
        (WidgetTester tester) async {
      // Arrange: Profile with 15 milestones
      final milestones = List<DateTime>.generate(
          15,
          (index) => TestHelpers.createTestDateTime()
              .subtract(Duration(days: 15 - index)));
      // Phase 8.3: Use agentId for privacy protection
      final profile = PersonalityProfile(
        agentId: 'agent_test-user-id',
        userId: 'test-user-id',
    ...
    testWidgets('should display all milestones when exactly 10 exist',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should display milestones in reverse order (most recent first)',
        (WidgetTester tester) async {
    ...
    testWidgets('should highlight latest milestone with success color',
        (WidgetTester tester) async {
      ...
      expect(latestIndicator,
          findsOneWidget); // Only the latest milestone has success color
      ...
      expect(greyIndicators,
          findsNWidgets(2)); // Two older milestones have grey color
    });

    testWidgets('should format date as "Today" when milestone is today',
        (WidgetTester tester) async {
      ...
      expect(find.text('Today'),
          findsAtLeastNWidgets(1)); // Appears in milestone and possibly dates
    });

    testWidgets('should format date as "Yesterday" when milestone is yesterday',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should format date as "X days ago" when milestone is 2-6 days ago',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should format date as "MM/DD/YYYY" when milestone is 7+ days ago',
        (WidgetTester tester) async {
    ...
    testWidgets('should display created and last updated dates',
        (WidgetTester tester) async {
