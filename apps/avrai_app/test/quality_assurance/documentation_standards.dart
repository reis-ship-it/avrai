...
''';
    ...
    await File('$DOCS_PATH/guides/testing_guidelines.md')
...
// import 'package:avrai_core/models/your_model.dart';
...
''';
    ...
    await File('$TEMPLATE_PATH/unit_test_template.dart')
        .writeAsString(unitTemplate);
...
''';
    ...
    await File('$TEMPLATE_PATH/widget_test_template.dart')
        .writeAsString(widgetTemplate);
...
''';
    ...
    await File('$TEMPLATE_PATH/integration_test_template.dart')
        .writeAsString(integrationTemplate);
  }
...
import 'package:avrai_runtime_os/domain/entities/unified_user.dart';
...
import 'package:avrai_runtime_os/data/datasources/spots_remote_datasource.dart';

// ❌ BAD: Domain depending on data layer
import 'package:avrai_runtime_os/data/models/spot_model.dart'; // In domain test
```
...
''';
    ...
    await File('$DOCS_PATH/guides/architecture_guide.md')
        .writeAsString(content);
  }
...
''';
    ...
    await File('$DOCS_PATH/standards/quality_standards.md')
        .writeAsString(content);
  }
