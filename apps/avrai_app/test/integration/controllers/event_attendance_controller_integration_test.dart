...
void main() {
  group('EventAttendanceController Integration Tests', () {
    ...
    group('AVRAI Core System Integration', () {
      ...
      test('should handle fabric creation for group attendance gracefully',
          () async {
        ...
        // Assert
        expect(result.success, isTrue,
            reason: 'Should succeed for group attendance');
        expect(result.event, isNotNull, reason: 'Event should be updated');
        // Fabric creation is deferred until all attendees have knots, so it shouldn't block registration
      });

      test('should handle quantum compatibility calculation gracefully',
          () async {
        ...
        expect(result.success, isTrue,
            reason:
                'Should succeed even if quantum compatibility calculation fails');
