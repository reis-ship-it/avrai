...
void main() {
  group('P2P System Integration Tests', () {
    ...
    test('should create encrypted data silos for organization privacy',
        () async {
    ...
    test('should reject training data containing personal identifiers',
        () async {
    ...
    test('should handle data synchronization with privacy preservation',
        () async {
    ...
    test('should comply with OUR_GUTS.md principles in P2P operations',
        () async {
      final node = await nodeManager.initializeNode(
        NetworkType.university,
      ...
      expect(node.networkType,
          isIn([NetworkType.university, NetworkType.company]));
