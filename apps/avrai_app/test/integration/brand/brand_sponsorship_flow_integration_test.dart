  ...
  group('Brand Sponsorship Flow Integration Tests', () {
    ...
    setUp(() {
      ...
      testUser = testUser.copyWith(
        ...
        location:
            'San Francisco', // Set location to match event location for city expert
      );
    ...
    test('multi-party sponsorship flow with partnership', () async {
      ...
      final partnerships =
          await partnershipService.getPartnershipsForEvent(createdEvent.id);
      final sponsorships =
          await sponsorshipService.getSponsorshipsForEvent(createdEvent.id);
    ...
    test('sponsorship eligibility checks', () async {
      ...
      final isEligibleAfterVerification =
          await sponsorshipService.checkSponsorshipEligibility(
        eventId: createdEvent.id,
