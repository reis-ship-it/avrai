  ...
  group('Brand Discovery Services Integration Tests', () {
    ...
    group('Scenario 1: Brand Search for Events', () {
      ...
      test('should sort matches by compatibility score', () async {
        ...
        expect(matches.first.compatibilityScore,
            greaterThanOrEqualTo(matches.last.compatibilityScore));
      });
    });
    ...
    group('Scenario 4: Compatibility Scoring', () {
      test('should calculate compatibility score between brand and event',
          () async {
        // Arrange
        when(() => mockSponsorshipService.calculateCompatibility(
              eventId: 'event-456',
        ...
        // Act
        final compatibility =
            await brandDiscoveryService.calculateBrandEventCompatibility(
          brandId: 'brand-123',
          eventId: 'event-456',
        );
