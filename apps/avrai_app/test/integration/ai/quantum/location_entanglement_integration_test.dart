  ...
  group('Location Entanglement Integration Tests', () {
    ...
    group('Location Quantum State Generation', () {
      test('should generate location quantum states for user and spot', () {
        ...
        final userLocationState =
            LocationQuantumState.fromLocation(userLocation);
        final spotLocationState =
            LocationQuantumState.fromLocation(spotLocation);
    ...
    group('Enhanced Compatibility with Location Entanglement', () {
      test('should combine personality and location compatibility', () {
        ...
        expect(
            enhanced,
            greaterThan(personalityCompat *
                0.5)); // Should be higher than personality alone
      });
    ...
    group('SpotVibeMatchingService Integration', () {
      test('should use location entanglement when locations provided',
          () async {
    ...
    group('End-to-End Location Entanglement Flow', () {
      test('should complete full location entanglement workflow', () {
        ...
        final locationCompat =
            userLocationState.locationCompatibility(spotLocationState);
        ...
        expect(
            enhanced,
            greaterThan(personalityCompat *
                0.5)); // Should include location contribution
      });
    });
  });
}
