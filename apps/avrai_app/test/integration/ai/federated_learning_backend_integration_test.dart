  ...
  group('Federated Learning Backend Integration Tests', () {
    ...
    group('FederatedLearningSystem Integration', () {
      ...
      test('should aggregate model updates', () async {
        ...
        // Act
        final globalUpdate =
            await federatedLearningSystem.aggregateModelUpdates(
          round,
          updates,
        );
    ...
    group('Widget Backend Integration', () {
      testWidgets('FederatedLearningStatusWidget should display active rounds',
      ...
      testWidgets('FederatedParticipationHistoryWidget should display history',
          (WidgetTester tester) async {
        // Arrange
      ...
      // ignore: unused_local_variable
      testWidgets('PrivacyMetricsWidget should display metrics',
          (WidgetTester tester) async {
        // Arrange
        // ignore: unused_local_variable
        // ignore: unused_local_variable - May be used in callback or assertion
    ...
    group('Loading States', () {
      testWidgets('FederatedLearningStatusWidget should handle empty rounds',
          (WidgetTester tester) async {
        // Arrange
        final widget = WidgetTestHelpers.createTestableWidget(
          child: const FederatedLearningStatusWidget(),
        ...
        final hasEmptyState =
            find.textContaining('No active').evaluate().isNotEmpty ||
                find
                    .textContaining('No active learning rounds')
                    .evaluate()
                    .isNotEmpty ||
      ...
      testWidgets(
          'FederatedParticipationHistoryWidget should handle null history',
          (WidgetTester tester) async {
        // Arrange
        // FederatedParticipationHistoryWidget loads history internally via GetIt
        final widget = WidgetTestHelpers.createTestableWidget(
