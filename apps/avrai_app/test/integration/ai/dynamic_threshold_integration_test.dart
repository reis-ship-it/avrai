  ...
  group('Dynamic Threshold Integration Tests', () {
    ...
    group('Threshold Calculation', () {
      test('should calculate locality-specific thresholds', () async {
        ...
        final adjustedThresholds =
            await thresholdService.calculateLocalThreshold(
          locality: 'Greenpoint',
          category: 'Coffee',
        ...
        expect(adjustedThresholds.minAvgRating,
            equals(4.0)); // Rating doesn't change
        expect(adjustedThresholds.minTimeInCategory,
            equals(const Duration(days: 30))); // Time doesn't change
      });

      test('should lower thresholds for activities valued by locality',
          () async {
        const baseThresholds = ThresholdValues(
          minVisits: 10,
          minRatings: 5,
      ...
      test('should get threshold for specific activity', () async {
        ...
        final adjustedThreshold =
            await thresholdService.getThresholdForActivity(
          locality: 'Greenpoint',
    ...
    group('Activity Adjustment Logic', () {
      test('should apply 0.7x multiplier for highly valued activities',
          () async {
        const baseThreshold = 10.0;
