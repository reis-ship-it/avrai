...
void main() {
  ...
  group('AI Improvement UI Integration Tests', () {
    ...
    group('Page Initialization', () {
      testWidgets('should initialize service and display page content',
        ...
        await tester.pump(
            const Duration(milliseconds: 500)); // Allow service initialization
        await tester
            .pump(const Duration(seconds: 1)); // Allow widgets to render
        ...
        expect(hasContent || hasError, isTrue,
            reason:
                'Page should show either initialized widgets or error state');
      });

      testWidgets(
          'should display all four widget sections when service initializes successfully',
          (WidgetTester tester) async {
        ...
        final hasAnyWidget = find
                .byType(AIImprovementSection)
                .evaluate()
                .isNotEmpty ||
    ...
    group('Error Handling', () {
      testWidgets('should display error UI when service initialization fails',
          (WidgetTester tester) async {
      ...
      testWidgets('should allow retry after initialization error',
          (WidgetTester tester) async {
    ...
    group('Loading States', () {
      testWidgets('should show loading indicator during service initialization',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'should transition from loading to content after initialization',
          (WidgetTester tester) async {
        ...
        await tester
            .pump(const Duration(milliseconds: 500)); // Allow initialization
        ...
        expect(hasContent || hasError, isTrue,
            reason:
                'After initialization, should show content or error, not stuck in loading');
      });
    });

    group('Service-Widget Integration', () {
      testWidgets('should pass service instance to all widgets',
          (WidgetTester tester) async {
    ...
    group('User Interactions', () {
      testWidgets('should handle scrolling through all sections',
          (WidgetTester tester) async {
      ...
      testWidgets('should handle widget interactions without crashing',
          (WidgetTester tester) async {
