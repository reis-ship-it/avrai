...
import 'package:avrai/presentation/widgets/common/offline_indicator_widget.dart'
    show OfflineIndicatorWidget, OfflineBanner;
...
void main() {
  ...
  group('UI LLM Integration Tests', () {
    ...
    group('AIThinkingIndicator Integration', () {
      testWidgets('should show thinking indicator during LLM call',
          (tester) async {
        // Arrange
      ...
      testWidgets('should hide thinking indicator after LLM call completes',
          (tester) async {
      ...
      testWidgets('should show thinking indicator during action parsing',
          (tester) async {
    ...
    group('ActionSuccessWidget Integration', () {
      testWidgets(
          'should show success widget after successful action execution',
          (tester) async {
        // Arrange
      ...
      testWidgets('should show undo option for undoable actions',
          (tester) async {
        // Arrange
      ...
      testWidgets('should integrate with action execution flow',
          (tester) async {
                  ...
                  onPressed: () async {
                    ...
                    if (result.success && context.mounted) {
                      ...
                      showDialog(
                        context: context,
                        builder: (context) =>
                            ActionSuccessWidget(result: result),
                      );
                    }
                  },
    ...
    group('OfflineIndicatorWidget Integration', () {
      testWidgets('should show offline indicator when device is offline',
          (tester) async {
        // Arrange
        await tester.pumpWidget(
          const MaterialApp(
      ...
      testWidgets('should hide offline indicator when device is online',
          (tester) async {
        // Arrange
        await tester.pumpWidget(
          const MaterialApp(
      ...
      testWidgets('should integrate with connectivity monitoring',
          (tester) async {
    ...
    group('End-to-End Integration Flow', () {
      testWidgets(
          'should show complete flow: thinking indicator → LLM call → response',
          (tester) async {
      ...
      testWidgets(
          'should show complete action flow: parse → execute → success widget',
          (tester) async {
      ...
      testWidgets(
          'should handle offline flow: offline indicator → offline handling',
          (tester) async {
      ...
      testWidgets(
          'should handle error flow: thinking indicator → error → error dialog',
          (tester) async {
    ...
    group('Widget Integration Without Conflicts', () {
      testWidgets('should show all widgets together without UI conflicts',
          (tester) async {
                            ...
                            onPressed: () async {
                              ...
                              if (context.mounted) {
                                showDialog(
                                  ...
                                  builder: (context) => ActionSuccessWidget(
                                    result:
                                        ActionResult.success(intent: intent),
                                  ),
                                );
                              }
                            },
        ...
        if (successMessage.evaluate().isEmpty) {
          ...
          if (dialog.evaluate().isNotEmpty) {
            ...
            // ignore: avoid_print
            print(
                '⚠️ Success dialog not found - action may not have completed');
          }
        } else {
