...
void main() {
  group('Map Platform Selection Integration Tests', () {
    group('Android Platform', () {
      testWidgets(
        ...
        final googlePolyline =
            MapBoundaryConverter.toGoogleMapsPolyline(testBoundary);
    ...
    group('macOS Platform', () {
      testWidgets(
        ...
        final flutterPolyline =
            MapBoundaryConverter.toFlutterMapPolyline(testBoundary);
    ...
    group('Feature Verification', () {
      test(
          'should verify boundary conversion works for both map types on all platforms',
          () {
      ...
      test('should verify geohash overlay conversion works for both map types',
        ...
        final googlePolygon =
            MapBoundaryConverter.toGoogleMapsPolygon(testBoundary);
        expect(googlePolygon.points, hasLength(4));

        // Convert to flutter_map
        final flutterPolygon =
            MapBoundaryConverter.toFlutterMapPolygon(testBoundary);
