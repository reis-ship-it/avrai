...
void main() {
  group('Expertise-Event Integration Tests', () {
    ...
    group('Scenario 1: Expertise Requirements for Event Hosting', () {
      ...
      test('should allow City level expertise to host events (expanded scope)',
          () async {
      ...
      test('should prevent event hosting without Local level expertise',
          () async {
        ...
        expect(
            userWithoutExpertise.expertiseMap.containsKey('Coffee'), isFalse);
    ...
    group('Scenario 4: Expertise Progression Through Events', () {
      ...
      test('should track expertise progression through event lifecycle',
          () async {
        // Arrange
        final host = IntegrationTestHelpers.createUserWithCityExpertise(
          id: 'host-6',
