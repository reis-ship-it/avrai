...
void main() {
  group('Expertise-Partnership Integration Tests', () {
    ...
    group('Scenario 1: Expertise Requirements for Partnership Creation', () {
      test('should require Local level expertise to create partnership',
          () async {
        // Arrange
      ...
      test('should prevent partnership creation without Local level expertise',
          () async {
        // Arrange
    ...
    group('Scenario 2: Partnership Creation Contributing to Expertise', () {
      test('should track partnership creation as expertise contribution',
          () async {
        // Arrange
    ...
    group('Scenario 3: Expertise Level Affecting Partnership Eligibility', () {
      test('should allow partnerships for users with City+ level expertise',
          () async {
        // Arrange - City level
      ...
      test('should track partnership events in expertise calculation',
          () async {
        // Arrange
        final host = IntegrationTestHelpers.createUserWithCityExpertise(
          id: 'host-4',
