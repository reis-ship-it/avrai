  ...
  group('Expertise Services Integration Tests', () {
    ...
    group('Saturation to Requirements Flow', () {
      test('should adjust requirements based on saturation', () async {
        ...
        final lowMultiplier =
            saturationService.getSaturationMultiplier(lowSaturation);
        ...
        expect(
            ...
            greaterThanOrEqualTo(
                0.8)); // At least reduced or normal requirements

        // High saturation
        final highSaturation =
            await saturationService.analyzeCategorySaturation(
          category: 'Travel',
        ...
        final highMultiplier =
            saturationService.getSaturationMultiplier(highSaturation);
