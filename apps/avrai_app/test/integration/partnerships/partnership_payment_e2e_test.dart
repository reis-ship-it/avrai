...
class MockBusinessAccountService extends Mock
  ...
  group('Partnership Payment End-to-End Integration Tests', () {
    ...
    group('Full Partnership Payment Workflow', () {
      ...
      test('should handle 3-party partnership correctly', () async {
        ...
        expect(revenueSplit.parties[0].amount,
            closeTo(347.20, 0.01)); // 40% of $868
        expect(revenueSplit.parties[1].amount,
            closeTo(303.80, 0.01)); // 35% of $868
        expect(revenueSplit.parties[2].amount,
            closeTo(217.00, 0.01)); // 25% of $868
      });
    });
  });
}
