...
class MockProductTrackingService extends Mock
    implements ProductTrackingService {}
...
void main() {
  group('Revenue Split Services Integration Tests', () {
    ...
    group('Scenario 1: N-Way Brand Revenue Split', () {
      test('should calculate N-way split with user + business + brand',
          () async {
        // Arrange
        ...
        expect(revenueSplit.parties.length,
            greaterThanOrEqualTo(3)); // user + business + brand(s)
      });
    ...
    group('Scenario 2: Product Sales Revenue Split', () {
      test('should calculate product sales revenue split', () async {
        // Arrange
        final productTracking =
            IntegrationTestHelpers.createTestProductTracking(
        ...
        when(() => mockProductTrackingService
                .getProductTrackingById('product-track-123'))
        ...
        when(() => mockSponsorshipService.getSponsorshipById('sponsor-123'))
            .thenAnswer(
                (_) async => IntegrationTestHelpers.createTestSponsorship(
                      id: 'sponsor-123',
                      eventId: 'event-456',
                      brandId: 'brand-123',
        ...
        // Act
        final revenueSplit =
            await revenueSplitService.calculateProductSalesSplit(
