...
import 'package:avrai_core/models/expertise/expertise_event.dart'
    show ExpertiseEvent, ExpertiseEventType;
...
void main() {
  group('Feedback Flow Integration Tests', () {
    ...
    test('multiple feedback records aggregate correctly', () {
      ...
      final positiveCount =
          allFeedback.where((f) => f.overallRating >= 4.0).length;
      expect(positiveCount, equals(3));

      final wouldRecommendCount =
          allFeedback.where((f) => f.wouldRecommend).length;
    ...
    test('feedback calculates NPS score', () {
      ...
      final detractorCount = detractors
