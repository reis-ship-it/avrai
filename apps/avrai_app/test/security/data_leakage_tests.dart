...
void main() {
  group('Data Leakage Tests', () {
    ...
    group('AI2AI Service Data Leakage Tests', () {
      test('should verify no personal data in AnonymousUser conversion',
          () async {
      ...
      test('should verify no personal data in personality profile payload',
          () async {
        final unifiedUser = UnifiedUser(
          id: 'user-leak-3',
          email: 'user@example.com',
        ...
        final personality = PersonalityProfile.initial('agent_user-leak-3',
            userId: 'user-leak-3');
    ...
    group('AnonymousUser Validation Tests', () {
      ...
      test('should reject AnonymousUser with personal data in agentId',
          () async {
    ...
    group('Location Obfuscation Tests', () {
      ...
      test('should verify location has expiration', () async {
        ...
        if (anonymousUser.location != null) {
          ...
          expect(anonymousUser.location!.expiresAt.isAfter(DateTime.now()),
              isTrue);
        }
      });

      test('should verify no exact coordinates in non-admin location',
          () async {
        final unifiedUser = UnifiedUser(
          id: 'user-location-3',
          email: 'user@example.com',
    ...
    group('Field Encryption Tests', () {
      test('should verify encrypted fields are not exposed in plain text',
          () async {
    ...
    group('Comprehensive Data Leakage Tests', () {
      test('should verify complete anonymization flow has no leaks', () async {
        ...
        final personality = PersonalityProfile.initial(
            'agent_user-comprehensive-1',
            userId: 'user-comprehensive-1');
      ...
      test('should verify nested data structures have no leaks', () async {
        ...
        // Phase 8.3: Use agentId for privacy protection
        final personality = PersonalityProfile.initial(
            'agent_user-comprehensive-2',
            userId: 'user-comprehensive-2');
