...
class AccessibilityTestHelpers {
  ...
  static Map<String, dynamic> testWidgetAccessibility(
    ...
    results['isKeyboardAccessible'] =
        isKeyboardAccessible(tester, widgetFinder);
  ...
  static Map<String, dynamic> validateAppColorsContrast() {
    ...
    for (final textColor in textColors) {
      for (final bgColor in backgroundColors) {
        ...
        // Normal text
        final normalPass =
            verifyContrastRatio(textColor, bgColor, isLargeText: false);
        ...
        // Large text
        final largePass =
            verifyContrastRatio(textColor, bgColor, isLargeText: true);
    ...
    for (final uiColor in uiColors) {
      for (final bgColor in backgroundColors) {
        ...
        final uiPass =
            verifyContrastRatio(uiColor, bgColor, isUIComponent: true);
