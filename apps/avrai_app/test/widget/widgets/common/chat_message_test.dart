...
void main() {
  group('ChatMessage Widget Tests', () {
    ...
    testWidgets(
        'should display user message correctly, display AI message correctly, display timestamp for user/AI messages, display "Just now" for recent messages, align user message to the right, align AI message to the left, or handle long messages correctly',
      ...
      const longMessage =
          'This is a very long message that should wrap correctly '
