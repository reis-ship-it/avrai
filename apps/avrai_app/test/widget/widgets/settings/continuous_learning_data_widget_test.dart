...
void main() {
  group('ContinuousLearningDataWidget Widget Tests', () {
    ...
    group('Rendering', () {
      ...
      testWidgets('displays data collection status for all 10 data sources',
    ...
    group('Activity Indicators', () {
      testWidgets('shows data collection activity indicators',
          (WidgetTester tester) async {
    ...
    group('Data Volume', () {
      testWidgets('displays data volume/statistics',
          (WidgetTester tester) async {
        ...
        expect(
          totalVolumeFinder.evaluate().isNotEmpty ||
              activeSourcesFinder.evaluate().isNotEmpty,
          isTrue,
    ...
    group('Health Status', () {
      testWidgets('shows data source health status',
          (WidgetTester tester) async {
    ...
    group('Loading States', () {
      testWidgets('shows loading indicator while fetching data',
        ...
        expect(find.byType(CircularProgressIndicator), findsNothing,
            reason:
                'Loading should complete after getDataCollectionStatus() returns');
      });
    });
    ...
    group('Backend Integration', () {
      testWidgets('calls ContinuousLearningSystem.getDataCollectionStatus()',
          (WidgetTester tester) async {
        ...
        expect(find.byType(CircularProgressIndicator), findsNothing,
            reason:
                'Loading should complete after getDataCollectionStatus() is called');
      });
    });
  });
}
