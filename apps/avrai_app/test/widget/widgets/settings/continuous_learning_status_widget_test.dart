...
void main() {
  group('ContinuousLearningStatusWidget Widget Tests', () {
    ...
    group('Rendering', () {
      ...
      testWidgets('displays learning status information',
        ...
        expect(inactiveFinder, findsWidgets,
            reason:
                'Status text should be displayed (Inactive when learning not started)');
      });
    });
    ...
    group('Data Display', () {
      ...
      testWidgets('displays system metrics (uptime, cycles, learning time)',
          (WidgetTester tester) async {
        ...
        expect(
          uptimeFinder.evaluate().isNotEmpty ||
              cyclesFinder.evaluate().isNotEmpty ||
              learningTimeFinder.evaluate().isNotEmpty,
          isTrue,
    ...
    group('Loading States', () {
      testWidgets('shows loading indicator while fetching data',
        ...
        expect(find.byType(CircularProgressIndicator), findsNothing,
            reason:
                'Loading should complete after getLearningStatus() returns');
      });
    });

    group('Error Handling', () {
      testWidgets('displays widget correctly with normal operation',
          (WidgetTester tester) async {
    ...
    group('Backend Integration', () {
      testWidgets('calls ContinuousLearningSystem.getLearningStatus()',
          (WidgetTester tester) async {
        ...
        expect(find.byType(CircularProgressIndicator), findsNothing,
            reason:
                'Loading should complete after getLearningStatus() is called');
      });
    });
  });
}
