...
void main() {
  group('HomebaseSelectionPage Widget Tests', () {
    testWidgets('should display required UI elements',
    ...
    testWidgets('should display selected homebase when provided',
        (WidgetTester tester) async {
      // Arrange
    ...
    testWidgets('should show loading state during map initialization',
        (WidgetTester tester) async {
      // Arrange
      final widget = _createTestableWidget(
        child: HomebaseSelectionPage(
    ...
    testWidgets('should handle location permission states',
        (WidgetTester tester) async {
      // Arrange
      final widget = _createTestableWidget(
        child: HomebaseSelectionPage(
    ...
    testWidgets('should handle rapid button interactions gracefully',
        (WidgetTester tester) async {
      // Arrange
      final widget = _createTestableWidget(
        child: HomebaseSelectionPage(
    ...
    testWidgets('should handle callback when homebase changes',
        (WidgetTester tester) async {
      // Arrange
      final widget = _createTestableWidget(
        child: HomebaseSelectionPage(
