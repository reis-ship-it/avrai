...
import 'package:avrai_runtime_os/crypto/signal/ai_agent_fingerprint_service.dart';
...
void main() {
  group('AIAgentFingerprintService', () {
    test('should generate fingerprint from identity key', () {
      ...
      final fingerprint =
          AIAgentFingerprintService.generateFingerprint(identityKey);
    ...
    test('should format fingerprint for display correctly', () {
      ...
      expect(
          formatted.length,
          greaterThan(fingerprint
              .hexString.length)); // Formatted should be longer due to spaces
  ...
  group('AgentFingerprint', () {
    ...
    test('should provide display format and QR code format', () {
      ...
      expect(fingerprint.displayFormat,
          contains(' ')); // Formatted should have spaces
    });
