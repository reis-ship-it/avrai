...
void main() {
  ...
  group('RelationshipType Tests', () {
    test('should have correct display names', () {
      ...
      expect(
          RelationshipType.collaborative.displayName, equals('Collaborative'));
      expect(RelationshipType.professional.displayName, equals('Professional'));
    });

    test('should parse from string correctly', () {
      expect(RelationshipType.fromString('friendship'),
          equals(RelationshipType.friendship));
      expect(RelationshipType.fromString('mentorship'),
          equals(RelationshipType.mentorship));
      expect(RelationshipType.fromString('romantic'),
          equals(RelationshipType.romantic));
      expect(RelationshipType.fromString('collaborative'),
          equals(RelationshipType.collaborative));
      expect(RelationshipType.fromString('professional'),
          equals(RelationshipType.professional));
