  ...
  group('KnotPrivacyService', () {
    ...
    group('generateAnonymizedKnot', () {
      test('should generate anonymized knot from profile with knot', () async {
        ...
        // Act
        final anonymizedKnot =
            privacyService.generateAnonymizedKnot(profileWithKnot);

        // Assert
        expect(anonymizedKnot, isNotNull);
        expect(anonymizedKnot.topology, isNotNull);
        expect(anonymizedKnot.topology.jonesPolynomial,
            equals(knot.invariants.jonesPolynomial));
        expect(anonymizedKnot.topology.alexanderPolynomial,
            equals(knot.invariants.alexanderPolynomial));
        expect(anonymizedKnot.topology.crossingNumber,
            equals(knot.invariants.crossingNumber));
