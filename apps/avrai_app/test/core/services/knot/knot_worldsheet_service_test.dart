...
void main() {
  group('KnotWorldsheetService', () {
    ...
    group('createWorldsheet', () {
      test(
          'should create worldsheet from group strings and fabric snapshots, return null when no strings found, and generate fabric on-the-fly if missing',
          () async {
      ...
      test(
          'should handle time filtering and return null when no knots found for fabric generation',
          () async {
    ...
    group('getFabricAtTime', () {
      test(
          'should return fabric at specific time using worldsheet interpolation',
          () async {
