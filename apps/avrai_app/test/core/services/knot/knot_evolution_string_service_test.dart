...
void main() {
  group('KnotEvolutionStringService', () {
    ...
    group('createStringFromHistory', () {
      test(
          'should create string from evolution history, return string with current knot when history is empty, and return null when no knot found',
          () async {
      ...
      test(
          'should sort snapshots by timestamp and use first snapshot as initial knot',
          () async {
    ...
    group('getKnotAtTime', () {
      test('should return knot at specific time using string interpolation',
          () async {
        ...
        final knot =
            await service.getKnotAtTime('agent-1', DateTime(2025, 1, 1, 12));
      ...
      test('should return null when string cannot be created', () async {
        ...
        final knot =
            await service.getKnotAtTime('agent-1', DateTime(2025, 1, 1));
    ...
    group('getEvolutionTrajectory', () {
      test(
          'should generate sequence of knots at regular intervals when history is empty',
          () async {
