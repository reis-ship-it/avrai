...
void main() {
  ...
  group('KnotCommunityService Tests', () {
    ...
    group('findKnotTribe', () {
      ...
      test(
          'should return empty list when _getAllCommunities returns empty (current implementation)',
          () async {
    ...
    group('createOnboardingKnotGroup', () {
      test('should create group (may return empty with current implementation)',
          () async {
    ...
    group('generateKnotBasedRecommendations', () {
      test('should generate recommendations with all components', () async {
        ...
        expect(recommendations['suggestedCommunities'],
            isA<List<KnotCommunity>>());
        expect(
            recommendations['suggestedUsers'], isA<List<PersonalityProfile>>());
    ...
    group('Error Handling', () {
      ...
      test('should handle errors gracefully in createOnboardingKnotGroup',
          () async {
        when(() => mockPersonalityKnotService.generateKnot(any()))
      ...
      test(
          'should handle errors gracefully in generateKnotBasedRecommendations',
          () async {
        when(() => mockPersonalityKnotService.generateKnot(any()))
            .thenThrow(Exception('Generation error'));
