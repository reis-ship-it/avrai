  ...
  group('EventAttendanceController', () {
    ...
    group('registerForEvent', () {
      test('should successfully register for free event', () async {
        ...
        verify(mockEventService.registerForEvent(testEvent, testUser))
            .called(1);
      ...
      test(
          'should successfully register for paid event via PaymentProcessingController',
          () async {
        // Arrange
      ...
      test('should return failure for event not available', () async {
        ...
        final cancelledEvent =
            testEvent.copyWith(status: EventStatus.cancelled);
