...
void main() {
  group('PartnershipCheckoutController', () {
    ...
    group('validate', () {
      ...
      test(
          'should return invalid result when partnership event ID does not match',
          () {
        final invalidPartnership =
            testPartnership.copyWith(eventId: 'different_event');
        final input = PartnershipCheckoutInput(
          event: testEvent,
          buyer: testUser,
          quantity: 2,
    ...
    group('processCheckout', () {
      test('should successfully process checkout for partnership event',
          () async {
        ...
        verify(mockPartnershipService.getPartnershipsForEvent('event_123'))
            .called(1);
      ...
      test('should use existing revenue split from partnership if available',
          () async {
