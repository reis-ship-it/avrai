  ...
  group('PaymentProcessingController', () {
    ...
    group('validatePayment', () {
      ...
      test('should return invalid result for event that already started', () {
        ...
        expect(
            result.fieldErrors['event'], equals('Event has already started'));
      });
      ...
      test('should return invalid result for zero quantity', () {
        ...
        // Assert
        expect(result.isValid, isFalse);
        expect(result.fieldErrors['quantity'],
            equals('Quantity must be greater than 0'));
      });
      ...
      test('should return invalid result for insufficient capacity', () {
        ...
        expect(result.isValid, isFalse);
        expect(result.fieldErrors['quantity'],
            equals('Insufficient capacity. Only 1 tickets available'));
      });
      ...
      test('should return invalid result for paid event without price', () {
        ...
        expect(result.isValid, isFalse);
        expect(result.fieldErrors['event'],
            equals('Paid event must have a valid price'));
      });
    });
    ...
    group('processEventPayment', () {
      ...
      test('should return failure result when payment processing fails',
          () async {
        // Arrange
        when(mockSalesTaxService.calculateSalesTax(
          eventId: testEvent.id,
      ...
      test('should return failure result when event not found after payment',
          () async {
    ...
    group('processRefund', () {
      test('should return failure result (not yet implemented)', () async {
        ...
        expect(result.isSuccess, isFalse);
        expect(
            result.error, equals('Refund processing is not yet implemented'));
