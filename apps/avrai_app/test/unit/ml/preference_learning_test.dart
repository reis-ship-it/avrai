...
import 'package:avrai_runtime_os/ml/preference_learning.dart';
  ...
  group('PreferenceLearningEngine', () {
    ...
    group('learnFromBehavior', () {
      ...
      test('should handle errors gracefully', () async {
        ...
        final behaviorData = UserBehaviorData(
          ...
          endDate: DateTime.now()
              .subtract(const Duration(days: 1)), // Invalid date range
        );
    ...
    group('identifySocialContexts', () {
      ...
      test('should return valid preference scores', () async {
        ...
        expect(
            socialPreferences.smallGroupPreference, greaterThanOrEqualTo(0.0));
        expect(socialPreferences.smallGroupPreference, lessThanOrEqualTo(1.0));
        expect(
            socialPreferences.largeGroupPreference, greaterThanOrEqualTo(0.0));
        expect(socialPreferences.largeGroupPreference, lessThanOrEqualTo(1.0));
        expect(socialPreferences.communityEventPreference,
            greaterThanOrEqualTo(0.0));
        expect(
            socialPreferences.communityEventPreference, lessThanOrEqualTo(1.0));
      });
    });
  });
