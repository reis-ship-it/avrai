  ...
  group('QuantumPredictionTrainingPipeline', () {
    ...
    test('should calculate feature importance', () async {
      ...
      final totalImportance =
          model.featureImportance.values.reduce((a, b) => a + b);
      expect(totalImportance, closeTo(1.0, 0.1));
    });

    test('should serialize and deserialize model correctly (round-trip)',
        () async {
      // Arrange
      final examples = List.generate(50, (i) {
        return QuantumTrainingExample(
      ...
      // Assert
      expect(restored.featureWeights.length,
          equals(original.featureWeights.length));
