    ...
    test('aggregateModelUpdates maintains privacy', () async {
      ...
      final localUpdates = [
        LocalModelUpdate(
          ...
          gradients: {
            'weights': List.generate(
                10, (i) => 0.1 + i * 0.01), // 10 elements to match global model
            'biases': List.generate(
                5, (i) => 0.05), // 5 elements to match global model
          },
        ...
        LocalModelUpdate(
          ...
          gradients: {
            'weights': List.generate(
                10, (i) => 0.2 + i * 0.01), // 10 elements to match global model
            'biases': List.generate(
                5, (i) => 0.1), // 5 elements to match global model
          },
          trainingMetrics: TrainingMetrics(
            samplesUsed: 80,
            trainingLoss: 0.6,
