...
class MockPersonalitySyncService extends Mock
    implements PersonalitySyncService {}
...
void main() {
  group('AuthBloc', () {
    ...
    setUpAll(() async {
      ...
      when(() => mockSyncService.isCloudSyncEnabled(any()))
          .thenAnswer((_) async => false);
      when(() => mockSyncService.reEncryptWithNewPassword(any(), any(), any()))
          .thenAnswer((_) async {
        return;
      });
      ...
      final testProfile = PersonalityProfile.initial('agent_test-user-123',
          userId: 'test-user-123');
      when(() => mockPersonalityLearning.initializePersonality(any(),
