    ...
    group('Connection Monitor System', () {
      test('should start monitoring a connection', () async {
        ...
        final session = await connectionMonitor.startMonitoring(
            'test_connection_001', testMetrics);
      ...
      test('should update connection metrics during monitoring', () async {
        ...
        final updatedSession = await monitor.updateConnectionMetrics(
            'test_connection_002', updatedMetrics);
      ...
      test('should get real-time connection status', () async {
        ...
        final connectionStatus =
            await monitor.getConnectionStatus('test_connection_003');
      ...
      test('should handle connection not found gracefully', () async {
        ...
        final connectionStatus =
            await monitor.getConnectionStatus('non_existent_connection');

        expect(
            connectionStatus.connectionId, equals('non_existent_connection'));
      ...
      test('should analyze connection performance trends', () async {
        ...
        final testMetrics = ConnectionMetrics(
          ...
          interactionHistory: [],
          dimensionEvolution: {
            'exploration_eagerness': 0.07,
            'authenticity_preference': 0.03
          },
        );
        ...
        expect(performanceAnalysis.analysisWindow,
        ...
        expect(performanceAnalysis.overallPerformanceScore,
      ...
      test(
          'should generate active connections overview when no connections exist',
          () async {
        final monitor = ConnectionMonitor(prefs: compatPrefs);
      ...
      test('should stop monitoring and generate report', () async {
        ...
        final statusAfterStop =
            await monitor.getConnectionStatus('test_connection_005');
        expect(statusAfterStop.healthScore,
            equals(0.0)); // Should return not found status
      });
    });

    group('Integration Validation', () {
      test('should validate monitoring data structures compatibility',
          () async {
      ...
      test('should validate complete monitoring lifecycle', () async {
        ...
        // Start monitoring
        final session =
            await monitor.startMonitoring('lifecycle_test', testMetrics);
        expect(session.monitoringStatus, equals(MonitoringStatus.active));
        ...
        // Verify connection is no longer being monitored
        final statusAfterStop =
            await monitor.getConnectionStatus('lifecycle_test');
