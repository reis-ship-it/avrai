  ...
  group('DeviceDiscoveryService', () {
    ...
    group('startDiscovery', () {
      ...
      test('should pass scanWindow through to platform scan', () {
        fakeAsync((async) {
          ...
          expect(fakePlatform.scanCalls, equals(1));
          expect(
              fakePlatform.lastScanWindow, equals(const Duration(seconds: 9)));
        });
      });
      ...
      test('updateScanConfig should apply new scanWindow on next scan', () {
        fakeAsync((async) {
          ...
          expect(fakePlatform.scanCalls, equals(1));
          expect(
              fakePlatform.lastScanWindow, equals(const Duration(seconds: 4)));
          ...
          expect(fakePlatform.scanCalls, equals(2));
          expect(
              fakePlatform.lastScanWindow, equals(const Duration(seconds: 1)));
    ...
    group('stopDiscovery', () {
      test('should stop discovery', () {
        ...
        expect(discoveryService.getDiscoveredDevices(),
            isA<List<DiscoveredDevice>>());
      });
    });
