...
void main() {
  group('AI2AIProtocol', () {
    ...
    group('encodeMessage', () {
      test(
          'should encode messages with correct structure and include recipient ID when provided',
          () async {
        ...
        expect(messageWithoutRecipient.recipientId,
            isNull); // No recipient for broadcast
        ...
        expect(
            messageWithRecipient.type, equals(MessageType.connectionRequest));
      });
    });

    group('decodeMessage', () {
      test('should encode messages that can be serialized for transmission',
          () async {
    ...
    group('Connection message encoding', () {
      test(
          'should encode connection request with anonymized vibe payload and enforce privacy protection',
          () async {
      ...
      test(
          'should encode connection response payload with acceptance status and compatibility',
          () async {
    ...
    group('Learning message encoding', () {
      test(
          'should encode learning exchange payload with learning data and timestamp',
          () async {
    ...
    group('createHeartbeat', () {
      test(
          'should create heartbeat message with timestamp for connection monitoring',
          () async {
    ...
    group('Encryption/Decryption', () {
      test(
          'should encode messages successfully with encryption service and handle null key gracefully',
          () async {
