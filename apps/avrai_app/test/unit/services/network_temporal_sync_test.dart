  ...
  group('Experiment 6: Network-Wide Synchronization', () {
    test('should synchronize 10+ simulated nodes', () async {
      ...
      for (final timestamp in timestamps) {
        final diff =
            (timestamp.serverTime.difference(baseTime).inMilliseconds).abs();
    ...
    test('should maintain synchronization stability over time', () async {
      ...
      final initialDiff =
          (t1Initial.serverTime.difference(t2Initial.serverTime).inMilliseconds)
              .abs();
      ...
      final laterDiff =
          (t1Later.serverTime.difference(t2Later.serverTime).inMilliseconds)
              .abs();
