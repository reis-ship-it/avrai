...
class MockSharedPreferencesCompat extends Mock
    implements SharedPreferencesCompat {}
    ...
    group('isAuthenticated', () {
      test(
        ...
        await prefs.setString(
            'admin_session', jsonEncode(expiredSession.toJson()));
        ...
        await prefs.setString(
            'admin_session', jsonEncode(validSession.toJson()));
