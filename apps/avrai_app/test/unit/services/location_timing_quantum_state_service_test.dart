...
void main() {
  group('LocationTimingQuantumStateService', () {
    ...
    test('should create location quantum state from UnifiedLocationData',
        () async {
    ...
    test('should create timing quantum state with preferred days', () async {
      final timingState =
          await service.createTimingQuantumStateWithPreferredDays(
  ...
  group('LocationCompatibilityCalculator', () {
    ...
    test('should calculate distance-based compatibility', () {
      ...
      final compatibility =
          LocationCompatibilityCalculator.calculateDistanceBasedCompatibility(
        locationA,
        locationB,
        maxDistanceKm: 10.0,
      );
  ...
  group('TimingCompatibilityCalculator', () {
    ...
    test('should calculate time overlap compatibility', () {
      ...
      final compatibility =
          TimingCompatibilityCalculator.calculateTimeOverlapCompatibility(
