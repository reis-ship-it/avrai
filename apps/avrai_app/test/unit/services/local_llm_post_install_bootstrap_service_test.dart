  ...
  group('LocalLlmPostInstallBootstrapService', () {
    ...
    test('builds a non-empty deterministic system prompt from onboarding data',
      ...
      await prefs.setString(
          LocalLlmModelPackManager.prefsKeyActiveModelDir, activeDir.path);
      await prefs.setString(
          LocalLlmModelPackManager.prefsKeyActiveModelId, 'pack_test_v1');
