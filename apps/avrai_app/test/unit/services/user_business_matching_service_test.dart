...
import 'package:avrai_runtime_os/services/business/user_business_matching_service.dart';
...
void main() {
  group('UserBusinessMatchingService Tests', () {
    ...
    group('getUserCompatibilityScore', () {
      test('should return compatibility score for business without preferences',
          () async {
