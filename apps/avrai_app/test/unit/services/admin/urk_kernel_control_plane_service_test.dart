...
void main() {
  group('UrkKernelControlPlaneService', () {
    ...
    test('stages activation receipts into kernel/offline governed intake',
        () async {
      ...
      await service.recordActivationReceipt(
        ...
        actor: 'runtime_engine',
        reason:
            'user_runtime_learning_intake_accepted;runtime_lane=user_runtime;privacy_mode=local_sovereign',
      );
      ...
      expect(
        reviews.single.payload['channel'],
        'activation_receipt',
      );
      expect(
        reviews.single.payload['kernelOfflineEvidenceReceipt'],
