...
void main() {
  ...
  group('UserPreferences Model Tests', () {
    test(
      ...
      expect(preferences.getCategoryPreference('coffee'),
          equals(0.7)); // coffee is in preferences
      expect(preferences.getCategoryPreference('nonexistent'),
          equals(0.0)); // category not in preferences
    });
