...
void main() {
  group('HumanChatPromptComposer', () {
    test('builds one normalized human-chat prompt with safe context', () {
      ...
      final metroContext = MetroExperienceService.profileForMetroKey(
        ...
        governedConsumerStates: <GovernedDomainConsumerState>[
          GovernedDomainConsumerState(
            sourceId: 'simulation_training_source_nyc',
            domainId: 'locality',
            consumerId: 'locality_intelligence_lane',
            environmentId: 'nyc-replay-world-2024',
            cityCode: 'us-nyc',
            generatedAt: DateTime.utc(2026, 4, 2, 12),
            ...
            originOccurredAt: DateTime.utc(2026, 4, 2, 9),
            localStateCapturedAt: DateTime.utc(2026, 4, 2, 10),
            learningIntegratedAt: DateTime.utc(2026, 4, 2, 11),
            sourceLastSyncedAt: DateTime.utc(2026, 4, 2, 12),
      ...
      expect(prompt.messages.first.content, contains('Local context timing:'));
      ...
      expect(
        (prompt.context.preferences?['metro_context']
            as Map<String, dynamic>)['governed_knowledge_timing_summary'],
