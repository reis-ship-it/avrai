...
void main() {
  group('SocialMediaVibeAnalyzer Tests', () {
    ...
    group('Google Profile Analysis', () {
      test('should extract location adventurousness from saved parks',
          () async {
        // Arrange
        final savedPlaces = [
      ...
      test('should extract curation tendency from saved cafes and restaurants',
          () async {
        // Arrange
        final savedPlaces = [
      ...
      test(
          'should extract authenticity preference from reviews mentioning authentic',
          () async {
        // Arrange
        final reviews = [
      ...
      test('should extract curation tendency from high-rated reviews',
          () async {
        // Arrange
        final reviews = [
      ...
      test('should extract exploration eagerness from photos with nature tags',
          () async {
        // Arrange
        final photos = [
          {
      ...
      test('should increase exploration eagerness with multiple saved places',
          () async {
        // Arrange
        final savedPlaces = List.generate(
            10,
            (i) => <String, dynamic>{
                  'name': 'Place $i',
    ...
    group('Generic Social Profile Analysis', () {
      test('should extract social discovery style from high follow count',
          () async {
        // Arrange
        final follows =
            List.generate(600, (i) => <String, dynamic>{'id': 'user_$i'});
      ...
      test('should extract community orientation from high connection count',
          () async {
        // Arrange
        final connections =
            List.generate(400, (i) => <String, dynamic>{'id': 'user_$i'});
        final profileData = {'bio': ''};
      ...
      test(
          'should extract exploration eagerness from bio with adventure keywords',
          () async {
        // Arrange
        final profileData = {
      ...
      test('should extract curation tendency from bio with food keywords',
          () async {
        // Arrange
        final profileData = {
    ...
    group('Value Normalization', () {
      test('should ensure all dimension values are between 0.0 and 1.0',
          () async {
        // Arrange
        final savedPlaces = List.generate(
            100,
