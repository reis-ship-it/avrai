...
void main() {
  group('LegalDocumentService', () {
    ...
    test('should persist Terms acceptance locally (survives app restart)',
        () async {
      const userId = 'user_1';
      ...
      final terms = agreements
          .where((a) => a.documentType == 'terms_of_service')
          .toList();
    ...
    test('should revoke previous active Terms record when accepting again',
        () async {
      const userId = 'user_1';
