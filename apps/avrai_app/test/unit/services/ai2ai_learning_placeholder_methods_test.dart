...
import 'package:avrai_core/models/quantum/connection_metrics.dart' as cm;
  ...
  group('AI2AI Learning Placeholder Methods Tests', () {
    ...
    group('_extractDimensionInsights()', () {
      test(
        ...
        if (shouldSkipTest()) {
          return; // Skip test if services couldn't be initialized
        }
    ...
    group('_identifyOptimalLearningPartners()', () {
      ...
      test('should boost compatibility with trust patterns', () async {
        ...
        await analyzer!
            .analyzeChatConversation(userId, chatEvent, connectionContext);
