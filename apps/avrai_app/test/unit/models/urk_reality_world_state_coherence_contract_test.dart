import 'package:avrai_runtime_os/kernel/contracts/urk_reality_world_state_coherence_contract.dart';
  ...
  group('UrkRealityWorldStateCoherenceValidator', () {
    ...
    test('fails when conflicts or unresolved transitions exist', () {
      ...
      expect(
        result.failures,
        contains(
            UrkRealityWorldStateCoherenceFailure.crossPlaneConflictDetected),
      );
      expect(
        result.failures,
        contains(
