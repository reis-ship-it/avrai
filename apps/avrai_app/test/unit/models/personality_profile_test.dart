...
void main() {
  group('PersonalityProfile Model Tests', () {
    ...
    group('Initial Personality Profile Factory', () {
      test(
          'should create initial profile with correct business defaults and usable state',
          () {
        ...
        final otherProfile =
            PersonalityProfile.initial('agent_test_456', userId: 'user-456');
    ...
    group('Personality Evolution System', () {
      test(
        ...
        expect(
          ...
          equals((coreExploration + PersonalityProfile.maxDriftFromCore).clamp(
        ...
        expect(
          ...
          equals((coreExploration2 + PersonalityProfile.maxDriftFromCore).clamp(
              VibeConstants.minDimensionValue,
              VibeConstants.maxDimensionValue)),
        );
        expect(
    ...
    group('Compatibility Calculation', () {
      test(
        ...
        final profile2 = ModelFactories.createTestPersonalityProfile(
            userId: 'user-2', agentId: 'agent_user-2');
    ...
    group('Personality Analysis Methods', () {
      test(
        ...
        final underdeveloped =
            PersonalityProfile.initial('agent_test_123', userId: 'user-123');
        ...
        expect(
            different1.calculateLearningPotential(different2),
            equals(
                0.3)); // Low-compatibility learning floor (inclusive network)
      });
    });
