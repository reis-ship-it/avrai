...
void main() {
  group('MapBoundary Model Tests', () {
    group('Polyline Boundary', () {
      test(
          'should create polyline boundary with correct structure and access outer ring',
          () {
      ...
      test(
          'should handle empty points list gracefully and return empty outer ring',
          () {
    ...
    group('Polygon Boundary', () {
      test(
          'should create polygon boundary with outer ring and holes, and access them correctly',
          () {
      ...
      test(
          'should create polygon boundary without holes and return empty holes list',
          () {
    ...
    group('Boundary Factory Methods', () {
      test(
          'should validate boundary factory methods create correct types with default values',
          () {
    ...
    group('Coordinate Access', () {
      test(
          'should access outer ring and holes correctly for boundaries with multiple coordinate lists',
          () {
