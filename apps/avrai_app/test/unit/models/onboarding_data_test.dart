...
void main() {
  group('OnboardingData Model Tests', () {
    ...
    group('JSON Serialization', () {
      test(
          'should serialize and deserialize correctly (round-trip) with all fields, null values, and missing collections',
          () {
        ...
        final restoredMinimal =
            OnboardingData.fromJson(originalMinimal.toJson());
    ...
    group('Validation', () {
      test(
          'should validate agentId format, dates, and age constraints correctly',
          () {
        // Valid cases
    ...
    group('CopyWith', () {
      test(
          'should create immutable copy with updated fields, null handling, and preserve unchanged fields',
          () {
        ...
        expect(original.homebase,
            equals('San Francisco, CA')); // Original preserved
        ...
        expect(original.homebase,
            equals('San Francisco, CA')); // Original still preserved
    ...
    group('toAgentInitializationMap', () {
      test(
          'should convert OnboardingData to agent initialization map excluding privacy fields',
          () {
    ...
    group('Equality and HashCode', () {
      test(
          'should correctly identify equal and unequal OnboardingData instances',
          () {
        ...
        expect(data1,
            isNot(equals(data3))); // Different agentId = different instance
      });
    });

    group('Edge Cases', () {
      test(
          'should handle large collections, complex data structures, and remain valid',
          () {
        ...
        expect(dataWithComplexPrefs.isValid,
            isTrue); // Business logic: still valid
        ...
        expect(
            dataWithAllSocial.isValid, isTrue); // Business logic: still valid
      });
    });
  });
}
