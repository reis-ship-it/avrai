...
import 'package:avrai_core/models/user/user_preferences.dart';
...
void main() {
  group('PreferencesProfile Model', () {
    ...
    test(
        'should create empty PreferencesProfile with correct defaults and behavior',
        () {
      // Act
      ...
      expect(profile.prefersLocalExperts,
          isFalse); // Default weight is 0.5, threshold is 0.5
      expect(profile.isOpenToExploration,
          isFalse); // Default willingness is 0.3, threshold is 0.5
    });
  });
}
