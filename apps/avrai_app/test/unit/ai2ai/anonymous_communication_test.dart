...
void main() {
  ...
  group('AnonymousCommunicationProtocol - Encryption/Decryption', () {
    ...
    test('should produce different encrypted values for same payload',
        () async {
      final payload = {
        'agentId': 'agent-123',
        'data': 'test',
      ...
      expect(
          message1.encryptedPayload, isNot(equals(message2.encryptedPayload)));
    });
    ...
    test('should handle encryption of various payload sizes', () async {
      ...
      expect(largeMessage.encryptedPayload.length,
          greaterThan(smallMessage.encryptedPayload.length));
    });
  });
}
