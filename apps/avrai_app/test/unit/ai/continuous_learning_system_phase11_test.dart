...
void main() {
  group('ContinuousLearningSystem Phase 11 Enhancements', () {
    ...
    group('processAI2AIChatConversation()', () {
      ...
      test('should extract dimension insights from evolution recommendations',
          () async {
        await system.initialize();
      ...
      test(
          'should calculate correct dimension changes from direction and magnitude',
          () async {
        await system.initialize();
        ...
        expect(chatAnalysis.evolutionRecommendations.first.magnitude,
            equals(0.15));
        expect(chatAnalysis.evolutionRecommendations.first.direction,
            equals('increase'));
      });

      test('should handle empty evolution recommendations gracefully',
          () async {
        await system.initialize();
    ...
    group('Atomic Time Integration', () {
      ...
      test('should store AtomicTimestamp in _lastAi2AiLearningAtByPeerId',
          () async {
        await system.initialize();
      ...
      test('should fall back to DateTime when AtomicClockService unavailable',
          () async {
    ...
    group('ONNX Updates', () {
      ...
      test('should skip ONNX update when OnnxDimensionScorer not registered',
          () async {
