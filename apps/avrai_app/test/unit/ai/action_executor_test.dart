  ...
  group('ActionExecutor', () {
    ...
    group('executeCreateSpot', () {
      test('should successfully create a spot', () async {
        ...
        when(mockCreateSpotUseCase.call(any))
            .thenAnswer((_) async => createdSpot);
      ...
      test('should return failure when use case is not available', () async {
        ...
        expect(result.success, isFalse);
        expect(
            result.errorMessage, contains('CreateSpotUseCase not available'));
      });
    });
    ...
    group('executeCreateList', () {
      test('should successfully create a list', () async {
        ...
        when(mockCreateListUseCase.call(any))
    ...
    group('executeAddSpotToList', () {
      test('should successfully add spot to list', () async {
        ...
        when(mockListsRepository.getLists())
            .thenAnswer((_) async => [existingList]);
        when(mockUpdateListUseCase.call(any))
            .thenAnswer((_) async => existingList.copyWith(
                  spotIds: ['spot123'],
                  updatedAt: DateTime.now(),
                ));
