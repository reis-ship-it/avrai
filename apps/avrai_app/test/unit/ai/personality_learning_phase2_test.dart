...
void main() {
  group('PersonalityLearning Phase 2 Tests', () {
    ...
    group('Onboarding to Dimensions Mapping', () {
      test('should map age < 25 to exploration and temporal flexibility',
          () async {
        // Arrange
        ...
        expect(profile.dimensions['exploration_eagerness'],
            greaterThanOrEqualTo(0.5));
        expect(profile.dimensions['temporal_flexibility'],
            greaterThanOrEqualTo(0.5));
      });
      ...
      test('should map age > 45 to authenticity and trust network', () async {
        ...
        expect(profile.dimensions['authenticity_preference'],
            greaterThanOrEqualTo(0.5));
        expect(profile.dimensions['trust_network_reliance'],
            greaterThanOrEqualTo(0.5));
      });
      ...
      test('should map urban homebase to location adventurousness', () async {
        ...
        // Note: Values are blended, so we check for >= 0.5
        expect(profile.dimensions['location_adventurousness'],
            greaterThanOrEqualTo(0.5));
      });

      test(
          'should map favorite places > 5 to exploration and location adventurousness',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'Test City',
      ...
      test('should map Food & Drink preferences to curation and authenticity',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'Test City',
      ...
      test(
          'should map Activities preferences to exploration and social discovery',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'Test City',
      ...
      test(
          'should map Outdoor & Nature preferences to location and exploration',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'Test City',
        ...
        expect(
            profile.dimensions['location_adventurousness'], greaterThan(0.5));
        expect(profile.dimensions['exploration_eagerness'], greaterThan(0.5));
      });

      test(
          'should map Social preferences to community orientation and social discovery',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'Test City',
      ...
      test(
          'should map respected friends to community orientation and trust network',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'Test City',
        ...
        // Note: Values are blended, so we check for >= 0.5
        expect(profile.dimensions['community_orientation'],
            greaterThanOrEqualTo(0.5));
        expect(profile.dimensions['trust_network_reliance'],
            greaterThanOrEqualTo(0.5));
      });
    ...
    group('initializePersonalityFromOnboarding', () {
      ...
      test('should initialize personality with social media data only',
          () async {
        // Arrange
      ...
      test(
          'should initialize personality with both onboarding and social media data',
          () async {
        // Arrange
        final onboardingData = {
          'age': 30,
        ...
        expect(profile.learningHistory['onboarding_data_used'], isTrue);
        expect(profile.learningHistory['social_media_data_used'], isTrue);
        expect(profile.learningHistory['learning_sources'],
            containsAll(['onboarding', 'social_media']));
      });
      ...
      test('should not overwrite existing evolved profile', () async {
        ...
        expect(secondProfile.evolutionGeneration,
            firstProfile.evolutionGeneration);
      });

      test('should handle errors gracefully and fallback to default profile',
          () async {
        // Arrange
      ...
      test('should convert userId to agentId for privacy protection', () async {
        ...
        expect(
            (profile.learningHistory['agent_id'] as String)
                .startsWith('agent_'),
            isTrue);
      });
    });
    ...
    group('Archetype Determination', () {
      test('should return adventurous_explorer for high exploration and energy',
          () async {
        // Arrange
        final onboardingData = {
      ...
      test('should return social_connector for high social and energy',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'Test City',
    ...
    group('Authenticity Calculation', () {
      test('should calculate authenticity from dimension consistency',
          () async {
        // Arrange
        final onboardingData = {
          'age': 30,
    ...
    group('Urban Area Detection', () {
      test(
          'should identify San Francisco as urban and boost location adventurousness',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'San Francisco, CA',
      ...
      test(
          'should identify New York as urban and boost location adventurousness',
          () async {
        // Arrange
        final onboardingData = {
          'homebase': 'New York, NY',
