...
void main() {
  group('InteractionEvent Atomic Timestamp Support', () {
    group('Atomic Timestamp Field Tests', () {
      ...
      test(
          'should create InteractionEvent without atomicTimestamp (defaults to null)',
          () {
        final event = InteractionEvent(
      ...
      test(
          'should deserialize atomicTimestamp from fromJson() with String format',
          () {
        final json = {
          ...
          'timestamp': DateTime.now().toIso8601String(),
          'atomic_timestamp':
              DateTime(2025, 1, 15, 12, 30, 0).toIso8601String(),
        };
    ...
    group('Atomic Timestamp Conversion Tests', () {
      test('should preserve atomic timestamp precision in serialization', () {
        ...
        expect(restored.atomicTimestamp?.precision,
            equals(TimePrecision.millisecond));
      ...
      test('should handle timezone correctly', () {
        ...
        expect(
            restored.atomicTimestamp?.timezoneId, equals('America/New_York'));
        expect(restored.atomicTimestamp?.offset,
