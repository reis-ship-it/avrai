...
import 'package:avrai_runtime_os/ai/privacy_protection.dart'
    show PrivacyProtection, AnonymizedPersonalityData, AnonymizedVibeData;
...
void main() {
  group('PrivacyProtection', () {
    group('Personality Profile Anonymization', () {
      ...
      test('should ensure anonymized data contains no personal identifiers',
          () async {
        const userId = 'test-user-123';
        // Phase 8.3: Use agentId for privacy protection
        const agentId = 'agent_$userId';
    ...
    group('Differential Privacy', () {
      test('should apply differential privacy without errors', () async {
        ...
        final protected =
            await PrivacyProtection.applyDifferentialPrivacy(dimensions);
