...
void main() {
  group('AIListGeneratorService', () {
    group('generatePersonalizedLists', () {
      ...
      test('should prioritize professional networking for adults 26-64',
          () async {
        final lists = await AIListGeneratorService.generatePersonalizedLists(
          userName: 'AdultUser',
          age: 35,
      ...
      test('should include professional networking for college students',
          () async {
        final lists = await AIListGeneratorService.generatePersonalizedLists(
      ...
      test('should handle null homebase gracefully', () async {
        ...
        final hasGenericSuggestions =
            lists.any((list) => !list.contains('null') && list.isNotEmpty);
