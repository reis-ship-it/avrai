...
import 'package:avrai/presentation/schemas/pages/values_sharing_page_schema.dart';
import 'package:avrai/presentation/widgets/onboarding/dimension_question_widget.dart';

/// Step 8: Values & Sharing page.
///
/// Measures dimensions:
/// - value_orientation
/// - authenticity_preference
/// - curation_tendency
class ValuesSharingPage extends StatefulWidget {
  ...
  @override
  State<ValuesSharingPage> createState() => _ValuesSharingPageState();
}

class _ValuesSharingPageState extends State<ValuesSharingPage> {
  ...
  List<DimensionQuestion> get _questions =>
      OnboardingQuestionBank.valuesQuestions;
  ...
  Widget build(BuildContext context) {
    return AppSchemaPage(
      schema: buildValuesSharingPageSchema(
