...
import 'package:avrai_core/models/quantum/recommendation_attribution.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ...attribution
              .getTopFactors(3)
              .map((factor) => _buildFactorRow(factor, isDark, textTheme)),
        ],
      ),
    );
  }
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Icon(
              IconData(factor.icon, fontFamily: 'MaterialIcons'),
              size: 14,
