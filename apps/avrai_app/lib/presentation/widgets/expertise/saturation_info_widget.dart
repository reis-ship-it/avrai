      ...
      child: Column(
        ...
        children: [
          ...
          if (showDetails) ...[
            ...
            _buildFactorRow(
                'Supply Ratio', saturationMetrics.factors.supplyRatio, 0.25),
            _buildFactorRow('Quality Distribution',
                saturationMetrics.factors.qualityDistribution, 0.20),
            _buildFactorRow('Utilization Rate',
                saturationMetrics.factors.utilizationRate, 0.20),
            _buildFactorRow(
                'Demand Signal', saturationMetrics.factors.demandSignal, 0.15),
            _buildFactorRow('Growth Velocity',
                saturationMetrics.factors.growthVelocity, 0.10),
            _buildFactorRow('Geographic Distribution',
