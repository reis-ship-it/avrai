...
Future<void> registerAIServices(GetIt sl) async {
  ...
  if (!sl.isRegistered<KernelGraphRunLedger>()) {
    sl.registerLazySingleton<KernelGraphRunLedger>(
      () => KernelGraphRunLedger(
        storageService:
            sl.isRegistered<StorageService>() ? sl<StorageService>() : null,
      ),
    );
  }
  if (!sl.isRegistered<UserGovernedLearningSignalPolicyService>()) {
    sl.registerLazySingleton<UserGovernedLearningSignalPolicyService>(
  ...
  sl.registerLazySingleton(
    () => GovernedUpwardLearningIntakeService(
      ...
      kernelGraphRunLedger: sl.isRegistered<KernelGraphRunLedger>()
          ? sl<KernelGraphRunLedger>()
          : null,
      signalPolicyService: sl<UserGovernedLearningSignalPolicyService>(),
    ),
  );
  if (!sl.isRegistered<UserGovernedLearningUsageService>()) {
    sl.registerLazySingleton<UserGovernedLearningUsageService>(
      () => UserGovernedLearningUsageService(
        storageService: sl<StorageService>(),
      ),
    );
  }
  if (!sl.isRegistered<UserGovernedLearningAdoptionService>()) {
    sl.registerLazySingleton<UserGovernedLearningAdoptionService>(
      () => UserGovernedLearningAdoptionService(
        storageService: sl<StorageService>(),
      ),
    );
  }
  if (!sl.isRegistered<UserGovernedLearningChatObservationService>()) {
    sl.registerLazySingleton<UserGovernedLearningChatObservationService>(
      () => UserGovernedLearningChatObservationService(
        storageService: sl<StorageService>(),
      ),
    );
  }
  if (!sl.isRegistered<UserGovernedLearningProjectionService>()) {
    sl.registerLazySingleton<UserGovernedLearningProjectionService>(
      () => UserGovernedLearningProjectionService(
        intakeRepository: sl<UniversalIntakeRepository>(),
        signalPolicyService: sl<UserGovernedLearningSignalPolicyService>(),
        adoptionService: sl<UserGovernedLearningAdoptionService>(),
        observationService: sl<UserGovernedLearningChatObservationService>(),
        usageService: sl<UserGovernedLearningUsageService>(),
      ),
    );
  }
  if (!sl.isRegistered<UserGovernedLearningControlService>()) {
    sl.registerLazySingleton<UserGovernedLearningControlService>(
      () => UserGovernedLearningControlService(
        intakeRepository: sl<UniversalIntakeRepository>(),
        governedUpwardLearningIntakeService:
            sl<GovernedUpwardLearningIntakeService>(),
        agentIdService: sl<AgentIdService>(),
        signalPolicyService: sl<UserGovernedLearningSignalPolicyService>(),
        adoptionService: sl<UserGovernedLearningAdoptionService>(),
        correctionFollowUpPlannerService: sl.isRegistered<
                UserGovernedLearningCorrectionFollowUpPromptPlannerService>()
            ? sl<UserGovernedLearningCorrectionFollowUpPromptPlannerService>()
            : null,
      ),
    );
  }
  if (!sl.isRegistered<UserGovernedLearningResponseComposerService>()) {
    sl.registerLazySingleton<UserGovernedLearningResponseComposerService>(
  ...
  sl.registerLazySingleton<event_rec_service.EventRecommendationService>(
    () => event_rec_service.EventRecommendationService(
      ...
      quantumMatchingController: sl.isRegistered<QuantumMatchingController>()
          ...
          : null,
      userGovernedLearningProjectionService:
          sl.isRegistered<UserGovernedLearningProjectionService>()
              ? sl<UserGovernedLearningProjectionService>()
              : null,
      userGovernedLearningUsageService:
          sl.isRegistered<UserGovernedLearningUsageService>()
              ? sl<UserGovernedLearningUsageService>()
              : null,
    ),
  );
  ...
  if (!sl.isRegistered<RecommendationFeedbackPromptPlannerService>()) {
    sl.registerLazySingleton<RecommendationFeedbackPromptPlannerService>(
  ...
  if (!sl.isRegistered<RecommendationFeedbackAssistantFollowUpService>()) {
    sl.registerLazySingleton<RecommendationFeedbackAssistantFollowUpService>(
      () => RecommendationFeedbackAssistantFollowUpService(
        plannerService: sl<RecommendationFeedbackPromptPlannerService>(),
      ),
    );
  }
  if (!sl.isRegistered<PostEventFeedbackPromptPlannerService>()) {
    sl.registerLazySingleton<PostEventFeedbackPromptPlannerService>(
  ...
  if (!sl.isRegistered<PostEventFeedbackAssistantFollowUpService>()) {
    sl.registerLazySingleton<PostEventFeedbackAssistantFollowUpService>(
      () => PostEventFeedbackAssistantFollowUpService(
        plannerService: sl<PostEventFeedbackPromptPlannerService>(),
      ),
    );
  }
  if (!sl.isRegistered<SavedDiscoveryFollowUpPromptPlannerService>()) {
    sl.registerLazySingleton<SavedDiscoveryFollowUpPromptPlannerService>(
  ...
  if (!sl.isRegistered<SavedDiscoveryAssistantFollowUpService>()) {
    sl.registerLazySingleton<SavedDiscoveryAssistantFollowUpService>(
      () => SavedDiscoveryAssistantFollowUpService(
        plannerService: sl<SavedDiscoveryFollowUpPromptPlannerService>(),
      ),
    );
  }
  if (!sl.isRegistered<
  ...
  if (!sl
      .isRegistered<UserGovernedLearningCorrectionAssistantFollowUpService>()) {
    sl.registerLazySingleton<
  ...
  if (!sl.isRegistered<VisitLocalityFollowUpPromptPlannerService>()) {
    sl.registerLazySingleton<VisitLocalityFollowUpPromptPlannerService>(
  ...
  if (!sl.isRegistered<VisitLocalityAssistantFollowUpService>()) {
    sl.registerLazySingleton<VisitLocalityAssistantFollowUpService>(
      () => VisitLocalityAssistantFollowUpService(
        plannerService: sl<VisitLocalityFollowUpPromptPlannerService>(),
      ),
    );
  }
  if (!sl.isRegistered<CommunityFollowUpPromptPlannerService>()) {
    sl.registerLazySingleton<CommunityFollowUpPromptPlannerService>(
  ...
  if (!sl.isRegistered<CommunityAssistantFollowUpService>()) {
    sl.registerLazySingleton<CommunityAssistantFollowUpService>(
      () => CommunityAssistantFollowUpService(
        plannerService: sl<CommunityFollowUpPromptPlannerService>(),
      ),
    );
  }
  if (!sl.isRegistered<BusinessOperatorFollowUpPromptPlannerService>()) {
    sl.registerLazySingleton<BusinessOperatorFollowUpPromptPlannerService>(
  ...
  if (!sl.isRegistered<BusinessOperatorAssistantFollowUpService>()) {
    sl.registerLazySingleton<BusinessOperatorAssistantFollowUpService>(
      () => BusinessOperatorAssistantFollowUpService(
        plannerService: sl<BusinessOperatorFollowUpPromptPlannerService>(),
      ),
    );
  }
  if (!sl.isRegistered<OnboardingFollowUpPromptPlannerService>()) {
    sl.registerLazySingleton<OnboardingFollowUpPromptPlannerService>(
  ...
  if (!sl.isRegistered<OnboardingAssistantFollowUpService>()) {
    sl.registerLazySingleton<OnboardingAssistantFollowUpService>(
      () => OnboardingAssistantFollowUpService(
        plannerService: sl<OnboardingFollowUpPromptPlannerService>(),
      ),
    );
  }
  if (!sl.isRegistered<ReservationOperationalFollowUpPromptPlannerService>()) {
    sl.registerLazySingleton<
  ...
  if (!sl.isRegistered<ReservationOperationalAssistantFollowUpService>()) {
    sl.registerLazySingleton<ReservationOperationalAssistantFollowUpService>(
      () => ReservationOperationalAssistantFollowUpService(
        plannerService:
            sl<ReservationOperationalFollowUpPromptPlannerService>(),
      ),
    );
  }
  ...
  sl.registerLazySingleton(() => PersonalityAgentChatService(
        ...
        userGovernedLearningProjectionService:
            sl<UserGovernedLearningProjectionService>(),
        userGovernedLearningControlService:
            sl<UserGovernedLearningControlService>(),
        userGovernedLearningResponseComposerService:
            sl<UserGovernedLearningResponseComposerService>(),
        reservationOperationalAssistantFollowUpService:
            sl.isRegistered<ReservationOperationalAssistantFollowUpService>()
                ? sl<ReservationOperationalAssistantFollowUpService>()
                : null,
      ));
    ...
    sl.registerLazySingleton<DwellEventIntakeAdapter>(
      () => DwellEventIntakeAdapter(
        ...
        visitLocalityFollowUpPlannerService:
            sl.isRegistered<VisitLocalityFollowUpPromptPlannerService>()
                ? sl<VisitLocalityFollowUpPromptPlannerService>()
                : null,
      ),
    );
  }
