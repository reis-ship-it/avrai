...
Future<void> _registerAppServiceLayer(AppLogger logger) async {
  ...
  if (!sl.isRegistered<Ai2AiMeshGovernanceBindingService>()) {
    sl.registerLazySingleton<Ai2AiMeshGovernanceBindingService>(
      () => Ai2AiMeshGovernanceBindingService(
  ...
  sl.registerLazySingleton(() => EventCreationController(
        ...
        eventPlanningTelemetryService:
            sl.isRegistered<EventPlanningTelemetryService>()
