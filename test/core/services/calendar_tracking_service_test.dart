...
import 'package:avrai/core/services/analytics/calendar_tracking_service.dart';
  ...
  group('CalendarTrackingService', () {
    ...
    group('Event Type Inference', () {
      ...
      test('work keywords should be recognized', () {
        ...
        for (final title in workKeywords) {
          expect(title.toLowerCase().contains('meeting') ||
              ...
              title.toLowerCase().contains('presentation'), isTrue,
    ...
    group('Pattern Analysis', () {
      ...
      test('busiest day calculation should identify day with most events', () {
        ...
        final busiestDay = dayCounts.entries
            .reduce((a, b) => a.value > b.value ? a : b)
            .key;
    ...
    group('Service Lifecycle', () {
      ...
      test('collectCalendarEvents should return empty list when not initialized',
          () async {
