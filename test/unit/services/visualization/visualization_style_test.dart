...
void main() {
  ...
  group('VisualizationStyleFactory', () {
    test('should create knot style from brand colors', () {
      ...
      expect(style.primaryColor, equals(AppColors.electricGreen.toHex()));
      expect(style.secondaryColor, equals(AppColors.primaryLight.toHex()));
    });

    test('should create fabric style from brand colors', () {
      final style = VisualizationStyleFactory.fabricFromBrand();

      expect(style.highlightColor, equals(AppColors.white.toHex()));
    });
    ...
    test('should create network style from brand colors', () {
      ...
      expect(style.nodeColor, equals(AppColors.electricGreen.toHex()));
      expect(style.edgeColor, equals(AppColors.electricGreen.toHex()));
      expect(style.centerColor, equals(AppColors.white.toHex()));
    });
  });
}
