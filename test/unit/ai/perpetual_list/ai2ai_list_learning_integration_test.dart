  ...
  group('AI2AIListLearningIntegration', () {
    ...
    group('age filtering', () {
      ...
      test('should filter 18+ insights for users under 18', () {
        ...
        final candidateWithAdult = _createScoredCandidate(category: 'tattoo_parlor');
    ...
    group('sensitive category handling', () {
      test('should require opt-in for sensitive categories', () {
        ...
        final sensitiveCandidate = _createScoredCandidate(category: 'adult_entertainment');
    ...
    group('possibility collapse', () {
      test('should collapse to best matching possibility on positive interaction', () {
        final possibilities = [
      ...
      test('should generate dimension updates from collapse', () {
        ...
        expect(collapseResult.dimensionUpdates['novelty_seeking'], equals(0.02));
      });
    });
