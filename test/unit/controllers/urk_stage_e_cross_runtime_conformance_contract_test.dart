import 'package:avrai/runtime/avrai_runtime_os/kernel/contracts/urk_stage_e_cross_runtime_conformance_contract.dart';
...
void main() {
  group('UrkStageECrossRuntimeConformanceValidator', () {
    ...
    test('fails when runtime set coverage is incomplete', () {
      ...
      expect(
        result.failures,
        contains(UrkStageECrossRuntimeConformanceFailure.runtimeCountBelowThreshold),
      );
    });
    ...
    test('fails when coverage/determinism regress or policy diverges', () {
      ...
      expect(
        result.failures,
        contains(UrkStageECrossRuntimeConformanceFailure.contractCoverageBelowThreshold),
      );
      expect(
        result.failures,
        contains(
      ...
      expect(
        result.failures,
        contains(UrkStageECrossRuntimeConformanceFailure.policyDivergenceDetected),
      );
    });
  });
}
