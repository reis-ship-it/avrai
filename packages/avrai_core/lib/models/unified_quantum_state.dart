...
class UnifiedQuantumState {
  ...
  double _calculateNorm() {
    ...
    if (stringData != null) {
      ...
      final initialKnotData = stringData?['initialKnot'] as Map<String, dynamic>?;
      if (initialKnotData != null) {
        final invariants = initialKnotData['invariants'] as Map<String, dynamic>?;
        final crossingNumber = (invariants?['crossingNumber'] as num?)?.toInt() ?? 0;
    ...
    if (worldsheetData != null) {
      ...
      final initialFabricData = worldsheetData?['initialFabric'] as Map<String, dynamic>?;
      if (initialFabricData != null) {
        final invariants = initialFabricData['invariants'] as Map<String, dynamic>?;
