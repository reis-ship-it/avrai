...
class WorldsheetSimilarity {
  ...
  factory WorldsheetSimilarity.fromJson(Map<String, dynamic> json) {
    return WorldsheetSimilarity(
      ...
      stabilitySimilarity: (json['stabilitySimilarity'] as num?)?.toDouble() ?? 0.0,
      densitySimilarity: (json['densitySimilarity'] as num?)?.toDouble() ?? 0.0,
      evolutionRateSimilarity: (json['evolutionRateSimilarity'] as num?)?.toDouble() ?? 0.0,
      invariantSimilarity: (json['invariantSimilarity'] as num?)?.toDouble() ?? 0.0,
