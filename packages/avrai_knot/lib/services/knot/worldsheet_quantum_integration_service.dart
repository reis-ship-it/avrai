  ...
  double calculateQuantumFabricCompatibility({
    ...
    try {
      ...
      for (final state in states) {
        ...
        final knotComplexity = (correspondingKnot.invariants.crossingNumber / 100.0)
            .clamp(0.0, 1.0);
      ...
      final finalCompatibility = (0.7 * avgCompatibility + 0.3 * fabric.stability);
