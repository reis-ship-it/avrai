...
class CrossSystemCompatibilityService {
  ...
  Future<double> calculateUnifiedCompatibility({
    ...
    developer.log(
      'Calculating unified compatibility',
      name: _logName,
    );
    ...
    try {
      ...
      if (string1 != null && string2 != null && _temporalStringService != null) {
        stringCompat = _temporalStringService.calculateTemporalStringCompatibility(
          s1: string1,
          s2: string2,
          t1: tAtomic1,
          t2: tAtomic2,
      ...
      if (fabric1 != null && fabric2 != null && _worldsheetQuantumService != null) {
        // Compare fabrics
        worldsheetCompat = _calculateFabricCompatibility(fabric1, fabric2);
      }
      
      // Combined compatibility
      final unified = (_quantumWeight * quantumCompat) +
  ...
  double _calculateKnotKnotCompatibility(
    ...
    final writheDiff = (knot1.invariants.writhe - knot2.invariants.writhe).abs();
  ...
  double _calculateFabricCompatibility(
    KnotFabric fabric1,
    KnotFabric fabric2,
  ) {
  ...
  Future<double> calculateUnifiedCompatibilityWithWeights({
    ...
    final totalWeight = quantumWeight + knotWeight + temporalWeight + 
                       stringWeight + worldsheetWeight;
    ...
    final unified = (quantumWeight * quantumCompat) +
