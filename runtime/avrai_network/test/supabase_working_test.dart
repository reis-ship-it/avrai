...
void main() {
  ...
  group('Supabase Working Example Tests', () {
    ...
    test('should handle initialization failure gracefully', () async {
      ...
      // In tests, this might initialize dummy supabase anyway
      expect(success, isA<bool>());
    });
    ...
    test('should handle document operations', () async {
      ...
      final document = await SupabaseWorkingExample.createDocument('test', {
        'name': 'test',
      });
    ...
    test('should handle file operations', () async {
      ...
      final path = await SupabaseWorkingExample.uploadFile('test.txt', [
        1,
        2,
        3,
        4,
