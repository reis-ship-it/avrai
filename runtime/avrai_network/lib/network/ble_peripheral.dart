...
class BlePeripheral {
  ...
  static Future<bool> startPeripheral({required Uint8List payload}) async {
    try {
      ...
      developer.log(
        'Failed to start BLE peripheral',
        name: _logName,
        error: e,
        stackTrace: st,
      );
  ...
  static Future<bool> updatePayload({required Uint8List payload}) async {
    try {
      ...
      developer.log(
        'Failed to update BLE peripheral payload',
        name: _logName,
        error: e,
        stackTrace: st,
      );
  ...
  static Future<bool> updatePreKeyPayload({required Uint8List payload}) async {
    try {
      ...
      developer.log(
        'Failed to update BLE peripheral prekey payload',
        name: _logName,
        error: e,
        stackTrace: st,
      );
  ...
  static Future<bool> updateServiceDataFrameV1({
    ...
    try {
      ...
      developer.log(
        'Failed to update BLE peripheral service-data frame v1',
        name: _logName,
        error: e,
        stackTrace: st,
      );
