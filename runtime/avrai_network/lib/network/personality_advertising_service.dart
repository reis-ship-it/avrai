...
class PersonalityAdvertisingService {
  ...
  Future<bool> _startAndroidAdvertising(
    ...
    try {
      ...
      if (jsonPayload.isEmpty) {
        developer.log(
          'Failed to encode personality data JSON payload',
          name: _logName,
        );
        return false;
      }
  ...
  Future<bool> _startWebAdvertising(AnonymizedVibeData personalityData) async {
    try {
      ...
      developer.log(
        'Web advertising requires signaling server registration',
        name: _logName,
      );
      developer.log(
        'Would register with personality data: ${jsonData.length} bytes',
        name: _logName,
      );
  ...
  Future<bool> _updateWebAdvertising(AnonymizedVibeData personalityData) async {
    ...
    developer.log(
      'Updating Web advertising with new personality data',
      name: _logName,
    );
    return true;
  }
