...
class AndroidDeviceDiscovery extends DeviceDiscoveryPlatform {
  ...
  Future<List<DiscoveredDevice>> scanForDevices({
    ...
    if (!isSupported()) {
      developer.log(
        'Android discovery not supported on this platform',
        name: _logName,
      );
      return [];
    }
  ...
  AnonymizedVibeData? _extractPersonalityFromAdvertisement(
    ...
    try {
      ...
      if (!PersonalityDataCodec.isSpotsPersonalityData(dataBytes)) {
        developer.log(
          'Manufacturer data does not contain SPOTS personality data',
          name: _logName,
        );
        return null;
      }
      ...
      if (personalityData == null) {
        developer.log(
          'Failed to decode personality data from manufacturer data',
          name: _logName,
        );
        return null;
      }
      ...
      developer.log(
        'Successfully extracted personality data from BLE advertisement',
        name: _logName,
      );
