...
class SyncStatus extends Equatable {
  ...
  SyncStatus startSync() {
    return copyWith(state: SyncState.syncing, lastSyncAttempt: DateTime.now());
  }
  ...
  SyncStatus syncConflict(Map<String, dynamic> conflictData) {
    return copyWith(state: SyncState.conflict, pendingChanges: conflictData);
  }
  ...
  Duration get timeSinceLastAttempt =>
      DateTime.now().difference(lastSyncAttempt);
...
class SyncQueue extends Equatable {
  ...
  factory SyncQueue.empty() {
    ...
    return SyncQueue(operations: const [], createdAt: now, updatedAt: now);
  }
