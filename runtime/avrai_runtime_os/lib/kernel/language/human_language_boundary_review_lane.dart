    ...
    String metadataKey = HumanLanguageBoundaryReview.metadataKey,
      ...
      <String, dynamic>{
        metadataKey: <String, dynamic>{
          ...
          'asks_for_response':
              turn.interpretation.requestArtifact.asksForResponse,
          'asks_for_recommendation':
              turn.interpretation.requestArtifact.asksForRecommendation,
          'asks_for_action': turn.interpretation.requestArtifact.asksForAction,
          'asks_for_explanation':
              turn.interpretation.requestArtifact.asksForExplanation,
          'referenced_entities':
              turn.interpretation.requestArtifact.referencedEntities,
          'questions': turn.interpretation.requestArtifact.questions,
          'preference_signals': turn
              .interpretation.requestArtifact.preferenceSignals
              .map((entry) => entry.toJson())
              .toList(),
          'share_intent': turn.interpretation.requestArtifact.shareIntent,
