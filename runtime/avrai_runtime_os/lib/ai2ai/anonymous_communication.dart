...
class AnonymousCommunicationProtocol {
  ...
  static final int _messageExpirationMinutes =
      Ai2AiRetentionConfig.wormholeQueue.ttl?.inMinutes ?? 60;
  ...
  Ai2AiRetentionPolicy get deliveredMessageRetentionPolicy =>
      Ai2AiRetentionConfig.localDeliveredHistory;
  ...
  Future<AnonymousMessage> sendEncryptedMessage(
    ...
    try {
      ...
      final message = AnonymousMessage(
        ...
        expiresAt:
            DateTime.now().add(Duration(minutes: _messageExpirationMinutes)),
        routingHops: [],
