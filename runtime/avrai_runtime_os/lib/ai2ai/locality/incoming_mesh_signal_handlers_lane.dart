...
import 'package:avrai_runtime_os/ai2ai/locality/incoming_locality_agent_update_processor.dart';
import 'package:avrai_runtime_os/ai2ai/locality/incoming_organic_spot_discovery_processor.dart';
  ...
  static Future<void> handleLocalityAgentUpdate({
    ...
    try {
      ...
      final ingestionResult =
          await IncomingLocalityAgentUpdateProcessor.process(
        payload: payload,
