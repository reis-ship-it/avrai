...
class OutcomePredictionModel {
  ...
  static const int totalInputSize =
      baseInputSize + historyFeatureSize; // ~45 features
  ...
  static const String defaultModelPath =
      'assets/models/outcome_prediction_model.onnx';
    ...
    try {
      ...
      if (modelPath != null) {
        ...
        final activeVersionInfo =
            ModelVersionRegistry.getActiveOutcomeVersion();
  ...
  double _ruleBasedPrediction(
    ...
    final pastPositiveRate =
        historyFeatures.isNotEmpty ? historyFeatures[0] : 0.5;
    final averageEngagement =
        historyFeatures.length > 2 ? historyFeatures[2] : 0.5;

    // Weighted combination
    final score = (vibeCompatibility * 0.30 +
            contextFactor * 0.20 +
            timingFactor * 0.15 +
