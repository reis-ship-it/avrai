...
class ModelVersionRegistry {
  ...
  static final Map<String, ModelVersionInfo> _versions = {
    'v1.0-hybrid': ModelVersionInfo(
      ...
      description:
          'v1.0 hybrid model (Big Five personality + synthetic spots/context/timing)',
      trainingMetrics: {
        'test_loss': 0.0267,
    ...
    'v1.1-hybrid': ModelVersionInfo(
      ...
      defaultWeight:
          0.1, // Start with low weight, will increase after A/B test validation
      dataSource: 'hybrid_big_five',
      trainedDate: DateTime(2025, 12, 28),
      status: ModelStatus.staging,
      description:
          'v1.1 optimized hybrid model (batch_size=128, +3.75% improvement vs v1.0)',
      trainingMetrics: {
        'test_loss': 0.0257,
        'val_loss': 0.0279,
  ...
  static double getVersionWeight(String version,
