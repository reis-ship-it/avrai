...
class SignalRustWrapperBindings {
  ...
  Future<void> initialize() async {
    if (_initialized) {
      developer.log('Rust wrapper bindings already initialized',
          name: _logName);
      return;
    }
    ...
    try {
      ...
      _registerDispatchCallback = _lib!
          .lookup<NativeFunction<_NativeRegisterDispatchCallback>>(
      ...
      _getLoadSessionWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_load_session_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getStoreSessionWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_store_session_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getGetIdentityKeyPairWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_get_identity_key_pair_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getGetLocalRegistrationIdWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_get_local_registration_id_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getSaveIdentityKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_save_identity_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getGetIdentityKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_get_identity_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getIsTrustedIdentityWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_is_trusted_identity_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getLoadPreKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_load_pre_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getStorePreKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_store_pre_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getRemovePreKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_remove_pre_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getLoadSignedPreKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_load_signed_pre_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getStoreSignedPreKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_store_signed_pre_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getLoadKyberPreKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_load_kyber_pre_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getStoreKyberPreKeyWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_store_kyber_pre_key_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();

      _getMarkKyberPreKeyUsedWrapperPtr = _lib!
          .lookup<NativeFunction<_NativeGetWrapperPtr>>(
              'spots_rust_get_mark_kyber_pre_key_used_wrapper_ptr')
          .asFunction<_GetWrapperPtr>();
      ...
      final error = SignalProtocolException(
          'Failed to load Rust wrapper library: ${e.message}');
      developer.log('Failed to initialize Rust wrapper bindings: $error',
          error: error, name: _logName);
      throw error;
    } catch (e, stackTrace) {
      developer.log(
  ...
  void registerDispatchCallback(Pointer<Void> dispatchCallback) {
    if (!_initialized) {
      throw SignalProtocolException(
          'Rust wrapper bindings not initialized. Call initialize() first.');
    }
