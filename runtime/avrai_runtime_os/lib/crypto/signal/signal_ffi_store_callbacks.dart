...
class SignalFFIStoreCallbacks {
  ...
  Future<void> initialize() async {
    ...
    try {
      developer.log('Initializing Signal FFI store callbacks...',
          name: _logName);
      ...
      _initialized = true;
      developer.log('✅ Signal FFI store callbacks initialized successfully',
          name: _logName);
    } catch (e, st) {
      developer.log(
  ...
  void _registerCallbacks() {
    ...
    _callbackRegistry[_getIdentityKeyPairCallbackId] =
        _getIdentityKeyPairCallbackImpl;
    _callbackRegistry[_getLocalRegistrationIdCallbackId] =
        _getLocalRegistrationIdCallbackImpl;
    _callbackRegistry[_saveIdentityKeyCallbackId] =
        _saveIdentityKeyCallbackImpl;
    _callbackRegistry[_getIdentityKeyCallbackId] = _getIdentityKeyCallbackImpl;
    _callbackRegistry[_isTrustedIdentityCallbackId] =
        _isTrustedIdentityCallbackImpl;
    ...
    _callbackRegistry[_loadSignedPreKeyCallbackId] =
        _loadSignedPreKeyCallbackImpl;
    _callbackRegistry[_storeSignedPreKeyCallbackId] =
        _storeSignedPreKeyCallbackImpl;
    _callbackRegistry[_loadKyberPreKeyCallbackId] =
        _loadKyberPreKeyCallbackImpl;
    _callbackRegistry[_storeKyberPreKeyCallbackId] =
        _storeKyberPreKeyCallbackImpl;
  ...
  static void _ensureNativeHelpersBound(SignalFFIBindings ffiBindings) {
    ...
    _addressGetName = lib
        .lookup<
            NativeFunction<
                Pointer<SignalFfiError> Function(Pointer<Pointer<Utf8>>,
                    _SignalConstPointerProtocolAddress)>>(
    ...
    _sessionRecordSerialize = lib
        .lookup<
            NativeFunction<
                Pointer<SignalFfiError> Function(Pointer<SignalOwnedBuffer>,
                    _SignalConstPointerSessionRecord)>>(
  ...
  static int _storeSessionCallbackImpl(
    ...
    try {
      ...
      context.ffiBindings.checkError(err);
      final bytes =
          _serializeOwnedBufferToBytesAndFree(context.ffiBindings, out);
  ...
  static int _getIdentityKeyPairCallbackImpl(
    ...
    try {
      ...
      try {
        data
            .asTypedList(identity.privateKey.length)
            .setAll(0, identity.privateKey);
        borrowed.ref.base = data;
  ...
  static int _loadPreKeyCallbackImpl(
    ...
    try {
      ...
      developer.log('load_pre_key failed: $e',
  ...
  static int _storePreKeyCallbackImpl(
    ...
    try {
      ...
      final bytes =
          _serializeOwnedBufferToBytesAndFree(context.ffiBindings, out);
      unawaited(
          context.keyManager.storePreKeyRecord(id: id, serialized: bytes));
      return 0;
    } catch (e, st) {
      developer.log('store_pre_key failed: $e',
          name: _logName, error: e, stackTrace: st);
      return 1;
    }
  }
  ...
  static int _loadSignedPreKeyCallbackImpl(
    ...
    try {
      ...
      developer.log('load_signed_pre_key failed: $e',
          name: _logName, error: e, stackTrace: st);
      recordp.ref.raw = nullptr;
      return 1;
    }
  ...
  static int _storeSignedPreKeyCallbackImpl(
    ...
    try {
      ...
      final bytes =
          _serializeOwnedBufferToBytesAndFree(context.ffiBindings, out);
      unawaited(context.keyManager
          .storeSignedPreKeyRecord(id: id, serialized: bytes));
      unawaited(context.keyManager.setCurrentSignedPreKeyId(id));
      return 0;
    } catch (e, st) {
      developer.log('store_signed_pre_key failed: $e',
          name: _logName, error: e, stackTrace: st);
      return 1;
    }
  }
  ...
  static int _loadKyberPreKeyCallbackImpl(
    ...
    try {
      ...
      developer.log('load_kyber_pre_key failed: $e',
          name: _logName, error: e, stackTrace: st);
      recordp.ref.raw = nullptr;
      return 1;
    }
  ...
  static int _storeKyberPreKeyCallbackImpl(
    ...
    try {
      ...
      final bytes =
          _serializeOwnedBufferToBytesAndFree(context.ffiBindings, out);
      unawaited(
          context.keyManager.storeKyberPreKeyRecord(id: id, serialized: bytes));
      unawaited(context.keyManager.setCurrentKyberPreKeyId(id));
      return 0;
    } catch (e, st) {
      developer.log('store_kyber_pre_key failed: $e',
          name: _logName, error: e, stackTrace: st);
      return 1;
    }
  }
  ...
  Pointer<_SignalSessionStore> createSessionStore() {
    ...
    final store =
        malloc.allocate<_SignalSessionStore>(sizeOf<_SignalSessionStore>());
  ...
  Pointer<_SignalIdentityKeyStore> createIdentityKeyStore() {
    ...
    final store = malloc
        .allocate<_SignalIdentityKeyStore>(sizeOf<_SignalIdentityKeyStore>());

    // Set context
    store.ref.ctx = _contextPtr.cast();

    // Get function pointers from Rust wrapper (these call the registered Dart callbacks)
    store.ref.get_identity_key_pair =
        _rustWrapper.getGetIdentityKeyPairWrapperPtr().cast();
    store.ref.get_local_registration_id =
        _rustWrapper.getGetLocalRegistrationIdWrapperPtr().cast();
    store.ref.save_identity =
        _rustWrapper.getSaveIdentityKeyWrapperPtr().cast();
    store.ref.get_identity = _rustWrapper.getGetIdentityKeyWrapperPtr().cast();
    store.ref.is_trusted_identity =
        _rustWrapper.getIsTrustedIdentityWrapperPtr().cast();
  ...
  Pointer<_SignalPreKeyStore> createPreKeyStore() {
    ...
    final store =
        malloc.allocate<_SignalPreKeyStore>(sizeOf<_SignalPreKeyStore>());
    store.ref.ctx = _contextPtr.cast();
...
typedef _NativeLoadSessionCallback = IntPtr Function(
    Pointer<Void>,
    Pointer<_SignalMutPointerSessionRecord>,
...
typedef _NativeSaveIdentityKeyCallback = IntPtr Function(
    Pointer<Void>,
    Pointer<_SignalConstPointerProtocolAddress>,
...
typedef _NativeGetIdentityKeyCallback = IntPtr Function(
    Pointer<Void>,
    Pointer<SignalMutPointerPublicKey>,
    Pointer<_SignalConstPointerProtocolAddress>);
...
typedef _NativeIsTrustedIdentityCallback = IntPtr Function(
    Pointer<Void>,
    Pointer<_SignalConstPointerProtocolAddress>,
    Pointer<SignalConstPointerPublicKey>,
    Uint32);
...
final class _SignalIdentityKeyStore extends Struct {
  external Pointer<Void> ctx;
  external Pointer<NativeFunction<_NativeGetIdentityKeyPairCallback>>
      get_identity_key_pair;
  external Pointer<NativeFunction<_NativeGetLocalRegistrationIdCallback>>
      get_local_registration_id;
  external Pointer<NativeFunction<_NativeSaveIdentityKeyCallback>>
      save_identity;
  external Pointer<NativeFunction<_NativeGetIdentityKeyCallback>> get_identity;
  external Pointer<NativeFunction<_NativeIsTrustedIdentityCallback>>
      is_trusted_identity;
}
