...
typedef _NativePreKeySignalMessageDeserialize = Pointer<SignalFfiError>
    Function(
...
class SignalFFIBindings {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _preKeyRecordNew = _lib!
          .lookup<NativeFunction<_NativePreKeyRecordNew>>(
  ...
  Future<SignalPreKeyBundle> generatePreKeyBundle({
    ...
    try {
      ...
      final getKyberPublicKeyError = _kyberKeyPairGetPublicKey(
          kyberPublicKeyPtr, constKyberKeyPairPtr.ref);
      ...
      final extractSignedPrekeyError = _publicKeySerialize(
          signedPrekeyExtractBufferPtr,
          constSignedPrekeyPublicKeyForExtract.ref);
  ...
  Future<SignalLocalPreKeyMaterial> generateLocalPreKeyMaterial({
    ...
    final constOneTimePrekeyPrivateKeyPtr =
        malloc<SignalConstPointerPrivateKey>();
    final constOneTimePrekeyPublicKeyPtr =
        malloc<SignalConstPointerPublicKey>();
    ...
    try {
      ...
      constOneTimePrekeyPrivateKeyPtr.ref.raw =
          oneTimePrekeyPrivateKeyPtr.ref.raw;
      _checkError(
        _privateKeyGetPublicKey(
      ...
      constOneTimePrekeyPublicKeyPtr.ref.raw =
          oneTimePrekeyPublicKeyPtr.ref.raw;
      ...
      _checkError(
        _publicKeySerialize(
            identityPublicKeyExtract, constIdentityPublicKeyPtr.ref),
      );
      ...
      _checkError(
        _publicKeySerialize(
            oneTimePrekeyExtract, constOneTimePrekeyPublicKeyPtr.ref),
      );
