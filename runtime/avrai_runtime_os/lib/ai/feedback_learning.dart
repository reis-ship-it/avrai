...
import 'package:avrai_runtime_os/ai/feedback_learning_models.dart';

export 'package:avrai_runtime_os/ai/feedback_learning_models.dart';
...
class UserFeedbackAnalyzer {
        ...
        try {
          ...
          if (userProfile != null) {
            ...
            final eventTimestamp =
                _extractEventTimestamp(scenario) ?? userTimestamp;
            ...
            predictedSatisfaction =
                await _quantumSatisfactionEnhancer.enhanceSatisfaction(
  ...
  Map<String, double> _extractEventVibeDimensions(
      Map<String, dynamic> scenario) {
  ...
  LocationQuantumState? _extractUserLocationState(
      Map<String, dynamic> scenario) {
    try {
      ...
      if (userLocation != null) {
        ...
        if (lat != null && lon != null) {
          return LocationQuantumState.fromLocation(
            ...
            accessibilityScore:
                (userLocation['accessibilityScore'] as num?)?.toDouble(),
            vibeLocationMatch:
                (userLocation['vibeLocationMatch'] as num?)?.toDouble(),
          );
        }
      }
    } catch (e) {
  ...
  LocationQuantumState? _extractEventLocationState(
      Map<String, dynamic> scenario) {
    try {
        ...
        if (eventLocation != null) {
          ...
          if (lat != null && lon != null) {
            return LocationQuantumState.fromLocation(
              ...
              accessibilityScore:
                  (eventLocation['accessibilityScore'] as num?)?.toDouble(),
              vibeLocationMatch:
                  (eventLocation['vibeLocationMatch'] as num?)?.toDouble(),
            );
          }
        }
      }
