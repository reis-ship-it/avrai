...
class QuantumFeatureExtractor {
  ...
  Future<QuantumPredictionFeatures> extractFeatures({
    ...
    try {
      ...
      final decoherenceStability =
          decoherencePattern?.decoherenceStability ?? 1.0;
  ...
  double _calculateEntanglementStrength(
    ...
    final maxEntropy =
        count * math.log(2.0); // Maximum entropy for uniform distribution
    return maxEntropy > 0.0 ? (entropy / maxEntropy).clamp(0.0, 1.0) : 0.0;
  }
