...
class QuantumVibeState {
  ...
  QuantumVibeState interfere(QuantumVibeState other,
  ...
  @override
  String toString() =>
      'QuantumVibeState(real: ${real.toStringAsFixed(3)}, imaginary: ${imaginary.toStringAsFixed(3)}, probability: ${probability.toStringAsFixed(3)})';
