...
class LocationQuantumState {
  ...
  double innerProduct(LocationQuantumState other) {
    ...
    final latA = latitudeState.isNotEmpty
        ? latitudeState.first * latitudeState.first
        : 0.5;
    final latB = other.latitudeState.isNotEmpty
        ? other.latitudeState.first * other.latitudeState.first
        : 0.5;
    final lonA = longitudeState.isNotEmpty
        ? longitudeState.first * longitudeState.first
        : 0.5;
    final lonB = other.longitudeState.isNotEmpty
        ? other.longitudeState.first * other.longitudeState.first
        : 0.5;
    ...
    final inner = latOverlap *
        lonOverlap *
        typeOverlap *
        accessibilityOverlap *
        vibeOverlap;
