  ...
  Future<double> _calculateTemporalPatternsImprovement(
    ...
    if (data.timeData.isNotEmpty) {
      final temporalPatterns =
          _processor.analyzeTemporalPatterns(data.timeData);
      final seasonalPatterns =
          _processor.analyzeSeasonalPatterns(data.timeData);
    ...
    if (data.weatherData.isNotEmpty && data.timeData.isNotEmpty) {
      final weatherTimeCorrelation = _processor.analyzeWeatherTimeCorrelation(
