...
class RAGContextBuilder {
  RAGContextBuilder({
    ...
    MetroExperienceService? metroExperienceService,
        ...
        _metroExperienceService =
            metroExperienceService ?? _get<MetroExperienceService>();
  ...
  final MetroExperienceService? _metroExperienceService;
  ...
  Future<LanguageRuntimeContext> buildContext({
    ...
    try {
      ...
      if (_metroExperienceService != null) {
        try {
          final metroContext = await _metroExperienceService.resolveBestEffort(
            latitude: location?.latitude,
            longitude: location?.longitude,
          );
          final metroPreferences = metroContext.toPreferenceMap();
          conversationPreferencesMap = <String, dynamic>{
            if (conversationPreferencesMap != null)
              ...conversationPreferencesMap,
            ...metroPreferences,
          };
        } catch (e) {
          developer.log('Metro experience context fetch failed: $e',
              name: _logName);
        }
      }
