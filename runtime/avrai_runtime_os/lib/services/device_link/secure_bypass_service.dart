...
class SecureBypassService {
  ...
  Future<BypassRequest> initiateBypass({
    ...
    developer.log('Initiated secure bypass: ${response['request_id']}',
        name: _logName);
  ...
  Future<bool> verifyPassword({
    ...
    try {
      ...
      await _logBypassAudit(
        ...
        deviceId:
            _deviceRegistrationService.currentDevice?.deviceIdString ?? '',
  ...
  Future<void> _triggerRemoteWipe(RegisteredDevice device) async {
    try {
      ...
      developer.log('Remote wipe triggered for: ${device.deviceIdString}',
          name: _logName);
    } catch (e) {
