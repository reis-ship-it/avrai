...
class CallingScoreBaselineMetrics {
  ...
  Future<BaselineMetrics> calculateBaselineMetrics() async {
    try {
      ...
      int trueNegatives =
          0; // Not called (score < 0.70) and negative/neutral outcome
      int falsePositives = 0; // Called but negative outcome
      int falseNegatives = 0; // Not called but positive outcome

      double totalScoreError =
          0.0; // Sum of absolute differences between score and outcome
      ...
      final accuracy =
          total > 0 ? (truePositives + trueNegatives) / total : 0.0;
