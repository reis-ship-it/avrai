...
class PerformanceMonitor {
  ...
  final AppLogger _logger =
      const AppLogger(defaultTag: 'Performance', minimumLevel: LogLevel.debug);
  ...
  static const Duration _responseTimeWarningThreshold =
      Duration(milliseconds: 1000);
  static const Duration _responseTimeCriticalThreshold =
  ...
  Future<void> startMonitoring() async {
    ...
    try {
      ...
      _logger.error('Error starting performance monitoring',
  ...
  Future<void> stopMonitoring() async {
    ...
    try {
      ...
      _logger.error('Error stopping performance monitoring',
          error: e, tag: _logName);
    }
  }
  ...
  Future<PerformanceReport> generateReport(Duration timeWindow) async {
    try {
      ...
      // Get recent alerts
      final recentAlerts =
          _alerts.where((a) => a.timestamp.isAfter(cutoff)).toList();
      ...
      _logger.error('Error generating performance report',
          error: e, tag: _logName);
  ...
  void alertOnThreshold(String metric, double threshold) {
    ...
    developer.log('Alert threshold set for $metric: $threshold',
        name: _logName);
  }
  ...
  Future<void> _collectMetrics() async {
    try {
      ...
      await trackMetric(
          'memory_usage', memoryUsage / (1024 * 1024)); // Convert to MB
  ...
  Future<void> _createAlert(
      String metric, String severity, String message) async {
    try {
