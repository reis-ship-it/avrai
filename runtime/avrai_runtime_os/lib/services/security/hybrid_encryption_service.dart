...
class HybridEncryptionService implements MessageEncryptionService {
  ...
  HybridEncryptionService({
    ...
    aes.AES256GCMEncryptionService? aes256GCMService,
        ...
        _aes256GCMService =
            aes256GCMService ?? aes.AES256GCMEncryptionService();
  ...
  EncryptionType get encryptionType {
    ...
    if (_signalProtocolService != null &&
        _signalProtocolService.isInitialized) {
  ...
  bool get isSignalProtocolAvailable {
    return _signalProtocolService != null &&
        _signalProtocolService.isInitialized;
  }
  ...
  Future<EncryptedMessage> encrypt(String plaintext, String recipientId) async {
    ...
    if (_signalProtocolService != null) {
      try {
        ...
        final encrypted =
            await _signalProtocolService.encrypt(plaintext, recipientId);
    ...
    if (encrypted.encryptionType == EncryptionType.signalProtocol) {
      ...
      if (_signalProtocolService != null) {
        try {
          ...
          final decrypted =
              await _signalProtocolService.decrypt(encrypted, senderId);
        ...
        throw Exception(
            'Signal Protocol service not available, cannot decrypt Signal Protocol message');
      }
    } else {
