...
class HumanChatPromptComposer {
  ...
  String _buildSystemInstruction({
    ...
    if (metroContext != null) {
      ...
      if (metroContext.governedKnowledgeTimingSummary case final timing?) {
        sections.add(
          'Local context timing: $timing. Prefer fresher governed locality knowledge over older assumptions.',
        );
      }
  ...
  Map<String, dynamic>? _buildSafeConversationPreferences(
    ...
    return <String, dynamic>{
      ...
      'governed_knowledge_occurred_at': metroContext
          .governedKnowledgeOccurredAtUtc
          ?.toUtc()
          .toIso8601String(),
      'governed_knowledge_captured_at': metroContext
          .governedKnowledgeCapturedAtUtc
          ?.toUtc()
          .toIso8601String(),
      'governed_knowledge_integrated_at': metroContext
          .governedKnowledgeIntegratedAtUtc
          ?.toUtc()
          .toIso8601String(),
      'governed_knowledge_synced_at':
          metroContext.governedKnowledgeSyncedAtUtc?.toUtc().toIso8601String(),
      'governed_knowledge_phase': metroContext.governedKnowledgePhase,
      'governed_knowledge_timing_summary':
          metroContext.governedKnowledgeTimingSummary,
    };
  }
