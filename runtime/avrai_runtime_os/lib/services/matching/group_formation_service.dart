  ...
  Future<List<DiscoveredUser>> discoverNearbyUsers({
    ...
    try {
      ...
      final currentAgentId =
          await _agentIdService.getUserAgentId(currentUserId);
      ...
      for (final device in devices) {
        try {
          ...
          final deviceAgentId =
              device.deviceId; // TODO: Map deviceId to agentId if needed
          ...
          if (_knotCompatibilityService != null && currentKnot != null) {
            try {
              ...
              if (deviceKnot != null) {
                ...
                compatibilityScore =
                    0.5; // Neutral if knot compatibility unavailable
              }
            } catch (e) {
              developer.log(
  ...
  Future<List<String>> getFriendsList(String currentUserId) async {
    ...
    try {
      ...
      if (_socialDiscovery != null) {
        try {
          final connectedFriends =
              await _socialDiscovery.getConnectedFriends(currentAgentId);
