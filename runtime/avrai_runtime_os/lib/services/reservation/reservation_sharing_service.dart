...
class ReservationSharingService {
  ...
  Future<SharingOperationResult> shareReservation({
    ...
    try {
      ...
      await _stageReservationSharingBestEffort(
        ownerUserId: ownerUserId,
        reservation: reservation,
        action: 'share',
        occurredAtUtc: sharedReservation.sharedAt,
        counterpartUserId: sharedWithUserId,
        permission: permission.name,
      );
      await _createReservationFollowUpPlanBestEffort(
        ownerUserId: ownerUserId,
        reservation: reservation,
        action: 'share',
        occurredAtUtc: sharedReservation.sharedAt,
  ...
  Future<TransferOperationResult> transferReservation({
    ...
    try {
      ...
      await _createReservationFollowUpPlanBestEffort(
        ...
        reservation: reservation,
        action: 'transfer',
        occurredAtUtc: transferredReservation.updatedAt,
        counterpartUserId: toUserId,
      );
  ...
  Future<void> _stageReservationSharingBestEffort({
    required String ownerUserId,
    required Reservation reservation,
    ...
    try {
      ...
      await _governedUpwardLearningIntakeService.stageReservationSharingIntake(
        ownerUserId: ownerUserId,
        reservation: reservation,
        action: action,
      ...
      developer.log(
        'Failed to stage reservation sharing upward intake: $e',
        name: _logName,
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> _createReservationFollowUpPlanBestEffort({
    required String ownerUserId,
    required Reservation reservation,
    required String action,
    required DateTime occurredAtUtc,
    ...
    final planner = _reservationFollowUpPlannerService;
    if (planner == null) {
      return;
    }
    try {
      await planner.createSharingPlan(
        ownerUserId: ownerUserId,
        reservation: reservation,
        action: action,
        occurredAtUtc: occurredAtUtc,
      ...
      developer.log(
        'Failed to create reservation sharing follow-up plan: $e',
        name: _logName,
        error: e,
        stackTrace: stackTrace,
      );
