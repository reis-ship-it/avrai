...
class ReservationRecurrenceService {
  ...
  Future<RecurrenceOperationResult> createRecurringSeries({
    ...
    try {
      ...
      await _stageReservationRecurrenceBestEffort(
        ownerUserId: userId,
        baseReservation: baseReservation,
        occurredAtUtc: series.createdAt,
        seriesId: series.id,
        pattern: pattern,
        createdReservationIds: createdIds,
      );
      await _createReservationRecurrenceFollowUpPlanBestEffort(
        ownerUserId: userId,
        baseReservation: baseReservation,
        occurredAtUtc: series.updatedAt,
        pattern: pattern,
        createdReservationIds: createdIds,
      );
  ...
  Future<void> _stageReservationRecurrenceBestEffort({
    ...
    try {
      ...
      await _governedUpwardLearningIntakeService
      ...
      developer.log(
        'Failed to stage reservation recurrence upward intake: $e',
        name: _logName,
        error: e,
        stackTrace: stackTrace,
      );
  ...
  Future<void> _createReservationRecurrenceFollowUpPlanBestEffort({
    required String ownerUserId,
    required Reservation baseReservation,
    required DateTime occurredAtUtc,
    required RecurrencePattern pattern,
    ...
    try {
      await planner.createRecurrencePlan(
        ...
        reservation: baseReservation,
        occurredAtUtc: occurredAtUtc,
        recurrencePattern: pattern.type.name,
        createdInstanceCount: createdReservationIds.length,
      );
    } catch (e, stackTrace) {
      developer.log(
        'Failed to create reservation recurrence follow-up plan: $e',
        name: _logName,
        error: e,
        stackTrace: stackTrace,
      );
