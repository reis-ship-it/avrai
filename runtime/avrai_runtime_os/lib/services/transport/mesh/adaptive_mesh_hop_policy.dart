...
class AdaptiveMeshHopPolicy {
  ...
  static int? calculateMaxHops({
    ...
    ExpertiseLevel?
        targetExpertiseLevel, // NEW: Target's expertise level (for learning)
  }) {
    ...
    // Calculate total
    final int totalHops =
        baseHops + densityBonus + priorityBonus + expertiseBonus;
  ...
  static bool _shouldAllowUnlimitedHops({
    ...
    if (userExpertiseLevel != null &&
      ...
      return baseConditions || (batteryLevel >= 60 && networkDensity >= 5);
    }
