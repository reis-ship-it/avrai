...
import 'package:avrai_runtime_os/ai2ai/telemetry/hot_discovery_enqueue_lane.dart';
import 'package:avrai_runtime_os/services/infrastructure/storage_service.dart'
    show SharedPreferencesCompat;
import 'package:avrai_runtime_os/services/transport/ble/battery_adaptive_ble_scheduler.dart';
import 'package:avrai_runtime_os/services/transport/ble/event_mode_scan_window_orchestration_lane.dart';
  ...
  static void onDevicesDiscoveredHotPath({
    ...
    HotDiscoveryEnqueueLane.handle(
      ...
      handleEventModeScanWindow: (scanDevices) async {
        final state =
            await EventModeScanWindowOrchestrationLane.handleForOrchestrator(
          allowBleSideEffects: allowBleSideEffects,
          ...
          eventModeLastDeepSyncAtMsByNodeTag:
              eventModeLastDeepSyncAtMsByNodeTag,
