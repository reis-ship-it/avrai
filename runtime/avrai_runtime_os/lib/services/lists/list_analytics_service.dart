...
class ListAnalyticsService {
  ...
  Future<void> trackListPin({
    ...
    try {
      ...
      developer.log('Tracked list pin: ${list.id} pinned=$isPinned',
          name: _logName);
    } catch (e) {
  ...
  Future<void> trackPlaceTap({
    ...
    try {
      ...
      developer.log('Tracked place tap: $placeId in ${list.id}',
          name: _logName);
    } catch (e) {
  ...
  Future<void> trackPlaceVisit({
    ...
    try {
      ...
      developer.log('Tracked place visit: $placeId from $listId',
          name: _logName);
    } catch (e) {
