...
class OutsideBuyerInsightsV1Validator {
  ...
  static const Set<String> allowedTimeGranularity = <String>{
    'hour',
    'day',
    'week'
  };

  static const Set<String> allowedDoorTypes = <String>{
    'spot',
    'event',
    'community'
  };
  ...
  static void validateRow(
    ...
    final uniqueNum =
        _expectNumValue(uniqueParticipants, 'metrics.unique_participants_est');
