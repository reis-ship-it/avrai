...
class LocalLlmProvisioningStateService {
  ...
  static const String _prefsKeyLastError =
      'local_llm_provisioning_last_error_v1';
  ...
  Future<LocalLlmProvisioningState> getState() async {
    ...
    return LocalLlmProvisioningState(
      ...
      lastError: effectivePhase == LocalLlmProvisioningPhase.error
          ? lastError
          : lastError,
      ...
      receivedBytes: effectivePhase == LocalLlmProvisioningPhase.downloading
          ? receivedBytes
          : null,
      totalBytes: effectivePhase == LocalLlmProvisioningPhase.downloading
          ? totalBytes
          : null,
    );
  }
