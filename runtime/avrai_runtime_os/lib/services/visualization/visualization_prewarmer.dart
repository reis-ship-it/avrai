    ...
    try {
      ...
      _headlessWebView = HeadlessInAppWebView(
        ...
        onLoadStop: (controller, url) async {
          developer.log('WebView loaded, initializing bridge...',
              name: _logName);
          ...
          try {
            await _bridge!.onReady.first.timeout(
              ...
              onTimeout: () {
                developer.log('Timeout waiting for Three.js ready',
                    name: _logName);
                return 'timeout';
              },
            );
      ...
      _headlessWebView = HeadlessInAppWebView(
        ...
        onLoadStop: (controller, url) async {
          ...
          try {
            ...
            developer.log('Timeout waiting for birth experience ready',
                name: _logName);
          }
