...
class AdminPermissionChecker {
  ...
  bool canViewUserProgress() => hasPermission(AdminPermission.viewUserProgress);
  ...
  bool canViewRealTimeData() => hasPermission(AdminPermission.viewRealTimeData);
  ...
  bool canAccessAuditLogs() => hasPermission(AdminPermission.accessAuditLogs);
}
