...
class SourceIntakeOrchestrator {
    ...
    for (final type in publishTypes) {
      switch (type) {
        case IntakeEntityType.spot:
          ...
          await _stageExternalConfirmationBestEffort(
            source: updatedSource.copyWith(
              metadata: <String, dynamic>{
                ...updatedSource.metadata,
                ...signatureMeta,
            ...
            metadata: metadata,
            entityType: IntakeEntityType.spot,
            entityId: spotId,
            action: 'materialized_import',
            boundedPayload: <String, dynamic>{
          ...
          await _stageExternalConfirmationBestEffort(
            ...
            boundedPayload: <String, dynamic>{
              ...
              if (candidate.startTime != null)
                'startTimeUtc': candidate.startTime!.toUtc().toIso8601String(),
            },
            occurredAtUtc: now,
          );
          break;
        case IntakeEntityType.community:
          ...
          await _stageExternalConfirmationBestEffort(
            ...
            metadata: metadata,
            entityType: IntakeEntityType.community,
  ...
  Future<void> _stageExternalConfirmationBestEffort({
    required ExternalSourceDescriptor source,
    ...
    try {
      ...
      developer.log(
        'Failed to stage external confirmation/import upward intake: $e',
        name: _logName,
        error: e,
        stackTrace: st,
      );
