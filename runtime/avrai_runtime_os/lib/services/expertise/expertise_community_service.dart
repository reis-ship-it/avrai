...
class ExpertiseCommunityService {
  ...
  Future<void> joinCommunity(
      ExpertiseCommunity community, UnifiedUser user) async {
    try {
      _logger.info('User ${user.id} joining community ${community.id}',
          tag: _logName);
  ...
  Future<List<ExpertiseCommunity>> findCommunitiesForUser(
  ...
  Future<List<ExpertiseCommunity>> searchCommunities({
    ...
    try {
      ...
      return allCommunities
          .where((community) {
            if (category != null && community.category != category) {
              return false;
            }
            if (location != null) {
  ...
  Future<List<UnifiedUser>> getCommunityMembers(
      ExpertiseCommunity community) async {
    try {
  ...
  String _generateCommunityId(String category, String? location) {
    ...
    final loc = location != null
        ? '_${location.toLowerCase().replaceAll(' ', '_')}'
        : '';
