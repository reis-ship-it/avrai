...
class ReplayAuthorityEndpointContractViolation implements Exception {
  const ReplayAuthorityEndpointContractViolation(this.message);

  final String message;

  @override
  String toString() => 'ReplayAuthorityEndpointContractViolation: $message';
}
...
class BhamReplaySupabaseUploadIndexService {
  const BhamReplaySupabaseUploadIndexService({
    ...
    BhamReplayArtifactRetentionService? retentionService,
  })  : _gatewayFactory = gatewayFactory,
        _retentionService =
            retentionService ?? const BhamReplayArtifactRetentionService();

  static const Map<String, Set<String>> _expectedIndexedRowKeys =
      <String, Set<String>>{
    'replay_runs': <String>{
      'run_id',
      'environment_id',
    ...
    'replay_artifact_partitions': <String>{
      'run_id',
      'artifact_ref',
      'section',
      'chunk_index',
    ...
    'replay_calibration_reports': <String>{
      'run_id',
      'artifact_ref',
      'report_json',
    },
    'replay_realism_gate_reports': <String>{
      'run_id',
      'artifact_ref',
      'report_json',
    },
    'replay_training_exports': <String>{
      'run_id',
      'artifact_ref',
      'manifest_json',
    },
    'replay_actor_profiles': <String>{
      'run_id',
      'actor_id',
      'locality_anchor',
    ...
    'replay_actor_kernel_bundles': <String>{
      'run_id',
      'actor_id',
      'locality_anchor',
      'has_full_bundle',
      'attached_kernel_ids',
      'ready_kernel_ids',
      'activation_count_by_kernel',
      'higher_agent_guidance_count',
      'metadata',
    },
    'replay_kernel_activation_traces': <String>{
      'run_id',
      'trace_id',
      'actor_id',
      'context_type',
      'context_id',
      'activated_kernel_ids',
      'higher_agent_guidance_ids',
      'metadata',
    },
    'replay_actor_connectivity_profiles': <String>{
      'run_id',
      'actor_id',
      'locality_anchor',
      'dominant_mode',
    ...
    'replay_actor_connectivity_transitions': <String>{
      'run_id',
      'transition_id',
      'actor_id',
      'schedule_surface',
    ...
    'replay_actor_tracked_locations': <String>{
      'run_id',
      'location_record_id',
      'actor_id',
      'month_key',
    ...
    'replay_actor_untracked_windows': <String>{
      'run_id',
      'window_id',
      'actor_id',
      'month_key',
    ...
    'replay_actor_movements': <String>{
      'run_id',
      'movement_id',
      'actor_id',
      'month_key',
      'origin_physical_ref',
      'destination_physical_ref',
      'origin_locality_anchor',
      'destination_locality_anchor',
      'mode',
      'tracked',
      'source_action_id',
      'metadata',
    },
    'replay_actor_flights': <String>{
      'run_id',
      'flight_id',
      'actor_id',
      'month_key',
      'airport_node_id',
      'airport_physical_ref',
      'destination_region',
      'reason',
      'source_action_id',
      'metadata',
    },
    'replay_exchange_threads': <String>{
      'run_id',
      'thread_id',
      'kind',
      'locality_anchor',
    ...
    'replay_exchange_participations': <String>{
      'run_id',
      'actor_id',
      'thread_id',
      'participation_state',
    ...
    'replay_exchange_events': <String>{
      ...
      'recipient_actor_ids',
      'interaction_type',
      'connectivity_receipt_json',
      'activated_kernel_ids',
      'higher_agent_guidance_ids',
      'metadata',
    },
    'replay_ai2ai_exchange_records': <String>{
      'run_id',
      'record_id',
      'actor_id',
      'thread_id',
    ...
    'replay_action_training_records': <String>{
      'run_id',
      'record_id',
      'actor_id',
      'kind',
    ...
    'replay_counterfactual_choices': <String>{
      'run_id',
      'record_id',
      'ordinal_index',
      'candidate_id',
    ...
    'replay_truth_decision_history': <String>{
      'run_id',
      'record_id',
      'subject_id',
      'subject_type',
    ...
    'replay_higher_agent_intervention_traces': <String>{
      'run_id',
      'trace_id',
      'actor_id',
      'action_record_id',
    ...
    'replay_run_variation_profiles': <String>{
      'run_id',
      'environment_id',
      'replay_year',
      'run_config_json',
      'same_seed_reproducible',
      'untracked_window_count',
      'offline_queued_count',
      'attendance_variation_count',
      'connectivity_variation_count',
      'route_variation_count',
      'exchange_timing_variation_count',
      'month_variation_counts',
      'notes',
      'metadata',
    },
    'replay_holdout_evaluations': <String>{
      'run_id',
      'metric_id',
      'environment_id',
      'replay_year',
  ...
  final BhamReplayArtifactRetentionService _retentionService;
  ...
  ReplayStorageUploadManifest buildUploadManifest({
    ...
    final boundaryReport = const BhamReplayStorageBoundaryService().buildReport(
      ...
      artifactMetadata: exportManifest.metadata,
    );
    ...
    final simulationAliasMetadata = _buildSimulationAliasMetadata(
      environmentId: exportManifest.environmentId,
      replayYear: exportManifest.replayYear,
      exportMetadata: exportManifest.metadata,
      partitionMetadata: partitionManifest.metadata,
    );
    ...
    return ReplayStorageUploadManifest(
      ...
      metadata: <String, dynamic>{
        'artifactLifecycle': _uploadManifestLifecycle(
          environmentId: exportManifest.environmentId,
          replayYear: exportManifest.replayYear,
          dryRun: dryRun,
        ).toJson(),
        'storageUploadManifestRef': _storageUploadManifestRef(
          environmentId: exportManifest.environmentId,
          replayYear: exportManifest.replayYear,
          dryRun: dryRun,
        ),
        ...
        if (_stringMetadata(
            ...
            null)
          'sourceStoragePartitionManifestRef': _stringMetadata(
            partitionManifest.metadata,
            'storagePartitionManifestRef',
          ),
        ...simulationAliasMetadata,
        ...
        'sourceStagingRoot': exportManifest.exportRoot,
        'sourcePartitionRoot': partitionManifest.partitionRoot,
        'sourceLifecycleStates': const <String, String>{
          'replay_storage_staging': 'accepted',
          'replay_storage_partitions': 'accepted',
        },
      },
    );
  }
  ...
  Future<ReplayStorageUploadManifest> uploadAndIndex({
    ...
    if (effectiveDryRun) {
      return ReplayStorageUploadManifest(
        ...
        metadata: <String, dynamic>{
          ...
          'retentionCleanupSucceeded': false,
          'retentionCleanupReason': 'dry_run_or_missing_credentials',
          'sourceLifecycleStates': const <String, String>{
            'replay_storage_staging': 'accepted',
            'replay_storage_partitions': 'accepted',
          },
    ...
    final boundaryReport = const BhamReplayStorageBoundaryService().buildReport(
      environmentId: uploadManifest.environmentId,
      replayYear: uploadManifest.replayYear,
      artifactMetadata: uploadManifest.metadata,
    ...
    Future<void> upsertTable({
      ...
      _validateIndexedRows(table: table, rows: rows);
    ...
    await upsertTable(
      ...
      rows: <Map<String, dynamic>>[
        <String, dynamic>{
          ...
          'metadata': <String, dynamic>{
            ..._selectSimulationAliasMetadata(uploadManifest.metadata),
            'status': uploadManifest.status,
    ...
    final cleanupResult = _retentionService.cleanupAfterSuccessfulUpload(
      exportManifest: exportManifest,
      partitionManifest: partitionManifest,
    );
    ...
    return ReplayStorageUploadManifest(
      ...
      notes: <String>[
        ...
        if (cleanupResult.deletedRoots.isNotEmpty)
          'Replay staging retention cleanup deleted ${cleanupResult.deletedRoots.length} root(s) after successful upload/index.'
        else
          'Replay staging retention cleanup did not delete any roots after successful upload/index.',
        if (cleanupResult.failures.isNotEmpty)
          'Replay staging retention cleanup left ${cleanupResult.failures.length} failure(s) for operator follow-up.',
      ],
      metadata: <String, dynamic>{
        ...uploadManifest.metadata,
        ...
        'retentionCleanupAttempted': cleanupResult.attempted,
        'retentionCleanupSucceeded': cleanupResult.succeeded,
        'deletedSourceRoots': cleanupResult.deletedRoots,
        'retainedSourceRoots': cleanupResult.retainedRoots,
        'retentionCleanupFailures': cleanupResult.failures,
        'sourceLifecycleStates': cleanupResult.lifecycleStatesByRole,
      },
    );
  }
  ...
  void _validateBuildUploadManifestContract({
    ...
    final violations = <String>[
      ...
      ..._collectReplayManifestBindingViolations(
        exportMetadata: exportManifest.metadata,
        partitionMetadata: partitionManifest.metadata,
      ),
  ...
  void _validateUploadAndIndexContract({
    ...
    final violations = <String>[
      ...
      ..._collectReplayManifestBindingViolations(
        exportMetadata: exportManifest.metadata,
        partitionMetadata: partitionManifest.metadata,
        uploadMetadata: uploadManifest.metadata,
      ),
      ..._collectExportEntryViolations(exportManifest.entries),
    ];
  ...
  List<String> _collectReplayManifestBindingViolations({
    required Map<String, dynamic> exportMetadata,
    required Map<String, dynamic> partitionMetadata,
    Map<String, dynamic> uploadMetadata = const <String, dynamic>{},
  }) {
    final violations = <String>[];
    ...
    compareValues(
      left: _stringMetadata(exportMetadata, 'sourceTrainingManifestRef'),
      right: _stringMetadata(partitionMetadata, 'sourceTrainingManifestRef'),
      message: 'Replay export and partition manifests must reference the '
          'same source training manifest.',
    );
    compareValues(
      left: _stringMetadata(exportMetadata, 'sourceTrainingRunRef'),
      right: _stringMetadata(partitionMetadata, 'sourceTrainingRunRef'),
      message: 'Replay export and partition manifests must reference the same '
          'source training run.',
    );
    compareValues(
      left: _stringMetadata(exportMetadata, 'storageExportManifestRef'),
      right:
          _stringMetadata(partitionMetadata, 'sourceStorageExportManifestRef'),
      message: 'Replay partition manifest must reference the current replay '
          'storage export manifest.',
    );

    if (uploadMetadata.isNotEmpty) {
      compareValues(
        left: _stringMetadata(uploadMetadata, 'sourceTrainingManifestRef'),
        right: _stringMetadata(exportMetadata, 'sourceTrainingManifestRef'),
        message: 'Replay upload manifest source training manifest ref must '
            'match export manifest binding.',
      );
      compareValues(
        left: _stringMetadata(uploadMetadata, 'sourceTrainingManifestRef'),
        right: _stringMetadata(partitionMetadata, 'sourceTrainingManifestRef'),
        message: 'Replay upload manifest source training manifest ref must '
            'match partition manifest binding.',
      );
      compareValues(
        left: _stringMetadata(uploadMetadata, 'sourceTrainingRunRef'),
        right: _stringMetadata(exportMetadata, 'sourceTrainingRunRef'),
        message: 'Replay upload manifest source training run ref must match '
            'export manifest binding.',
      );
      compareValues(
        left: _stringMetadata(uploadMetadata, 'sourceTrainingRunRef'),
        right: _stringMetadata(partitionMetadata, 'sourceTrainingRunRef'),
      ...
      compareValues(
        left: _stringMetadata(uploadMetadata, 'sourceStorageExportManifestRef'),
        right: _stringMetadata(exportMetadata, 'storageExportManifestRef'),
        message: 'Replay upload manifest source export manifest ref must '
            'match export manifest binding.',
      );
      compareValues(
        left: _stringMetadata(
          uploadMetadata,
          'sourceStoragePartitionManifestRef',
        ),
        right:
            _stringMetadata(partitionMetadata, 'storagePartitionManifestRef'),
        message: 'Replay upload manifest source partition manifest ref must '
            'match partition manifest binding.',
      );
    }
  ...
  String _storageUploadManifestRef({
    required String environmentId,
    required int replayYear,
    required bool dryRun,
  }) {
    return 'replay_storage_upload_manifest:'
        '$environmentId:$replayYear:${dryRun ? 'dry' : 'live'}';
  }
  ...
  Map<String, dynamic> _buildSimulationAliasMetadata({
    required String environmentId,
    required int replayYear,
    required Map<String, dynamic> exportMetadata,
    required Map<String, dynamic> partitionMetadata,
  }) {
    final legacyNamespace = exportMetadata['namespace']
                ?.toString()
                .trim()
                .isNotEmpty ==
            true
        ? exportMetadata['namespace'].toString().trim()
        : partitionMetadata['namespace']?.toString().trim().isNotEmpty == true
            ? partitionMetadata['namespace'].toString().trim()
            : null;
    final citySlug = exportMetadata['citySlug']?.toString().trim().isNotEmpty ==
            true
        ? exportMetadata['citySlug'].toString().trim()
        : partitionMetadata['citySlug']?.toString().trim().isNotEmpty == true
            ? partitionMetadata['citySlug'].toString().trim()
            : _citySlugFromEnvironmentId(environmentId);
    final cityDisplayName =
        exportMetadata['cityDisplayName']?.toString().trim().isNotEmpty == true
            ? exportMetadata['cityDisplayName'].toString().trim()
            : partitionMetadata['cityDisplayName']
                        ?.toString()
                        .trim()
                        .isNotEmpty ==
                    true
                ? partitionMetadata['cityDisplayName'].toString().trim()
                : _cityDisplayNameFromSlug(citySlug);
    final simulationEnvironmentId =
        '$citySlug-simulation-environment-$replayYear';
    final simulationEnvironmentNamespace = legacyNamespace != null &&
            legacyNamespace.startsWith('replay-world/')
        ? 'simulation-world/${legacyNamespace.substring('replay-world/'.length)}'
    ...
    return <String, dynamic>{
      ...
      'simulationLabel': '$cityDisplayName Simulation Environment $replayYear',
      'citySlug': citySlug,
      'cityDisplayName': cityDisplayName,
      if (exportMetadata['cityCode'] != null)
        'cityCode': exportMetadata['cityCode'],
      if (exportMetadata['cityPackManifestRef'] != null)
        'cityPackManifestRef': exportMetadata['cityPackManifestRef'],
      if (exportMetadata['cityPackId'] != null)
        'cityPackId': exportMetadata['cityPackId'],
      if (exportMetadata['cityPackStructuralRef'] != null)
        'cityPackStructuralRef': exportMetadata['cityPackStructuralRef'],
      if (exportMetadata['campaignDefaultsRef'] != null)
        'campaignDefaultsRef': exportMetadata['campaignDefaultsRef'],
      if (exportMetadata['localityExpectationProfileRef'] != null)
        'localityExpectationProfileRef':
            exportMetadata['localityExpectationProfileRef'],
      if (exportMetadata['worldHealthProfileRef'] != null)
        'worldHealthProfileRef': exportMetadata['worldHealthProfileRef'],
    };
  }

  Map<String, dynamic> _selectSimulationAliasMetadata(
  ...
  String _citySlugFromEnvironmentId(String environmentId) {
    ...
    final normalized = trimmed.split('/').last;
    return normalized
  ...
  List<Map<String, dynamic>> _buildSingleArtifactReportRows({
    ...
    if (decoded is! Map) {
      throw ReplayAuthorityEndpointContractViolation(
        'Replay upload-index artifact $artifactRef must decode to an object for '
        '$targetColumn, but received ${decoded.runtimeType}.',
      );
    }
  ...
  void _validateIndexedRows({
    required String table,
    required List<Map<String, dynamic>> rows,
  }) {
    final expectedKeys = _expectedIndexedRowKeys[table];
    if (expectedKeys == null) {
      throw ReplayAuthorityEndpointContractViolation(
        'Replay upload-index does not declare an endpoint row contract for '
        'table $table.',
      );
    }
    for (var index = 0; index < rows.length; index++) {
      ...
      final unexpectedKeys = actualKeys.difference(expectedKeys).toList()
        ..sort();
      if (missingKeys.isNotEmpty || unexpectedKeys.isNotEmpty) {
        throw ReplayAuthorityEndpointContractViolation(
          'Replay upload-index row contract violation for table $table at row '
          '$index: missing=${missingKeys.join(',')} '
  ...
  ArtifactLifecycleMetadata _uploadManifestLifecycle({
    required String environmentId,
    required int replayYear,
    required bool dryRun,
  }) {
    return ArtifactLifecycleMetadata(
      artifactClass: ArtifactLifecycleClass.archive,
      ...
      artifactFamily: 'replay_storage_upload_manifest',
      sourceScope: 'replay_storage_archive',
      provenanceRefs: <String>[
        environmentId,
        'replay_year:$replayYear',
        if (dryRun) 'dry_run' else 'live_upload',
      ],
      evaluationRefs: const <String>[
        'replay_storage_export_manifest',
        'replay_storage_partition_manifest',
      ],
