...
class HistoricalEntityReplaySourceAdapter extends BhamReplaySourceAdapter {
  const HistoricalEntityReplaySourceAdapter();

  @override
  String get adapterId => 'historical_entity_replay_source_adapter';
      ...
      return ReplaySourceRecord(
        ...
        payload: <String, dynamic>{
          'name':
              ...
              rawRecord['page_title']?.toString() ??
              rawEntityType,
          'historical_admissibility':
              rawRecord['historical_admissibility'] ?? 'retrospective_archive',
          'retrospective_evidence':
              rawRecord['retrospective_evidence'] ?? true,
          ...rawRecord,
        },
  ...
  TemporalUncertainty _readUncertainty(Map<String, dynamic> rawRecord) {
    final confidence = (rawRecord['confidence'] as num?)?.toDouble() ?? 0.76;
    final minutes = (rawRecord['uncertainty_minutes'] as num?)?.toInt() ?? 1440;
