...
class BhamReplayConnectivityService {
  ...
  List<ReplayConnectivityProfile> buildProfiles({
    ...
    final runConfig =
        stochasticRunConfig ??
        ReplayStochasticRunConfig(
          runId: 'bham_2023_replay',
          replayYear: populationProfile.replayYear,
          globalSeed: 2023,
          localityPerturbationSeed: 20231,
          actorSeed: 20232,
          monthSeasonSeed: 20233,
        );
  ...
  ReplayConnectivityProfile _buildProfile({
    ...
    final baseProbability = actor.lifecycleState == AgentLifecycleState.deleted
        ? 0.0
        : 0.92;
    ...
    final offlinePreference = actor.lifecycleState == AgentLifecycleState.deleted ||
    ...
    final transitions = <ReplayConnectivityStateTransition>[
      _transition(
        ...
        reason: 'home and household anchors are Wi-Fi probable unless user settings or lifecycle reduce availability',
      ...
      _transition(
        ...
        reason: 'movement through transit, street, and corridor time is cellular or offline biased',
      ...
      _transition(
        ...
        reason: 'work, school, library, civic, and major venue anchors are Wi-Fi probable where enabled',
        preferredMode: wifiEnabled
            ? ReplayConnectivityMode.wifi
            : cellularEnabled
            ? ReplayConnectivityMode.cellular
      ...
      _transition(
        ...
        reason: 'evening and weekend activity follows actor routine, nightlife, and recovery patterns',
