...
class BhamSingleYearReplayPassService {
  ...
  ReplaySingleYearPassSummary buildSummary({
    ...
    final cityDisplayName =
        environment.metadata['cityDisplayName']?.toString() ?? 'Replay';
    ...
    return ReplaySingleYearPassSummary(
      ...
      notes: <String>[
        'This is a replay-only single-year pass summary inside the isolated $cityDisplayName virtual world.',
      ...
      metadata: <String, dynamic>{
        ...
        if (environment.metadata['citySlug'] != null)
          'citySlug': environment.metadata['citySlug'],
        if (environment.metadata['cityPackManifestRef'] != null)
          'cityPackManifestRef': environment.metadata['cityPackManifestRef'],
        if (environment.metadata['cityPackId'] != null)
          'cityPackId': environment.metadata['cityPackId'],
        if (environment.metadata['cityPackStructuralRef'] != null)
          'cityPackStructuralRef':
              environment.metadata['cityPackStructuralRef'],
        if (environment.metadata['campaignDefaultsRef'] != null)
          'campaignDefaultsRef': environment.metadata['campaignDefaultsRef'],
        if (environment.metadata['localityExpectationProfileRef'] != null)
          'localityExpectationProfileRef':
              environment.metadata['localityExpectationProfileRef'],
        if (environment.metadata['worldHealthProfileRef'] != null)
          'worldHealthProfileRef':
              environment.metadata['worldHealthProfileRef'],
        ...
        'simulatedAi2AiExchangeCount': exchangeSummary?.totalAi2AiRecords ?? 0,
