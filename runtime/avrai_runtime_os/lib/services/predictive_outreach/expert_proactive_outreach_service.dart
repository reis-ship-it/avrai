...
class ExpertProactiveOutreachService {
  ...
  Future<void> processExpertLearningOutreach({
    ...
    try {
      ...
      final expertProfile =
          await _personalityLearning.getCurrentPersonality(expertId);
  ...
  Future<void> processExpertBusinessOutreach({
    ...
    try {
      ...
      for (final business in businesses) {
        try {
          final businessProfile = await _personalityLearning
              .getCurrentPersonality(business.businessId);
          ...
          if (outreachScore >= 0.75) {
            await _ai2aiCommunication.sendOutreachMessage(
              ...
              payload: {
                ...
                'compatibility_score': outreachScore,
                'reasoning':
                    'High compatibility for expert-business partnership',
              },
            );
          }
        } catch (e) {
  ...
  Future<List<LearningCandidate>> _findLearningCandidates(
