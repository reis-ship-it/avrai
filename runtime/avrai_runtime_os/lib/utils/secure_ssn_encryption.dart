...
class SecureSSNEncryption {
  ...
  Future<void> encryptSSN(String userId, String ssn) async {
    try {
      ...
      _logger.info('SSN encrypted and stored for user: $userId',
          tag: 'SecureSSNEncryption');
    } catch (e) {
      _logger.error('Failed to encrypt SSN',
          error: e, tag: 'SecureSSNEncryption');
      rethrow;
    }
  }
  ...
  Future<String?> decryptSSN(String userId) async {
    try {
      ...
      _logger.error('Failed to decrypt SSN',
          error: e, tag: 'SecureSSNEncryption');
      rethrow;
    }
  }
  ...
  Future<void> encryptEIN(String userId, String ein) async {
    try {
      ...
      _logger.info('EIN encrypted and stored for user: $userId',
          tag: 'SecureSSNEncryption');
    } catch (e) {
      _logger.error('Failed to encrypt EIN',
          error: e, tag: 'SecureSSNEncryption');
      rethrow;
    }
  }
  ...
  Future<String?> decryptEIN(String userId) async {
    try {
      ...
      _logger.error('Failed to decrypt EIN',
          error: e, tag: 'SecureSSNEncryption');
      rethrow;
    }
  }
  ...
  Future<void> deleteSSN(String userId) async {
    try {
      ...
      _logger.error('Failed to delete SSN',
          error: e, tag: 'SecureSSNEncryption');
      rethrow;
    }
  }
  ...
  Future<void> deleteEIN(String userId) async {
    try {
      ...
      _logger.error('Failed to delete EIN',
          error: e, tag: 'SecureSSNEncryption');
      rethrow;
    }
  }
  ...
  Future<bool> hasSSN(String userId) async {
    try {
      ...
      _logger.error('Failed to check SSN existence',
          error: e, tag: 'SecureSSNEncryption');
      return false;
    }
  }
  ...
  Future<bool> hasEIN(String userId) async {
    try {
      ...
      _logger.error('Failed to check EIN existence',
          error: e, tag: 'SecureSSNEncryption');
      return false;
    }
  }
  ...
  Future<String?> getSSNLast4(String userId) async {
    try {
      ...
      _logger.error('Failed to get SSN last 4',
          error: e, tag: 'SecureSSNEncryption');
      return null;
    }
  }
  ...
  Future<String?> getEINLast4(String userId) async {
    try {
      ...
      _logger.error('Failed to get EIN last 4',
          error: e, tag: 'SecureSSNEncryption');
      return null;
    }
  }
