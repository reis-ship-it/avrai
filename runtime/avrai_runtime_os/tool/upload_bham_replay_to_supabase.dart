...
void main(List<String> args) async {
  ...
  final markdownFile =
      File('$basePath/66_BHAM_REPLAY_SUPABASE_UPLOAD_INDEX_SUMMARY_2023.md')
        ..parent.createSync(recursive: true);
  final jsonFile =
      File('$basePath/66_BHAM_REPLAY_SUPABASE_UPLOAD_INDEX_SUMMARY_2023.json');
