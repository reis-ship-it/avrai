...
void main() {
  ...
  test('builds a representative Birmingham population profile with age safety',
    ...
    expect(profile.metadata['populationModelKind'],
        'dense_weighted_synthetic_city');
    expect(profile.metadata['cityDisplayName'], 'Austin');
    expect(
      profile.metadata['cityPackManifestRef'],
      'city_packs/atx/2024_manifest.json',
    );
    expect(profile.metadata['cityPackId'], 'austin_core_2024');
    expect(
      profile.metadata['cityPackStructuralRef'],
