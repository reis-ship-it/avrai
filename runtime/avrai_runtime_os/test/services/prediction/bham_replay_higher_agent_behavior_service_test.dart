...
void main() {
  ...
  test('builds an active higher-agent behavior pass with personal and city actions', () {
    ...
    expect(
      (behaviorPass.actionCountsByType['handoffLocalityDigestToPersonalAgents'] ?? 0),
      greaterThan(0),
    );
    expect(
      behaviorPass.actionCountsByType.keys,
