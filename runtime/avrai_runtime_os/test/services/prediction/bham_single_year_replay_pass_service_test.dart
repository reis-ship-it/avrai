...
void main() {
  ...
  test('builds a replay-only single-year pass summary with realism reports', () {
    ...
    expect(summary.metadata.containsKey('mesh_runtime_state_summary'), isFalse);
    expect(summary.metadata.containsKey('ai2ai_runtime_state_summary'), isFalse);
    expect(
