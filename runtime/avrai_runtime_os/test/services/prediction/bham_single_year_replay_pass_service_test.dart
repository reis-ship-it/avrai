...
void main() {
  ...
  test(
    ...
    () {
      ...
      expect(summary.notes.first, contains('Austin virtual world'));
      expect(
      ...
      expect(summary.metadata['cityDisplayName'], 'Austin');
      expect(summary.metadata['cityPackId'], 'austin_core_2024');
      expect(summary.metadata['cityPackManifestRef'],
          'city_packs/atx/2024_manifest.json');
      expect(
        summary.metadata['cityPackStructuralRef'],
