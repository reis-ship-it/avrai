...
void main() {
  ...
  test('builds an environment-aware replay place graph from replay truth', () {
    ...
    expect(graph.metadata['graphKind'], 'canonical_atx_truth_year_place_graph');
    expect(graph.metadata['cityDisplayName'], 'Austin');
    expect(graph.metadata['cityPackId'], 'austin_core_2024');
    expect(
      graph.metadata['cityPackStructuralRef'],
