...
class MockDeviceMotionService extends DeviceMotionService {
  MockDeviceMotionService() : super(filterAlpha: 0.15, skipInitForTesting: true);
...
void main() {
  ...
  group('SmartPassiveCollectionService - Dwell Time Clustering', () {
    ...
    test('should extend existing DwellEvent and capture encounters', () {
      ...
      service.recordPing(PassivePing(timestamp: now, latitude: 40.0, longitude: -74.0));
      service.recordPing(PassivePing(timestamp: now.add(const Duration(minutes: 6)), latitude: 40.0, longitude: -74.0));
