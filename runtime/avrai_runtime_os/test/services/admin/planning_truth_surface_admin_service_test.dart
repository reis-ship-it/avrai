...
void main() {
  ...
  test(
    'stages one bounded assistant observation for planning snapshots and suppresses duplicate refreshes',
    () async {
      final learningSignalService = EventLearningSignalService(
        airGap: _FakeAirGap(),
      );
      ...
      await service.getPlanningSnapshot();
      await service.getPlanningSnapshot();
      ...
      expect(
        ...
        'planning_truth_surface_snapshot',
      );
