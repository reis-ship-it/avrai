...
- **Live status tracker:** [`docs/agents/status/status_tracker.md`](docs/agents/status/status_tracker.md)
...
3. Keep file placement compliant with architecture guardrails in `docs/plans/architecture/`.
