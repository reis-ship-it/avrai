...
void main() {
  group('ArchetypePatternLearner', () {
    ...
    test('should derive an average archetype from positive encounters', () {
      ...
      expect(archetypes[0].avgCrossingNumber, equals(15.0)); // Average of 10 and 20
    ...
    test('should return higher affinity for locations that match learned archetypes', () {
      ...
      final matchingAffinity = learner.calculateLocationAffinity([archetype], matchingLocationVibe);
      final mismatchAffinity = learner.calculateLocationAffinity([archetype], mismatchedLocationVibe);
