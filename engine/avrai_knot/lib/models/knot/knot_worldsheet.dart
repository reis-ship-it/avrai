...
class KnotWorldsheet {
  ...
  Duration get timeSpan {
    ...
    return sortedSnapshots.last.timestamp.difference(
  ...
  KnotFabric _interpolateFabricPolynomial(
    ...
    final interpolatedDensity = cubicSplineInterpolateScalar([
      fabric1.invariants.density,
      fabric2.invariants.density,
    ], factor);

    final interpolatedStability = cubicSplineInterpolateScalar([
      fabric1.invariants.stability,
      fabric2.invariants.stability,
    ], factor);
    ...
    final interpolatedBraid =
        fabric1.braid; // Simplified - would interpolate braid data
  ...
  KnotFabric _extrapolateFabric(
    List<FabricSnapshot> sortedSnapshots,
    DateTime t,
  ) {
