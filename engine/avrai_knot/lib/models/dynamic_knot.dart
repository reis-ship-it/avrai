...
class DynamicKnot {
  ...
  factory DynamicKnot.fromJson(Map<String, dynamic> json) {
    ...
    final colorScheme = <String, int>{};
    for (final entry in colorSchemeJson.entries) {
      colorScheme[entry.key] = entry.value as int? ?? 0;
    }
    ...
    return DynamicKnot(
      ...
      energy: json['energy'] != null
          ? EnergyLevel.fromJson(json['energy'])
          : null,
      stress: json['stress'] != null
          ? StressLevel.fromJson(json['stress'])
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    for (final entry in colorScheme.entries) {
      colorSchemeJson[entry.key] = entry.value;
    }
...
class AnimatedKnot {
  ...
  final List<int> colorTransition;
...
enum AnimationType { breathing, pulsing, rotating, flowing }
