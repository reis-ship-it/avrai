...
class Knot3DExportService {
  ...
  Knot3DExportService({Knot3DConverterService? converterService})
  ...
  Future<String> exportToOBJ({
    ...
    try {
      ...
      developer.log('✅ Exported OBJ to: ${file.path}', name: _logName);
  ...
  Future<String> exportToSTL({
    ...
    try {
      ...
      developer.log('✅ Exported STL to: ${file.path}', name: _logName);
  ...
  Future<String> exportToGLTF({
    ...
    try {
      ...
      developer.log('✅ Exported glTF to: ${file.path}', name: _logName);
  ...
  Future<File> _getExportFile({required String filename}) async {
    final exportDir = Directory('${Directory.systemTemp.path}/knot_exports');
