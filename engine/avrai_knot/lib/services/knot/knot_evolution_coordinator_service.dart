...
class KnotEvolutionCoordinatorService {
  ...
  static const int _crossingChangeThreshold =
      2; // Significant if crossing number changes by 2+
  static const double _complexityChangeThreshold = 0.2; // 20% complexity change
  static const double _polynomialDistanceThreshold =
      0.3; // Polynomial distance threshold
  ...
  Future<void> handleProfileEvolution(
    ...
    try {
      ...
      final isSignificant =
          oldKnot == null || _detectSignificantChange(oldKnot, newKnot);
  ...
  bool _detectSignificantChange(
    ...
    final crossingDelta =
        (newKnot.invariants.crossingNumber - oldKnot.invariants.crossingNumber)
            .abs();
  ...
  bool _areKnotsDifferentType(PersonalityKnot knotA, PersonalityKnot knotB) {
  ...
  double _calculatePolynomialDistance(List<double> polyA, List<double> polyB) {
