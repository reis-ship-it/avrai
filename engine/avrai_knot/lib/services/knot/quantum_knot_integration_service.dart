...
class QuantumKnotIntegrationService {
  ...
  QuantumKnotIntegrationService({required PersonalityKnotService knotService})
  ...
  double calculateQuantumKnotCompatibility(
    ...
    developer.log('Calculating quantum-knot compatibility', name: _logName);
    ...
    try {
      ...
      final knotComplexity = (knot.invariants.crossingNumber / 100.0).clamp(
        0.0,
        1.0,
      );
