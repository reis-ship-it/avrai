...
class AudioMixer {
  ...
  AudioMixer({required this.sampleRate, required this.duration}) {
  ...
  void addSampleAtIndex({required int index, required StereoSample stereo}) {
  ...
  Uint8List toWav({StereoEncoder? encoder}) {
    ...
    return enc.encodeWav(leftSamples: _leftBuffer, rightSamples: _rightBuffer);
  }
}
