...
class VibeKernel {
  ...
  // Test-only fallback state remains defined so legacy reset helpers keep the
  // wider widget/test graph compiling even though runtime execution is native.
  ...
  // ignore: unused_field
  static DateTime _fallbackExportedAtUtc = DateTime.fromMillisecondsSinceEpoch(
    0,
    isUtc: true,
  );
  // ignore: unused_field
